    ...
    execute: function () {
      ...
      (function (_Utils) {
        ...
        function string_moneyToShortNumber(money) {
          ...
          if (money >= 10000) {
            ...
            if (_findTab.length == 2) {
              str = str + ".";
              str = str + String(_findTab[1]).slice(0, 2);
            }
        ...
        function string_formatByLua(str) {
          ...
          for (var _i = 0; _i < newTab.length; _i++) {
            newStr = newStr + newTab[_i];
          }
        ...
        function table_keyof(hashtable, value) {
          ...
          if (hashtable instanceof Array) {
            ...
            for (var _i2 in hashtable) {
              if (Object.prototype.hasOwnProperty.call(hashtable, _i2) && res == null) {
                if (value == hashtable[_i2]) {
                  res = _i2;
                }
              }
            }
...
//# sourceMappingURL=bcca2c0d30f719f3edb4af4905f5b66233652003.js.map