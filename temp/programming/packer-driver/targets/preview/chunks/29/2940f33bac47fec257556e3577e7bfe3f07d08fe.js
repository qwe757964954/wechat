    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cardAddTouchEvent(handNode) {
          ...
          handNode.off(Node.EventType.TOUCH_MOVE);
          handNode.off(Node.EventType.MOUSE_UP);
          handNode.off(Node.EventType.TOUCH_CANCEL);
          handNode.on(Node.EventType.TOUCH_START, event => {
            console.log(event);
            this._isTouched = true; // this.playSelectAnim(event.target);
          }, this);
          handNode.on(Node.EventType.MOUSE_MOVE, event => {
            console.log(event); // this.playSelectAnim(event.target);
          }, this);
          handNode.on(Node.EventType.TOUCH_END, event => {
            ...
            this._isTouched = false; // this.playSelectAnim(event.target);
          }, this);
          handNode.on(Node.EventType.TOUCH_CANCEL, event => {
            console.log(event);
            this._isTouched = false; // this.playSelectAnim(event.target);
          }, this);
        } //将抓上来的牌打出去
...
//# sourceMappingURL=2940f33bac47fec257556e3577e7bfe3f07d08fe.js.map