      ...
      _export("PictureDialogComponent", PictureDialogComponent = (_dec = ccclass('PictureDialogComponent'), _dec2 = property({
        ...
        preLoad() {
          ...
          var _loop = function _loop(type) {
            var resConf = _this._allResMapList[type];
        ...
        updateView() {
          ...
          var uiTransform = this.nodeContentRoot.getComponent(UITransform);
        ...
        onLoadCallback(type) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var pWidth = this.contentNode.getComponent(UITransform).width;
            this.contentNode.removeAllChildren();

            for (var i = 0; i < this._curMaxResNum; i++) {
              var imageAssert = this._loadResMapList[type][i];
              ...
              if (imageAssert) {
                ...
                if (spriteFrame) {
                  var sprNode = this.creatorSpriteNode(spriteFrame);
                  this.contentNode.addChild(sprNode); //缩放适配

                  var childUITrans = sprNode.getComponent(UITransform);
                  var scaleX = 1,
                      scaleY = 1,
                      scaleZ = 1;
...
//# sourceMappingURL=a527dcdfdde09b5565c676ef2192446da8fbb23b.js.map