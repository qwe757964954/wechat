      ...
      _export("NodeOutCardCtr", NodeOutCardCtr = (_dec = ccclass('NodeOutCardCtr'), _dec2 = property({
        ...
        initView() {
          var scale = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.ScaleOutCard;
          ...
          var groundToCard = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.GroundToCard * scale;
          var indexStart = (width * 6 + (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.SpaceOutCard * (6 - 1)) / 2 - width / 2 - 2; // 往右2米。这里-2
          ...
          for (var dir = 0; dir < 4; dir++) {
            ...
            for (var i = 0; i < 18; i++) {
              ...
              var index = length % 6;
              var distanceFromCenter = distance + (layer - 1) * height; // 离桌面中心的垂直距离

              var leftToRight = -indexStart + index * (width + (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
            ...
            for (var _i = 0; _i < 9; _i++) {
              ...
              var _distanceFromCenter = distance + (_layer - 2) * height; // 离桌面中心的垂直距离


              var _leftToRight = -indexStart + 6 * width + 1 + _index * (width + (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.SpaceOutCard); // 指定层的第index张牌的位置
              ...
              _card.setScale(_card.scale.x * scale, _card.scale.y * scale, _card.scale.z * scale);

              _card.setPosition(_leftToRight, groundToCard, _distanceFromCenter);
...
//# sourceMappingURL=0cff1104eeece337e9e29f2f1f920a15b92a8dc0.js.map