    ...
    execute: function () {
      ...
      _export("GameMenuPrefabCtr", GameMenuPrefabCtr = (_dec = ccclass('GameMenuPrefabCtr'), _dec2 = menu('prefab/game/GameMenuPrefabCtr'), _dec3 = property({
        ...
        onClickBack(event) {
          ...
          // EventManager.dispatch(AppEvent.REPORT_CLIENT_CLICK, { eventID: ReportConfig.game_1 });
        } //点击更多
        ...
        onClickToolBar(event) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), FXJUIID) : FXJUIID).ToolBarPrefab, null, {}); // EventManager.dispatch(AppEvent.REPORT_CLIENT_CLICK, { eventID: ReportConfig.game_2 });
        } //点击聊天
        ...
        onClickChat(event) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), FXJUIID) : FXJUIID).GameChatPrefab, null, {}); // EventManager.dispatch(AppEvent.REPORT_CLIENT_CLICK, { eventID: ReportConfig.game_6 });
        }
        /** 红点更新 */
...
//# sourceMappingURL=66308ce3d8f27708ced6bbd38a3867247fb2a08e.js.map