    ...
    execute: function () {
      ...
      _export("OprationMgr", OprationMgr = (_dec = ccclass('OprationMgr'), _dec2 = property(Layout), _dec(_class = (_class2 = class OprationMgr extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        onLoad() {
          ...
          var itemScript = this.opmgrItem.getComponent(_crd && OprationItem === void 0 ? (_reportPossibleCrUseOfOprationItem({
            error: Error()
          }), OprationItem) : OprationItem);
          itemScript.updateAtlasCodeMap();
        }

        updateUserOperationResult(event, resp) {
          if (event === void 0) {
            event = null;
          }
          ...
          var relativeSeatId = (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
          ...
          var coordinate = this.coordinateList[relativeSeatId];
...
//# sourceMappingURL=af2db690ae1872843edb851c07e2abed948c7ee8.js.map