          ...
          if (gender == 2) {
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              path: (_crd && FXJSound === void 0 ? (_reportPossibleCrUseOfFXJSound({
                error: Error()
              }), FXJSound) : FXJSound).QuickChatXiaoYa.path + param['index']
            });
          } else {
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
              ...
              path: (_crd && FXJSound === void 0 ? (_reportPossibleCrUseOfFXJSound({
                error: Error()
              }), FXJSound) : FXJSound).QuickChatXiaoBo.path + param['index']
            });
          }
...
//# sourceMappingURL=af31aeea3c9cf89ea9686fd6a83b34244123fe6c.js.map