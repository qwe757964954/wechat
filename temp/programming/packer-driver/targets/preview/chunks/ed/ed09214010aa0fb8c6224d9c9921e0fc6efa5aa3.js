  ...
  return {
    ...
    execute: function () {
      ...
      _export("RedDot", RedDot = class RedDot extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        has_reddot_mail() {
          var data = this.__User.MailInfo.MailData;
          var flag = false;
        ...
        update_dress_red(item_id, status) {
          if (status === void 0) {
            status = false;
          }
        }
...
//# sourceMappingURL=ed09214010aa0fb8c6224d9c9921e0fc6efa5aa3.js.map