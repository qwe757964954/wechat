System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19", "__unresolved_20", "__unresolved_21", "__unresolved_22", "__unresolved_23", "__unresolved_24", "__unresolved_25", "__unresolved_26", "__unresolved_27", "__unresolved_28", "__unresolved_29", "__unresolved_30", "__unresolved_31", "__unresolved_32", "__unresolved_33", "__unresolved_34", "__unresolved_35", "__unresolved_36", "__unresolved_37", "__unresolved_38"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ReportServers = _unresolved_35.ReportServers;
    }, function (_unresolved_36) {
      SelectGameServers = _unresolved_36.SelectGameServers;
    }, function (_unresolved_37) {
      ShareServers = _unresolved_37.ShareServers;
    }, function (_unresolved_38) {
      TaskServers = _unresolved_38.TaskServers;
    }, function (_unresolved_39) {
      UserServers = _unresolved_39.UserServers;
    }],
    execute: function () {
      _crd = true;
      ...
      _GlobalController = class _GlobalController extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        heartbeatOnLoading(event, state) {
          if (state === void 0) {
            state = false;
          }
        ...
        receiveNetPhpMsg(event, respData, reqData) {
          ...
          var reqSSID = null; //php请求参数

          if (reqData) {
            reqSSID = reqData.ssid;
          }

          var errorInfo = this.generateErrorInfo(respData.body, reqSSID);
          var eventBindindCmd = (_crd && GlobalCMDHead === void 0 ? (_reportPossibleCrUseOfGlobalCMDHead({
            error: Error()
          }), GlobalCMDHead) : GlobalCMDHead).PHP_CMD_CONSTANT + respData.cmd;
          var p_ISSuccess = false;
          var p_RespData = errorInfo;
          var p_ReqParam = reqData;
          ...
          var eventID = (_crd && GCmdMapping === void 0 ? (_reportPossibleCrUseOfGCmdMapping({
            error: Error()
        ...
        generateErrorInfo(packetInfo, ssid) {
          ...
          var errorType = packetInfo.type;
          var errorTips = null;
          var status = packetInfo.status;
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            if (errorTips == "") {
              ...
              var majorType = errorType.substring(0, 0);
              var minorType = errorType.substring(2, 2);
        ...
        receivePhpPushMsg(event, respData) {
          ...
          var mtype = respData.result["mtype"];
          ...
          switch (mtype) {
            ...
            case 13:
              var field = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                error: Error()
        ...
        receivePhpPushPayMoney(event, respData) {
          ...
          var detailData = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
            error: Error()
        ...
        detailPaySuccess(detailData) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var _prop = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).clone((_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              error: Error()
            }), GConstants) : GConstants).GoodsType.DIAMOND);

            var _propInfo = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            }), GCache) : GCache).PropsConf.getPropsInfoById(_prop["id"]);

            if (_propInfo && _propInfo["item_name"]) {
              var _oneData = {
                icon: _propInfo["url"],
                name: _propInfo["item_name"],
                num: (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  error: Error()
                }), Utils) : Utils).number_valueOf(detailData["diamond"])
              };
              awardData.push(_oneData);
            }
          }
          ...
          if ((_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            ...
            var moneyID = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
          ...
          var payMoney = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).number_valueOf(detailData["gold"]); //获得银币

          var award_gold = 0; //加赠得到的银币信息

          var award_diamond = 0; //获得的兑换券新

          var award_props = {}; //加赠信息
          //合并加赠信息

          var privilege = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          ...
          var bouns = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          ...
          var desc = String("成功购买*银币").replace("*", (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_moneyToShortNumber(payMoney)); //加赠银币

          if (award_gold > 0) {
            desc = desc + String(",加赠*银币").replace("*", String(award_gold));

            var _prop2 = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).clone((_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              error: Error()
            }), GConstants) : GConstants).GoodsType.SILVER_COIN);

            var _propInfo2 = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            }), GCache) : GCache).PropsConf.getPropsInfoById(_prop2["id"]);

            if (_propInfo2 && _propInfo2["item_name"]) {
              var _oneData2 = {
                icon: _propInfo2["url"],
                name: _propInfo2["item_name"],
                num: award_gold,
                newAdd: true
              };
              awardData.push(_oneData2);
            }
          } //加赠兑换券
          ...
          if (award_diamond > 0) {
            ...
            var _prop3 = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).clone((_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              error: Error()
            }), GConstants) : GConstants).GoodsType.DIAMOND);

            var _propInfo3 = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            }), GCache) : GCache).PropsConf.getPropsInfoById(_prop3["id"]);

            if (_propInfo3 && _propInfo3["item_name"]) {
              var _oneData3 = {
                icon: _propInfo3["url"],
                name: _propInfo3["item_name"],
                num: award_diamond,
                newAdd: true
              };
              awardData.push(_oneData3);
            }
          } //加赠道具


          for (var propID in award_props) {
            if (Object.prototype.hasOwnProperty.call(award_props, propID)) {
              var num = award_props[propID];

              var _propInfo4 = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                error: Error()
              }), GCache) : GCache).PropsConf.getPropsInfoById(propID);

              if (_propInfo4 && _propInfo4["item_name"]) {
                desc = desc + ",加赠" + _propInfo4["item_name"] + "x" + num;
                var _oneData4 = {
                  icon: _propInfo4["url"],
                  name: _propInfo4["item_name"],
                  num: num,
                  newAdd: true
                };
                awardData.push(_oneData4);
              }
            }
          }
        ...
        detailBuyGiftSuccess(detailData) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            for (var key in detailData["buy"]) {
              if (Object.prototype.hasOwnProperty.call(detailData["buy"], key)) {
                ...
                if (num > 0) {
                  var conf = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                    error: Error()
                  }), GCache) : GCache).PropsConf.getPropsInfoById(key);
                  var icon = detailData["gicons"][key];
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            for (var _key in detailData["extra"]) {
              if (Object.prototype.hasOwnProperty.call(detailData["extra"], _key)) {
                var obj = detailData["extra"][_key];
                var gname = obj['gname'];

                var _num = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  error: Error()
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            for (var _key2 in detailData["total_property"]) {
              if (Object.prototype.hasOwnProperty.call(detailData["total_property"], _key2)) {
                var value = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  error: Error()
                }), Utils) : Utils).number_valueOf(detailData["total_property"][_key2]);
                (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                  error: Error()
                }), GCache) : GCache).User.updateUserMoneyByID(Number(_key2), value);
              }
            }
          }
...
//# sourceMappingURL=beff031ab202bf209b3c962c60c8282515457270.js.map