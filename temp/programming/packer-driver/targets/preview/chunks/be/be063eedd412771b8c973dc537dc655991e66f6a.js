  ...
  return {
    ...
    execute: function () {
      ...
      _export("prefab_playerCenter", prefab_playerCenter = (_dec = ccclass('prefab_playerCenter'), _dec2 = menu('prefab/hall/playerCenter'), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property({
        ...
        checkIsInGame() {
          var userId = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        updateUserInfo(event, body) {
          ...
          if (this._isGameIn) {
            ...
            if (gender == 2) {
              var sp = this.femaleNode.getComponent(Sprite).spriteFrame;
        ...
        onOpenedViewCallback(event, viewParam) {
          if (event === void 0) {
            event = null;
          }
        ...
        onClosedViewCallback(event, viewParam) {
          if (event === void 0) {
            event = null;
          }
        ...
        onClickSyncWXInfo(event) {
          ...
          var tmpName = "测试1" + (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).User.getUserMid();
          var avatar = 'https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTI8sibBlJEE6mfxaKkdlFtAJ9tQGGDrAOEZDIEThRUqcBIr2gWQtde0wJIEfhSc4swl4PCW72LjqIg/132';
...
//# sourceMappingURL=be063eedd412771b8c973dc537dc655991e66f6a.js.map