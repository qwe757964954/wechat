System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Label', 'LabelComponent', 'Node', 'SpriteAtlas', 'Vec3', '_decorator']);
      ...
      _export("NodeUserPrefabCtr", NodeUserPrefabCtr = (_dec = ccclass('NodeUserPrefabCtr'), _dec2 = menu('prefab/game/NodeUserPrefabCtr'), _dec3 = property({
        ...
        updateCoin(event, uid) {
          ...
          console.log("updateCoin__________________", this._uid);

          if (uid && uid == this._uid) {
            var palyer = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
              error: Error()
            }), PlayerMgr) : PlayerMgr).getInstance().findPlayerWithUserId(uid);
            console.log("updateCoin__________________", uid, this._uid, palyer.money);
        ...
        showChatMsg(event, body) {
          ...
          */
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var _Label = bg == null ? void 0 : bg.getChildByName("Label");

            if (_Label) {
              _Label.getComponent(LabelComponent).string = String(body.msg);
            }
...
//# sourceMappingURL=6beb37cc6cbe274270fbad0416f8bd1f4280d687.js.map