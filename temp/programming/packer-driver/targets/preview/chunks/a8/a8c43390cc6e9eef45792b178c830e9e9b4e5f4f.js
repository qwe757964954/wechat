System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19", "__unresolved_20", "__unresolved_21"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, GCache, AppEvent, Encrypt, Utils, EventManager, RoomController, OperationMgr, PlayerMgr, Room, RoomMgr, FXJCMDHead, FXJWriteAndRead, OPCode, FXJConstant, FXJEvent, FXJObserver, FXJUIID, GameEvent, ChatServer, RoundServer, SettleServer, FXJController, _crd;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      OperationMgr = _unresolved_8.OperationMgr;
    }, function (_unresolved_9) {
      PlayerMgr = _unresolved_9.PlayerMgr;
    }, function (_unresolved_10) {
      Room = _unresolved_10.Room;
    ...
    execute: function () {
      ...
      _export("FXJController", FXJController = class FXJController extends (_crd && RoomController === void 0 ? (_reportPossibleCrUseOfRoomController({
        ...
        __initModuleEvent() {
          ...
          this.addModelListener((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
            error: Error()
          }), GameEvent) : GameEvent).SEND_CARD_OPERATION, this.sendCardOpration);
          this.addModelListener((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
            error: Error()
        ...
        onNextGameOperation(event) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), FXJUIID) : FXJUIID).GameMatchPrefab, null, {});
        } //发牌


        sendCardOpration(event, index) {
          if (event === void 0) {
            event = null;
          }
          ...
          var req = {
            opCard: (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
              error: Error()
            }), OperationMgr) : OperationMgr).getInstance().getSendCardListNumber(index)[0],
            ...
            opCards: (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
              error: Error()
            }), OperationMgr) : OperationMgr).getInstance().getSendCardListNumber(index),
        ...
        broadcastUpdateFanGangPai(event, resp) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), GameEvent) : GameEvent).VIEW_UPDATE_FAN_GANG_PAI, resp);
        }
...
//# sourceMappingURL=a8c43390cc6e9eef45792b178c830e9e9b4e5f4f.js.map