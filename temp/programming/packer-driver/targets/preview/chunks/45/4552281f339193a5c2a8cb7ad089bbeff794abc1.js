  ...
  return {
    ...
    execute: function () {
      ...
      _export("SuperScrollView", SuperScrollView = (_dec = ccclass('SuperScrollView'), _dec2 = menu('gui/scrollview/SuperScrollView'), _dec3 = property({
        ...
        scrollToAny(moveDelta, timeInSecond, attenuated) {
        ...
        _autoScrollToPage() {
          ...
          if (bounceBackStarted) {
            ...
            var index = this.layout["_currPageIndex"];
            ...
            var count = this.layout.itemTotal;
...
//# sourceMappingURL=4552281f339193a5c2a8cb7ad089bbeff794abc1.js.map