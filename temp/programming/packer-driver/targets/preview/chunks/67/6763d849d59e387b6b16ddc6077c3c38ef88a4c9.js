System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, Layout, Node, Prefab, UITransform, _decorator, EventManager, BaseComponent, OperationMgr, GameEvent, Card, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Carditem;
    ...
    execute: function () {
      ...
      _export("Carditem", Carditem = (_dec = ccclass('Carditem'), _dec2 = property({
        ...
        updateCardItemProp(opTypes) {
          ...
          var opNode = opTypes[0].node; // let childrens = opNode.node.children;
          ...
          this.opCards.type = Layout.Type.GRID;
          this.opCards.resizeMode = Layout.ResizeMode.CONTAINER;
          this.opCards.startAxis = Layout.AxisDirection.VERTICAL;
          this.opCards.spacingX = 15;
          this.opCards.spacingY = 15;
          this.opCards.verticalDirection = Layout.VerticalDirection.BOTTOM_TO_TOP;
          this.opCards.horizontalDirection = Layout.HorizontalDirection.RIGHT_TO_LEFT; // cardLayout.constraint = Layout.Constraint.FIXED_ROW;
          // cardLayout.constraintNum = rowNum;

          this.opCards.updateLayout(); // let transform = this.node.getComponent(UITransform);
...
//# sourceMappingURL=6763d849d59e387b6b16ddc6077c3c38ef88a4c9.js.map