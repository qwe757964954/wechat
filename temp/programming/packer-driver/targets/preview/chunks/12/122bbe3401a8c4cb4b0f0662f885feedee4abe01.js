System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Label, Node, _decorator, GCache, AppEvent, AppSound, GConstants, GameRes, UIID, Utils, EventManager, BaseComponent, Platform, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, menu, commonBtnPrefabCtr;
      ...
      _export("commonBtnPrefabCtr", commonBtnPrefabCtr = (_dec = ccclass('commonBtnPrefabCtr'), _dec2 = menu('prefab/hall/commonBtnPrefabCtr'), _dec3 = property({
        ...
        notifyClosedUI(event, viewParam) {
          ...
          if (viewParam && viewParam["Prefab"] == (_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
            ...
            var status = (_crd && Platform === void 0 ? (_reportPossibleCrUseOfPlatform({
              error: Error()
        ...
        refreshRedDot(event, keyType) {
          ...
          if (this.btnEmailNode.active == true) {
            var imgRedDot = this.btnEmailNode.getChildByName("img_dot");
...
//# sourceMappingURL=122bbe3401a8c4cb4b0f0662f885feedee4abe01.js.map