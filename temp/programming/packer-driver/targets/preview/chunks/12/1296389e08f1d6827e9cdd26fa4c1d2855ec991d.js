  ...
  return {
    ...
    execute: function () {
      ...
      _export("SpineAniManager", SpineAniManager = (_dec = ccclass('SpineAniManager'), _dec(_class = (_class2 = class SpineAniManager extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        preLoadSkinAniDir(bundle, dirPath, upFunc, cb) {
          if (upFunc === void 0) {
            upFunc = null;
          }
          ...
          var filePathList = String(dirPath).split("/"); //包名|根目录|文件名 or 包名|文件名
            ...
            bundle.loadDir(dirPath, sp.SkeletonData, (finished, total, item) => {
              ...
              for (var i = 0; i < data.length; i++) {
                if (data[i]["_name"] != null) {
                  var fileName = data[i]["_name"]; //文件名

                  var keyName = preKey + "|" + fileName;
        ...
        preLoadSkinAniDirList(list, updateFunc, cb) {
        ...
        stopPlayAni(event, param) {
          ...
          ;
          var key = param.resConf.bundle + "|" + param.resConf.path + "|" + param.aniName;
          var aniNode = this.getSpineNode(key);
        ...
        getSpineNode(key) {
          if (key && key != null) {
            var node = SpineAniManager.AniNodeMap.get(key);
            return node;
          }
        ...
        setSpineAni(aniNode, resData, trackIndex, name, loop, premultipliedAlpha, skin, pos, startCallFunc, endCallFunc, oneLoopEndCallFunc, processCallFunc, frameNum) {
          if (loop === void 0) {
            loop = false;
          }
          ...
          if (startCallFunc === void 0) {
            startCallFunc = null;
          }

          if (endCallFunc === void 0) {
            endCallFunc = null;
          }

          if (oneLoopEndCallFunc === void 0) {
            oneLoopEndCallFunc = null;
          }

          if (processCallFunc === void 0) {
            processCallFunc = null;
          }
          ...
          var key = resData.bundle + "|" + resData.path + "|" + name;
          ...
          var oldAniNode = aniNode.getChildByName(key);
        ...
        setAniData(node, resData, trackIndex, name, loop, premultipliedAlpha, skin, startCallFunc, endCallFunc, oneLoopEndCallFunc, processCallFunc, frameNum) {
          if (skin === void 0) {
            skin = null;
          }
          ...
          var filePathName = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_splitFileName(resData.path);
          var filePathList = String(resData.path).split("/"); //包名|根目录|文件名 or 包名|文件名

          var key = resData.bundle;
          ...
          var skinData = this._skinAniMapping[key];
          var self = this;
...
//# sourceMappingURL=1296389e08f1d6827e9cdd26fa4c1d2855ec991d.js.map