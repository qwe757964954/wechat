        ...
        stackAnim(indexList, tByte, insertIndex, cb) {
          ...
          */
          ...
          this.drawByte = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
          }), PlayerMgr) : PlayerMgr).getInstance().getMyhands().pop();
          ...
          var [drawX, drawY] = trackDraw.channels();
          drawX.curve.assignSorted([[0, {
            value: startPosDraw.x
          }], [0.1, {
            value: endPosDraw.x
          }]]);
          drawY.curve.assignSorted([[0, {
            value: startPosDraw.y
          }], [0.1, {
            value: endPosDraw.y + 100
          }]]);
          var animDrawCom;
          ...
          if (cb) {
            ...
            this.removeDrawCard(); // this._stackCb = cb
          }
...
//# sourceMappingURL=2c3b3d14585038c4eca8e48fb4917c39c2c7ab51.js.map