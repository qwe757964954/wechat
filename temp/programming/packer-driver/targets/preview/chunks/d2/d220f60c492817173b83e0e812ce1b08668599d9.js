    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        onTouchMove(event) {
          ...
          Vec3.add(pos, pos, new Vec3(location.x, location.y, 0)); // this.movePositionY=  this.startPosition + event.getDelta();
          ...
          console.log("movePositionY__________", pos);
...
//# sourceMappingURL=d220f60c492817173b83e0e812ce1b08668599d9.js.map