    ...
    execute: function () {
      ...
      _export("GameMenuPrefabCtr", GameMenuPrefabCtr = (_dec = ccclass('GameMenuPrefabCtr'), _dec2 = menu('prefab/game/GameMenuPrefabCtr'), _dec3 = property({
        ...
        onPlayerInto(event, uid) {
          console.log("onPlayerInto________________", uid, (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        onClickBack(event) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), FXJEvent) : FXJEvent).NET_REQ_LOGOUT_IN_GAME_TRY); // EventManager.dispatch(FXJEvent.REPORT_CLIENT_CLICK, { eventID: ReportConfig.game_1 });
        } //点击更多
...
//# sourceMappingURL=89889fd908f1faef92c648386d18c1ce5471508d.js.map