      ...
      _export("NodeUserPrefabCtr", NodeUserPrefabCtr = (_dec = ccclass('NodeUserPrefabCtr'), _dec2 = menu('prefab/game/NodeUserPrefabCtr'), _dec3 = property({
        ...
        showChatMsg(event, body) {
          ...
          */
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).isNull(body['index']) || (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_isEmpty(body['index'])) {
            console.warn("快捷聊天接收数据为空");
            return;
          }

          var audioName = body['index'];
          var arr = audioName.split('_');

          if (arr.length != 2) {
            console.warn("快捷聊天接收数据非法");
            return;
          }
          ...
          if (!Object.prototype.hasOwnProperty.call((_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
            error: Error()
          }), FXJConstant) : FXJConstant).ChatText, tag)) {
            console.warn("快捷聊天接收数据非法:没有该标签数据");
            return;
          }

          var tagArr = (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
            error: Error()
          }), FXJConstant) : FXJConstant).ChatText[tag];

          if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).isArray(tagArr) || (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).table_isEmpty(tagArr) || (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_isEmpty(tagArr[index])) {
            console.warn("快捷聊天接收数据非法:没有该标签下语句");
            return;
          }
...
//# sourceMappingURL=892ae97ad025cc063f410f6c7d129460903bc055.js.map