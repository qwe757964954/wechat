System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, AppEvent, GConstants, StoreKey, GameTxt, UIID, LocalStorage, Utils, Encrypt, EventManager, BaseCache, GCache, SelectGame, _crd;
    ...
    execute: function () {
      ...
      _export("SelectGame", SelectGame = class SelectGame extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        willEnterGame(gameID, roomLevel) {
          ...
          if (roomLevel == 0) {
            //快速开始
            var roomList = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            }), GCache) : GCache).SelectGame.getGameLevelRoomListAll(gameID);
            ...
            //正常点击进入房间
            var _roomList = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
        ...
        checkQuickGame(gameId, tabId) {
          ...
          var brokeLevel = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).BankrupData.getBankruptLowestMoney(); //获取最低银币的房间

          var minRoomData = this.getGameLevelRoomCanEnter(gameId, gameTabId, gameLevelId);
          console.log('判断是否破产', minRoomData < brokeLevel);

          if (!minRoomData) {
            var getBankruptRewardBol = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            ...
            if (minRoomData < brokeLevel && getBankruptRewardBol) {
              ...
              (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                ...
                error: Error()
              }), AppEvent) : AppEvent).NET_REQ_BANKRUPT_GIFT_CONF, gameId, gameLevelId);
              (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                error: Error()
              }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
                error: Error()
        ...
        checkIntoRoom(gameId, roomData) {
          ...
          var brokeLevel = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).BankrupData.getBankruptLowestMoney();
          ...
          if (max == -1) {
            ...
            if (userGold < min) {
              var _getBankruptRewardBol = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                error: Error()
              }), GCache) : GCache).BankrupData.isBankruptRewardRemain(); // 破产且有可领取的次数


              if (userGold < brokeLevel && _getBankruptRewardBol) {
                (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                  error: Error()
                }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
                  error: Error()
...
//# sourceMappingURL=dcd9046e0c53c8fc531a778d745cc6c4158f139b.js.map