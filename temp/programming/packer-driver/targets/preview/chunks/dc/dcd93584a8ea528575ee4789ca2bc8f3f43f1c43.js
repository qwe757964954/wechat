System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      checkLocalLittleEndian = function checkLocalLittleEndian() {
      ...
      WriteBuffer = class WriteBuffer {
        ...
        insertPacket(arrayBuffer, isLittleEndian) {
          if (isLittleEndian === void 0) {
            isLittleEndian = false;
          }
          ...
          var dataView = new DataView(arrayBuffer, 0); //取出来

          var commondBuffer = dataView.buffer.slice(0, dataView.buffer.byteLength);
          var uBuffer = new Int8Array(commondBuffer);
          /**注意 */
          //合并

          for (var index = 0; index < uBuffer.byteLength; index++) {
        ...
        writeInt(packetID, value) {
          ...
          if (MapArrayBuffer[packetID] && value != null) {
            var array = MapArrayBuffer[packetID]; //新长度

            var newBuffer = new ArrayBuffer(4);
            var newDataView = new DataView(newBuffer);
            newDataView.setInt32(0, value, array.isLittleEndian);
            /**注意 */
            //取出来

            var commondBuffer = newDataView.buffer.slice(0, newDataView.buffer.byteLength);
            var uBuffer = new Int8Array(commondBuffer);
            /**注意 */
            //合并
        ...
        writeUInt(packetID, value) {
          ...
          if (MapArrayBuffer[packetID] && value != null) {
            ...
            var commondBuffer = newDataView.buffer.slice(0, newDataView.buffer.byteLength);
            var uBuffer = new Uint8Array(commondBuffer);
            /**注意 */
            //合并
        ...
        writeShort(packetID, value) {
          ...
          if (MapArrayBuffer[packetID] && value != null) {
            ...
            var newBuffer = new ArrayBuffer(2);
            var newDataView = new DataView(newBuffer);
        ...
        writeByte(packetID, value) {
          ...
          if (MapArrayBuffer[packetID] && value != null) {
            ...
            var newBuffer = new ArrayBuffer(1);
            var newDataView = new DataView(newBuffer);
        ...
        writeString(packetID, str) {
          ...
          if (MapArrayBuffer[packetID]) {
            var newLength = 1; //字符串字节长度

            var strByteLength = 0; //字符串转字节数组

            var byteArray = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
              error: Error()
            ...
            var array = MapArrayBuffer[packetID];

            for (var _index = 0; _index < uBuffer.byteLength; _index++) {
              array.byteArray.push(uBuffer[_index]);
              array.readByteArray.push(uBuffer[_index]);
            }
        ...
        writeStringNoZeroEnd(packetID, str) {
          if (packetID === void 0) {
            packetID = null;
          }
          ...
          if (MapArrayBuffer[packetID]) {
            ...
            for (var _index2 = 0; _index2 < uBuffer.byteLength; _index2++) {
              array.byteArray.push(uBuffer[_index2]);
              array.readByteArray.push(uBuffer[_index2]);
            }
      ...
      ReadBuffer = class ReadBuffer {
         ...
         */
        readPacket(packetID, isOnlyRead, isOriginal, isUByte) {
          if (packetID === void 0) {
            packetID = null;
          }

          if (isOnlyRead === void 0) {
            isOnlyRead = false;
          }

          if (isOriginal === void 0) {
            isOriginal = false;
          }
          ...
          if (MapArrayBuffer[packetID]) {
            ...
            var newArrayBuffer = newArray.buffer.slice(0, newArray.byteLength);
            var newDataView = new DataView(newArrayBuffer); //返回值
        ...
        syncPacket(packetID) {
          ...
          if (MapArrayBuffer[packetID]) {
            var array = MapArrayBuffer[packetID];
            var fromArray = array.byteArray;
            var toArray = array.readByteArray;
        ...
        readPacketOffset(packetID, offset) {
          if (packetID === void 0) {
            packetID = null;
          }
        ...
        readInt(packetID, isLittleEndian, isNotDel) {
          if (packetID === void 0) {
            packetID = null;
          }
          ...
          if (MapArrayBuffer[packetID]) {
            var array = MapArrayBuffer[packetID]; //定义取出长度
            ...
            var newByteArray = array.readByteArray.slice(0, size);

            if (isNotDel != true) {
              array.readByteArray.splice(0, size);
            }

            var newArray = new Int8Array(newByteArray.length);
            /**注意 */
            //单独装进缓冲区
        ...
        readUInt(packetID, isLittleEndian, isNotDel) {
          if (packetID === void 0) {
            packetID = null;
          }
          ...
          if (MapArrayBuffer[packetID]) {
            ...
            var newArray = new Uint8Array(newByteArray.length);
            /**注意 */
            //单独装进缓冲区
        ...
        readInt64(packetID) {
          ...
          if (MapArrayBuffer[packetID]) {
            ...
            var int64 = new (_crd && Int64 === void 0 ? (_reportPossibleCrUseOfInt({
              error: Error()
        ...
        readShort(packetID, isLittleEndian) {
          if (packetID === void 0) {
            packetID = null;
          }
        ...
        readUShort(packetID, isLittleEndian) {
          if (packetID === void 0) {
            packetID = null;
          }
        ...
        readString(packetID, isLittleEndian) {
          if (packetID === void 0) {
            packetID = null;
          }
          ...
          if (MapArrayBuffer[packetID]) {
            var array = MapArrayBuffer[packetID]; //先读取缓存包定义的正文长度

            var readDataView = this.readPacket(packetID, true);
            ...
            var size = readDataView.getInt32(0, isLittleEndian != null ? isLittleEndian : array.isLittleEndian);
            /**注意 */
            //头部字节长度

            var startHeatLength = 4; //末尾0的长度
            ...
            var commonArrayBuffer = readDataView.buffer.slice(startHeatLength, startHeatLength + commonLength);
            var commonByteArray = new Uint8Array(commonArrayBuffer);
            /**注意 */

            var result = []; // byte队列

            for (var index = 0; index < commonByteArray.byteLength; index++) {
              result.push(commonByteArray[index]);
            } //拼接的字符串


            var strData = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
              error: Error()
        ...
        readStringNoZeroEnd(packetID, isLittleEndian) {
          if (packetID === void 0) {
            packetID = null;
          }
...
//# sourceMappingURL=dcd93584a8ea528575ee4789ca2bc8f3f43f1c43.js.map