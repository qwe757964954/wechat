      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cardAddTouchEvent(handNode) {
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            // 获取当前节点的位置
            var nodePosition = this.node.position; // 获取触摸的上一帧位置

            var touchDelta = event.getDelta(); // 在Y轴上添加触摸位移
...
//# sourceMappingURL=2e50252c6ab1e9bdf413c40f22599dc4074828ab.js.map