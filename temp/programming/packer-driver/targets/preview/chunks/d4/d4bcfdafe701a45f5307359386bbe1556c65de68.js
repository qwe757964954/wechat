System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Label, Node, _decorator, Utils, BaseComponent, RoomMgr, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, Remain;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['EventTouch', 'Label', 'Node', '_decorator']);
      ...
      _export("Remain", Remain = (_dec = ccclass('Remain'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class Remain extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
      }), BaseComponent) : BaseComponent) {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "rootTimeNode", _descriptor, this);

          _initializerDefineProperty(this, "rootRemainCardNode", _descriptor2, this);

          _initializerDefineProperty(this, "timeLabel", _descriptor3, this);

          _initializerDefineProperty(this, "remainCardLabel", _descriptor4, this);
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "rootTimeNode", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "rootRemainCardNode", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "remainCardLabel", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=d4bcfdafe701a45f5307359386bbe1556c65de68.js.map