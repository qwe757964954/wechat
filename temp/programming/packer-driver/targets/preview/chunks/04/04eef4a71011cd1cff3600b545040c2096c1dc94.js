    ...
    execute: function () {
      ...
      _export("NodeWallCtr", NodeWallCtr = (_dec = ccclass('NodeWallCtr'), _dec2 = property({
        ...
        onReconnect(data) {
          ...
          var bankSeatId = data.bankSeatId;
          var gangCount = data.gangCount;
          ...
          for (var i = 0; i < this._wallList.length - remain; i++) {
            this.takeOneCard();
          }

          for (var _i6 = 0; _i6 < gangCount; _i6++) {
            this.takeOneCardFromTail();
          }
...
//# sourceMappingURL=04eef4a71011cd1cff3600b545040c2096c1dc94.js.map