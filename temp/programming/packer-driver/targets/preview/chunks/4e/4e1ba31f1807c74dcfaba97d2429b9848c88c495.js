    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cardAddTouchEvent(handNode) {
          ...
          handNode.on(Node.EventType.TOUCH_END, event => {
            ...
            if (currentTime - this.lastClickTime < this.clickThreshold) {
              // 双击事件逻辑
              console.log("Double Clicked!"); // this.playSelectAnim(event.target);
              // 在这里执行你想要的双击操作
            }
        ...
        onTouchMove(event) {
          ...
          this.startPositionY = this.startPositionY + event.getDeltaY();
          console.log("deltaY_________________", this.startPositionY);

          this._touchNode.setPosition(this._touchNode.getPosition().x, this.startPositionY, this._touchNode.getPosition().z);
        }
...
//# sourceMappingURL=4e1ba31f1807c74dcfaba97d2429b9848c88c495.js.map