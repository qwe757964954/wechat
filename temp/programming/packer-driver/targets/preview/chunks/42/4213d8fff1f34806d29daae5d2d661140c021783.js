  ...
  return {
    ...
    execute: function () {
      ...
      _export("WXSdk", WXSdk = class WXSdk {
        ...
        login(timeout, success, fail, complete) {
          if (timeout === void 0) {
            timeout = null;
          }
        ...
        request(url, success, fail, complete, data, header, timeout, method, dataType, responseType) {
          if (success === void 0) {
            success = null;
          }
        ...
        getUserInfo(withCredentials, lang, success, fail, complete) {
        ...
        authorize(scope, success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
        ...
        onNeedPrivacyAuthorization(event, callback) {
          if (event === void 0) {
            event = null;
          }
        ...
        openPrivacyContract(isCheck, success, fail, complete) {
          if (isCheck === void 0) {
            isCheck = false;
          }
        ...
        hideToast(noConflict, success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
        ...
        hideLoading(noConflict, success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
        ...
        setClipboardData(data, success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
        ...
        getClipboardData(success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
        ...
        showShareMenu(withShareTicket, menus, success, fail, complete) {
        ...
        openCustomerServiceConversation(sessionFrom, success, fail, complete, showMessageCard, sendMessageTitle, sendMessagePath, sendMessageImg) {
          if (sessionFrom === void 0) {
            sessionFrom = "";
          }
          ...
          if (showMessageCard === void 0) {
            showMessageCard = false;
          }

          if (sendMessageTitle === void 0) {
            sendMessageTitle = null;
          }

          if (sendMessagePath === void 0) {
            sendMessagePath = null;
          }

          if (sendMessageImg === void 0) {
            sendMessageImg = null;
          }
        ...
        compareSdkVersion(v1, v2) {
          var v1Sum = v1.split('.');
          var v2Sum = v2.split('.');
          var len = Math.max(v1Sum.length, v2Sum.length);
          ...
          for (var i = 0; i < len; i++) {
            var num1 = parseInt(v1Sum[i]);
            var num2 = parseInt(v2Sum[i]);
        ...
        connectSocket(url, success, fail, complete, header, timeout, protocols, tcpNoDelay, perMessageDeflate) {
          if (success === void 0) {
            success = null;
          }
          ...
          if (tcpNoDelay === void 0) {
            tcpNoDelay = false;
          }

          if (perMessageDeflate === void 0) {
        ...
        requestMidasPayment(buyQuantity, offerId, env, zoneId, success, fail, complete) {
          if (env === void 0) {
            env = 0;
          }
         ...
         * @param complete 
         */
        setUserCloudStorage(KVDataList, success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
        ...
        getUserCloudStorage(keyList, success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
        ...
        requestSubscribeMessage(tmplIds, success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
        ...
        vibrateShort(type, success, fail, complete) {
          if (type === void 0) {
            type = (_crd && WXSdk_VibrateShortType === void 0 ? (_reportPossibleCrUseOfWXSdk_VibrateShortType({
              error: Error()
        ...
        setEnableDebug(enableDebug, success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
        ...
        downloadFile(url, timeout, filePath, success, fail, complete) {
          if (timeout === void 0) {
            timeout = 5000;
          }
        ...
        createRewardedVideoAd(adUnitId, success, fail, clickCloseFunc) {
          if (success === void 0) {
            success = null;
          }
        ...
        addRewardedVideoAdListener(success, fail, clickCloseFunc, isInit) {
          if (success === void 0) {
            success = null;
          }
        ...
        playRewardedVideoShow(success, fail, clickCloseCallback) {
          if (success === void 0) {
            success = null;
          }
          ...
          if (clickCloseCallback === void 0) {
            clickCloseCallback = null;
          }
        ...
        setKeepScreenOn(isLight, success, fail, complete) {
          if (success === void 0) {
            success = null;
          }
...
//# sourceMappingURL=4213d8fff1f34806d29daae5d2d661140c021783.js.map