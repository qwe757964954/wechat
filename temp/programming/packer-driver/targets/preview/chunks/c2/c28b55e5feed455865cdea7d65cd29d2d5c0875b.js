System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, Enum, ImageAsset, Sprite, SpriteFrame, UITransform, _decorator, Utils, resLoader, decompressFrames, parseGIF, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, menu, GifRenderLoadModel, GifArrayBufferList, GifRenderLoad;
    ...
    execute: function () {
      ...
      _export("GifRenderLoad", GifRenderLoad = (_dec = ccclass('GifRenderLoad'), _dec2 = menu('gui/sprite/GifRenderLoad'), _dec3 = property({
        ...
        setLocalLoad(bundle, path) {
          ...
          var realPath = this.resPath.replace(/\.(?:gif|png|jpg|webp|jpeg)$/i, "");
        ...
        _startDraw(oneCache) {
          ...
          var _needsDisposal = true;
          var _frameIndex = 0;
          var _frameWidth = 9999;
          var _frameHeight = 9999;
          var _frameData = null;
          ...
          _drawFunc = function drawFunc() {
            if (!self._showSprite || !self.node || self.node.isValid == false) {
              return;
            }

            var cache = oneCache;
            var frame = cache.frames[_frameIndex];
            var start = Date.now();
...
//# sourceMappingURL=c28b55e5feed455865cdea7d65cd29d2d5c0875b.js.map