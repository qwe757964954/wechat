      ...
      _export("HallController", HallController = class HallController extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        respLoginCoreInit(event, isSuccess, respData, reqData) {
          ...
          if (respData["goodsbase_url"]) {
            var conf = respData["goodsbase_url"];
        ...
        reqHallGameConfig(event) {
          var param = {
            ...
            //用户上次登录的Mid, 用于游戏列表白名单控制
            branch: (_crd && Platform === void 0 ? (_reportPossibleCrUseOfPlatform({
              error: Error()
            }), Platform) : Platform).isIOS() ? 0 : 1 // 强制android使用完整包，ios使用正常包
        ...
        reqGameLeaveRoom(event, gameID, islevel_500) {
          if (gameID === void 0) {
            gameID = null;
          }

          if (islevel_500 === void 0) {
            islevel_500 = 1;
          }
          ...
          var ver = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        reqGameLeavePersonCount(event, gameID) {
          if (gameID === void 0) {
            gameID = null;
          }
        ...
        reqGoodsBase(event) {
          this.print("基础配置请求");
          var baseConfTime = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          var unionConfTime = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).PropsConf.getPropsConfTime((_crd && StoreKey === void 0 ? (_reportPossibleCrUseOfStoreKey({
            error: Error()
          ...
          var type = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
            error: Error()
        ...
        respGoodsBase(event, isSuccess, respData, reqData) {
          ...
          if (isSuccess) {
            if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              ...
              var propsUrlConf = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                error: Error()
              }), GCache) : GCache).PropsConf.getPropsBaseUrlConf();
              var iconPre = propsUrlConf["icon_pre"];
              ...
              var time = propsUrlConf["srvtime"];
              var filepre = propsUrlConf["file_pre"];
              var filename = propsUrlConf['file_name'];
              var coreGoodsBaseUrl = filepre + filename[4] + "?v=" + time;
              var unionGoodsBaseUrl = filepre + filename[5] + "?v=" + time;
...
//# sourceMappingURL=8a2267319f95f237e30d2373c86781f1a2efd667.js.map