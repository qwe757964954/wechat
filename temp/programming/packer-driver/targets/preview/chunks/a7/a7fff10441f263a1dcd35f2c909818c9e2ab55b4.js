System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Camera, Node, Prefab, Sprite, UITransform, Vec3, _decorator, renderer, GCache, AppEvent, ClientInfo, GConstants, GameRes, GameResPreLoad, UIConfigData, Utils, LayerManager, EventManager, BaseComponent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, menu, runSceneCtr;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Camera', 'EventTouch', 'Node', 'Prefab', 'Sprite', 'UITransform', 'Vec3', '_decorator', 'renderer']);
      ...
      _export("runSceneCtr", runSceneCtr = (_dec = ccclass('runSceneCtr'), _dec2 = menu('scenes/runSceneCtr'), _dec3 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "debugNode", _descriptor6, this);

          _initializerDefineProperty(this, "loading", _descriptor7, this);

          _initializerDefineProperty(this, "aniClick", _descriptor8, this);
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "debugNode", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "loading", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "aniClick", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=a7fff10441f263a1dcd35f2c909818c9e2ab55b4.js.map