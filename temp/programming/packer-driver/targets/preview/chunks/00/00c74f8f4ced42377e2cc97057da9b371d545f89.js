System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      n = r(function (e, r) {
        ...
        r.readBytes = t, r.peekBytes = function (e) {
          ...
          return function (n, i, a) {
            for (var o = "function" == typeof r ? r(n, i, a) : r, d = t(e), u = new Array(o), c = 0; c < o; c++) {
              u[c] = d(n);
            }
      ...
      i = /*@__PURE__*/e(r(function (e, r) {
        ...
        var i = {
          blocks: function blocks(e) {
            ...
            for (var d = new Uint8Array(i), u = 0, c = 0; c < r.length; c++) {
              d.set(r[c], u), u += r[c].length;
            }
          ...
          text: [{
            ...
            preData: function preData(e, r, t) {
      ...
      _export("parseGIF", a = function a(e) {
        var r = new Uint8Array(e);
        return t.parse(n.buildStream(r), i);
      });

      _export("decompressFrame", o = function o(e, r, t) {
        if (e.image) {
          var n = e.image,
              i = function (e, r, t) {
            var n,
            ...
            for (d = 1 + (i = 1 << (l = e)), n = i + 2, c = -1, a = (1 << (o = l + 1)) - 1, s = 0; s < i; s++) {
              k[s] = 0, w[s] = s;
            }
          ...
          n.descriptor.lct.interlaced && (i = function (e, r) {
            for (var t = new Array(e.length), n = e.length / r, i = function i(n, _i) {
              var a = e.slice(_i * r, (_i + 1) * r);
              t.splice.apply(t, [n * r, r].concat(a));
            }, a = [0, 4, 2, 1], o = [8, 8, 4, 2], d = 0, u = 0; u < 4; u++) {
              for (var c = a[u]; c < n; c += o[u]) {
                i(c, d), d++;
              }
            }
      ...
      _export("decompressFrames", d = function d(e, r) {
...
//# sourceMappingURL=00c74f8f4ced42377e2cc97057da9b371d545f89.js.map