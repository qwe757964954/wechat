System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, ClientInfo, StoreKey, Encrypt, LocalStorage, HttpRequest, Utils, BaseCache, PropsConf, _crd;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ClientInfo = _unresolved_2.ClientInfo;
    ...
    execute: function () {
      ...
      _export("PropsConf", PropsConf = class PropsConf extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        downloadAndSavePropsConf(url, key, count) {
          ...
          var realkey = key + "_" + (_crd && ClientInfo === void 0 ? (_reportPossibleCrUseOfClientInfo({
            error: Error()
            ...
            if (response) {
              ...
              if (timestamp > 0 && timestamp > oldTime) {
                (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
                  error: Error()
                }), LocalStorage) : LocalStorage).set(realkey, response);
        ...
        getPropsConfTime(key) {
          ...
          if (flag != -1) {
            var jsonStr = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
              error: Error()
            }), LocalStorage) : LocalStorage).get(key + "_" + (_crd && ClientInfo === void 0 ? (_reportPossibleCrUseOfClientInfo({
              error: Error()
            }), ClientInfo) : ClientInfo).CurrowServer, '');
        ...
        getBaseProps() {
          var key = (_crd && StoreKey === void 0 ? (_reportPossibleCrUseOfStoreKey({
            error: Error()
          }), StoreKey) : StoreKey).PROPS_BASE_CONF + "_" + (_crd && ClientInfo === void 0 ? (_reportPossibleCrUseOfClientInfo({
            error: Error()
          }), ClientInfo) : ClientInfo).CurrowServer;
        ...
        getUnionProps() {
          var key = (_crd && StoreKey === void 0 ? (_reportPossibleCrUseOfStoreKey({
            error: Error()
          }), StoreKey) : StoreKey).PROPS_UNION_CONF + "_" + (_crd && ClientInfo === void 0 ? (_reportPossibleCrUseOfClientInfo({
            error: Error()
          }), ClientInfo) : ClientInfo).CurrowServer;
        ...
        getPropsInfoById(id) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).table_isEmpty(baseProps['GoodsBase'])) {
            return {};
          }
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).table_isEmpty(baseConf)) {
            return {};
          }
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).table_isEmpty(unionProps['GoodsBase'])) {
            return {};
          }
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).table_isEmpty(unionConf)) {
            return {};
          }
...
//# sourceMappingURL=68ac314b661a35f46c4ebb0204ece0403d7d20fb.js.map