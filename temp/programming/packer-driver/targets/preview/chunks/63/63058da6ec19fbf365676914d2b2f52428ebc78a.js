    ...
    execute: function () {
      ...
      _export("SelectGame", SelectGame = class SelectGame extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        willEnterGame(gameID, roomLevel) {
          ...
          if (roomLevel == 0) {
            //快速开始
            var roomList = this.__User.SelectGame.getGameLevelRoomListAll(gameID);
            ...
            //正常点击进入房间
            var _roomList = this.__User.SelectGame.getGameRoomInfoByRoomLevelID(gameID, roomLevel);
...
//# sourceMappingURL=63058da6ec19fbf365676914d2b2f52428ebc78a.js.map