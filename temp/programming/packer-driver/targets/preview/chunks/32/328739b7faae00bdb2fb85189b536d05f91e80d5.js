System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Node, Tween, Vec3, _decorator, instantiate, tween, Utils, BaseComponent, GameViewConfig, NodeCardCtr, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, NodeOutCardCtr;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GameViewConfig = _unresolved_4.GameViewConfig;
    }, function (_unresolved_5) {
      NodeCardCtr = _unresolved_5.NodeCardCtr;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("NodeOutCardCtr", NodeOutCardCtr = (_dec = ccclass('NodeOutCardCtr'), _dec2 = property({
        ...
        initView() {
          var indexStart = ((_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          ...
          for (var dir = 0; dir < 4; dir++) {
            ...
            for (var i = 0; i < 18; i++) {
              var length = this._seatList[dir].length;
              var layer = Math.floor(length / 6);
              var index = length % 6;
              var distanceFromCenter = distance + (layer - 1) * (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.Height; // 离桌面中心的垂直距离

              var leftToRight = -indexStart + index * ((_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
            ...
            for (var _i = 0; _i < 9; _i++) {
              var _length = this._seatList[dir].length;

              var _layer = Math.ceil((_i + 1) / 3);

              var _index = _length % 3;

              var _distanceFromCenter = distance + (_layer - 2) * (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.Height; // 离桌面中心的垂直距离


              var _leftToRight = -indexStart + 6 * (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.Width + 1 + _index * ((_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.Width + (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.SpaceOutCard); // 指定层的第index张牌的位置
              ...
              var _card = instantiate(this.nodeCard);

              _card.setPosition(_leftToRight, (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.GroundToCard, _distanceFromCenter);

              nodeSeat.addChild(_card);

              this._seatList[dir].push(_card);
            }
          }

          this.nodeArrow.setPosition(0, -4.5, 0);
          var pos = this.nodeArrow.getPosition();
        ...
        showCard(dir, cardNumber) {
          var cardList = this._seatList[dir];
          ...
          var pos = cardList[index].getPosition();
          ...
          var moveTween = tween(this.nodeArrow).by(0.6, {
...
//# sourceMappingURL=328739b7faae00bdb2fb85189b536d05f91e80d5.js.map