    ...
    execute: function () {
      ...
      _export("Carditem", Carditem = (_dec = ccclass('Carditem'), _dec2 = property({
        ...
        updateCardItemProp(opTypes) {
          ...
          var cardLayout = this.node.getComponent(Layout);
          ...
          if (cardLayout) {
            ...
            cardLayout.constraint = Layout.Constraint.FIXED_COL;
            cardLayout.constraintNum = rowNum > 2 ? 2 : rowNum; // cardLayout.constraint = Layout.Constraint.FIXED_ROW;
            // cardLayout.constraintNum = Math.round(rowNum / 2);
          } else {
            console.error("Layout component not found on the target node.");
          }

          cardLayout.updateLayout();
          var transform = this.node.getComponent(UITransform); // transform.height = 500;
...
//# sourceMappingURL=876977fbe568eb3cb14438aab85a20f7403a4d77.js.map