      ...
      _export("NodeHandCardCtr", NodeHandCardCtr = (_dec = ccclass('NodeHandCardCtr'), _dec2 = property({
        ...
        resetView() {
          ...
          for (var _dir = 0; _dir < this._seatList.length; _dir++) {
            ...
            for (var _i = 0; _i < cards.length; _i++) {
              ...
              cards[_i].setPosition(pos.x, (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.GroundToHandCard, (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.CenterToHandCard);
        ...
        normalOutCardAny(dir, count) {
          ...
          for (var _i2 = 0; _i2 < num; _i2++) {
            var pos = cards[_i2].getPosition(); // 使用动画移动到目标位置


            var x = -this._cardStart + _i2 * (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
              error: Error()
            }), GameViewConfig) : GameViewConfig).CardConfig.Width;

            if (_i2 == num - 1 && num % 3 == 2) {
              x += this._spaceLast;
            }

            tween(cards[_i2]).to(0.06 * count, {
...
//# sourceMappingURL=871160eb64090377e5e6225b1dc52cbe795cd206.js.map