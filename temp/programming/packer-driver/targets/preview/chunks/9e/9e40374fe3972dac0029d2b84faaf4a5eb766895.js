    ...
    execute: function () {
      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onOutCard() {
          ...
          var opCards = (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCards;
          var opCard = (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
        ...
        onAnGangCard() {
          ...
          var isGrab = opCards.indexOf(myHand.drawByte) !== -1;
...
//# sourceMappingURL=9e40374fe3972dac0029d2b84faaf4a5eb766895.js.map