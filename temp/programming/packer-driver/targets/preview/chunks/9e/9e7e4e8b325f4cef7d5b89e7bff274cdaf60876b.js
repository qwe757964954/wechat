    ...
    execute: function () {
      ...
      _export("Carditem", Carditem = (_dec = ccclass('Carditem'), _dec2 = property({
        ...
        updateCardItemProp(opTypes) {
          ...
          var constraintNum = rowNum > 2 ? 2 : rowNum; // cardLayout.updateLayout();

          var transform = this.node.getComponent(UITransform); // transform.height = Math.round(rowNum / 2) * 100;

          transform.width = constraintNum * item_width;
...
//# sourceMappingURL=9e7e4e8b325f4cef7d5b89e7bff274cdaf60876b.js.map