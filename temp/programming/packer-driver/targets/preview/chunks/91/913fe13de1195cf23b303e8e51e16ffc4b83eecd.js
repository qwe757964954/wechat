System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GameViewConfig = _unresolved_13.GameViewConfig;
    }, function (_unresolved_14) {
      NodeClockCtr = _unresolved_14.NodeClockCtr;
    }, function (_unresolved_15) {
      NodeDiceCtr = _unresolved_15.NodeDiceCtr;
    }, function (_unresolved_16) {
      NodeHandCardCtr = _unresolved_16.NodeHandCardCtr;
    }, function (_unresolved_17) {
      NodeHuCardCtr = _unresolved_17.NodeHuCardCtr;
    }, function (_unresolved_18) {
      NodeMeldCardCtr = _unresolved_18.NodeMeldCardCtr;
    }, function (_unresolved_19) {
      NodeOutCardCtr = _unresolved_19.NodeOutCardCtr;
    }, function (_unresolved_20) {
      NodeWallCtr = _unresolved_20.NodeWallCtr;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameDeskPrefabCtr", GameDeskPrefabCtr = (_dec = ccclass('GameDeskPrefabCtr'), _dec2 = menu('prefab/game/GameDeskPrefabCtr'), _dec3 = property({
        ...
        onInitModuleEvent() {
          ...
          this.addModelListener((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
            error: Error()
          }), GameEvent) : GameEvent).VIEW_BROADCAST_GAME_OVER, this.onGameOver); // 重连

          this.addModelListener((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
            error: Error()
          }), GameEvent) : GameEvent).RECEIVE_DEAL_CARD, this.onReconnect); // this.node.on(Node.EventType.TOUCH_END, this.onOprationTouchEnd, this);
        }
        ...
        onGameStart() {
          ...
          var dataAnim = {
            seatId: (_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
              error: Error()
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), FXJEvent) : FXJEvent).VIEW_OUT_CARD_ANI_PLAY, dataAnim);
        }
        /** 摇色子 */
        ...
        onReconnect() {
          var data = {
            bankSeatId: (_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
              error: Error()
            }), RoomMgr) : RoomMgr).getInstance().bankSeatId,
            dices: (_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
              error: Error()
            }), RoomMgr) : RoomMgr).getInstance().dices,
            remain: (_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
              error: Error()
            }), RoomMgr) : RoomMgr).getInstance().remainCardsCount,
            gangCount: 0,
            playerList: (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
              error: Error()
            }), PlayerMgr) : PlayerMgr).getInstance().playerList,
            operationSeatId: (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
              error: Error()
            }), OperationMgr) : OperationMgr).getInstance().seatId,
            operationTimePass: (_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
              error: Error()
            }), RoomMgr) : RoomMgr).getInstance().timePass
          };
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            error: Error()
          }), Utils) : Utils).table_isEmpty(data.dices)) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).isNull(data.bankSeatId) || data.bankSeatId < 1 || data.bankSeatId > 4) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).table_isEmpty(data.playerList)) {
            this.log("GameDeskPrefabCtr.onReconnect", "玩家数据异常", data);
            return;
          }

          data.playerList.forEach((value, index, array) => {
            for (var _i = 0; _i < value.opGroups.length; _i++) {
              var dataItem = value.opGroups[_i];
...
//# sourceMappingURL=913fe13de1195cf23b303e8e51e16ffc4b83eecd.js.map