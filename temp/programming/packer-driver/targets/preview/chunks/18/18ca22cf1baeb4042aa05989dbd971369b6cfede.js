  ...
  return {
    ...
    execute: function () {
      ...
      _export("BugangTop", BugangTop = (_dec = ccclass('BugangTop'), _dec2 = property(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
        ...
        /** override 初始化模块事件 */
        onInitModuleEvent() {// this.addModelListener(GameEvent.VIEW_UPDATE_FAN_GANG_PAI, this.updateFanGangPai);
        }

        onLoad() {}

        updateFanGangPai(resp) {
          //card
          var cardArray = [this.leftCard, this.rightCard];
          resp.cards.forEach((card, index) => {
...
//# sourceMappingURL=18ca22cf1baeb4042aa05989dbd971369b6cfede.js.map