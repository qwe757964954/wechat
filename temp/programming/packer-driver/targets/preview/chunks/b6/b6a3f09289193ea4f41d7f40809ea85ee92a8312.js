      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onOutCard() {
          ...
          if (this.pengArr.indexOf((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            ...
            var _insertIndex = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
              error: Error()
            }), PlayerMgr) : PlayerMgr).getInstance().getIndexByHandCards(myHand.drawByte, (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
              error: Error()
            }), OperationResultMgr) : OperationResultMgr).getInstance().opCard);

            myHand.makeSlotAnim(_insertIndex);
            myHand.drawCardToSlot();
          } else {
            myHand.playCardFromHandAnim(indexs[0]);

            var _insertIndex2 = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
              error: Error()
            }), PlayerMgr) : PlayerMgr).getInstance().getIndexByHandCards(myHand.drawByte, (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
              error: Error()
            }), OperationResultMgr) : OperationResultMgr).getInstance().opCard);

            myHand.makeSlotAnim(_insertIndex2);
            myHand.drawCardToSlot();
          }
...
//# sourceMappingURL=b6a3f09289193ea4f41d7f40809ea85ee92a8312.js.map