System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19", "__unresolved_20"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, GCache, Encrypt, EventManager, Utils, RoomController, PlayerMgr, Room, RoomMgr, SettleMgr, FXJCMDHead, FXJWriteAndRead, OPCode, FXJConstant, FXJEvent, FXJObserver, FXJUIID, GameEvent, ChatServer, RoundServer, SettleServer, FXJController, _crd;
  ...
  function _reportPossibleCrUseOfOPCode(extras) {
    _reporterNs.report("OPCode", "./FXJConfig", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SettleMgr = _unresolved_10.SettleMgr;
    }, function (_unresolved_11) {
      FXJCMDHead = _unresolved_11.FXJCMDHead;
    }, function (_unresolved_12) {
      FXJWriteAndRead = _unresolved_12.FXJWriteAndRead;
    }, function (_unresolved_13) {
      OPCode = _unresolved_13.OPCode;
    }, function (_unresolved_14) {
      FXJConstant = _unresolved_14.FXJConstant;
    }, function (_unresolved_15) {
      FXJEvent = _unresolved_15.FXJEvent;
    }, function (_unresolved_16) {
      FXJObserver = _unresolved_16.FXJObserver;
    }, function (_unresolved_17) {
      FXJUIID = _unresolved_17.FXJUIID;
    }, function (_unresolved_18) {
      GameEvent = _unresolved_18.GameEvent;
    }, function (_unresolved_19) {
      ChatServer = _unresolved_19.ChatServer;
    }, function (_unresolved_20) {
      RoundServer = _unresolved_20.RoundServer;
    }, function (_unresolved_21) {
      SettleServer = _unresolved_21.SettleServer;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("FXJController", FXJController = class FXJController extends (_crd && RoomController === void 0 ? (_reportPossibleCrUseOfRoomController({
        ...
        get IsReconn() {
          var _this$_intoGameData;

          return (_this$_intoGameData = this._intoGameData) == null ? void 0 : _this$_intoGameData.isReconn;
        }
        ...
        __initModuleEvent() {
          ...
          this.addModelListener((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
            error: Error()
          }), GameEvent) : GameEvent).NEXT_GAME_OPERATION, this.onNextGameOperation); //手动退出游戏

          this.addModelListener((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
            error: Error()
          }), GameEvent) : GameEvent).EXITS_GAME_ROOM_VIEW, this.exitsGameRoomView);
        }
        ...
        onNextGameOperation(event) {
          if (event === void 0) {
            event = null;
          }

          var roomInfo = (_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
            error: Error()
          }), RoomMgr) : RoomMgr).getInstance().getRoomInfoData(this._intoGameData.GameID);
          console.log("onNextGameOperation___________", (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).User.getUserSilver(), roomInfo);

          if ((_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).User.getUserSilver() < roomInfo.min_money) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).isNull((_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), FXJEvent) : FXJEvent).NET_REQ_ROOM_LOGIN);
          } else {
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).dispatch((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
              error: Error()
            }), GameEvent) : GameEvent).SHOW_HIDEN_MATCH_VIEW, true);
          } // EventManager.dispatch(FXJEvent.GAME_OPEN_POPUP, FXJUIID.GameMatchPrefab,null,{});

        } //操作


        sendPlayerOpration(event, info) {
          if (event === void 0) {
            event = null;
          }
          ...
          (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).Desk.turnMe = info.opCode === (_crd && OPCode === void 0 ? (_reportPossibleCrUseOfOPCode({
            error: Error()
        ...
        serverBroadcastPlayerLogin(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastFanGangPai(event, respData) {
          if (event === void 0) {
            event = null;
          }
        ...
        receiveExitRoomSuccess(event, respData) {
          ...
          (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
          }), PlayerMgr) : PlayerMgr).getInstance().deletePlayerLeave((_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        broadcastDingZhuang(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastGrabCard(event, resp) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), GameEvent) : GameEvent).VIEW_BROADCAST_GRAB_CARD, resp);
        }

        broadcastDingQueOptions(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastUserPiaoGang(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastPaoQianOptions(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastOneDingqueResult(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastAllShuaiQiangResult(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastAllDingqueResult(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastChaqueResult(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastMaiDuanMenUser(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastMaiDuanMenResult(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastUpdateFanGangPai(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastSelectFanGangPai(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastUserOperationResult(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastUserOperation(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastDoubleCards(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastRewardCards(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastPlayingJiType(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastSettleItem(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastBankerFirstOperation(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastUpdatePlayerMoney(event, resp) {
          if (event === void 0) {
            event = null;
          }
          ...
          (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), FXJEvent) : FXJEvent).VIEW_PLAYER_UPDATE_PROPERTY, player.userId);
          });
        }

        broadcastGameOperationResult(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastToWaitUserGiveUp(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastXiazhuOptions(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastXiazhuResult(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        broadcastGenZhuangSucc(event, resp) {
          if (event === void 0) {
            event = null;
          }
        ...
        receiveGameUserChat(event, respData) {
          ...
          if (respData) {
            var msg = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
              error: Error()
            }), Encrypt) : Encrypt).JsonDecode(respData['msg']);

            if (msg && msg['from'] && msg['to']) {
              var index = respData['index'];
              var mid = respData['mid'];
              var fromUid = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                error: Error()
              }), Utils) : Utils).number_valueOf(msg['from'], 0);
              var toUid = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                error: Error()
              }), Utils) : Utils).number_valueOf(msg['to'], 0);

              if (fromUid > 0 && toUid > 0 && index > 0) {
                var minPorpID = (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
                  error: Error()
                }), FXJConstant) : FXJConstant).EmojiProp[0].propID;
                var maxPorpID = (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
                  error: Error()
                }), FXJConstant) : FXJConstant).EmojiProp[(_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
                  error: Error()
                }), FXJConstant) : FXJConstant).EmojiProp.length - 1].propID;
...
//# sourceMappingURL=2bd679f90da92363ec8b869e4fea1c1d9b6c6735.js.map