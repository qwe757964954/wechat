System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, AppEvent, GConstants, StoreKey, GameTxt, LocalStorage, Utils, Encrypt, EventManager, BaseCache, GCache, SelectGame, _crd;
    ...
    execute: function () {
      ...
      _export("SelectGame", SelectGame = class SelectGame extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        checkIntoRoom(gameId, roomData) {
          ...
          var userGold = this.__User.getUserMoneyByID(moneyId);

          if (max == -1) {
            //一锅场、高级场，无上限
            if (userGold < min) {
              // this.showLimitGift() -- mark 资产不足 
              // 强弹  有破产先弹补助 没有再弹强弹
              (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                error: Error()
              }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
                ...
                error: Error()
              }), GConstants) : GConstants).PopupPos.POS_INTO_ROOM); // 破产礼包	
              ...
              //EventManager.dispatch(AppEvent.SYS_TOAST_TIP, { content: GameTxt.hall_goto_game_money_not_enough })
            ...
            if (userGold < min) {
              // if (userGold == 0) {
              // 	alert("破产了 弹出破产界面");
              // 	GameRoomHelper.checkIsBankruptAfterGameOver();
              // }
              // this.showLimitGift() -- mark 资产不足
              (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                error: Error()
...
//# sourceMappingURL=3e3bc123bd8ff0d453a0761720b06cccf75ef0f0.js.map