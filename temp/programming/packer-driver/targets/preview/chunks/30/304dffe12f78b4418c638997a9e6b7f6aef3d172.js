System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, GConstants, Utils, BaseCache, Platform, GCache, Activity, _crd;
  ...
  function _reportPossibleCrUseOfGCache(extras) {
    _reporterNs.report("GCache", "./GCache", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Activity", Activity = class Activity extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        getNewPlayerActivityCfgBykey(key, del) {
          if (del === void 0) {
            del = null;
          }
        ...
        updateHolidaysGiftPackage(body) {
          ...
          var keyArray = ["add_time", "appid", "basemap", "buyBtn", "edate", "edit_time", "firstIcon", "giftpack", //商品道具
          "id", "sdate", //开始时间
          "sedate", //结束时间
          "status"];
        ...
        */
        ...
        checkHolidayPop() {
          ...
          var giftpack = this._holidaysGiftPackage['giftpack'];
          var flag = false; //获取剩余次数

          for (var value of giftpack) {
        ...
        updateSigninBySuccess(body) {
          ...
          var signinDataToday = null;
          this._signinData.todayStatus = 1;

          if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).table_isEmpty(this._signinData.signAward)) {
            var itemData = this._signinData.signAward[this._signinData.today - 1];
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              ...
              for (var index = 0; index < this._signinData.continueAward.length; index++) {
                var _itemData = this._signinData.continueAward[index];

                if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  error: Error()
                }), Utils) : Utils).table_isEmpty(_itemData) && _itemData.day == body.ctDay) {
                  _itemData.status = 1;
                }
              }
            }
        ...
        updateContinusAward(body, day) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              ...
              for (var index = 0; index < this._signinData.continueAward.length; index++) {
                var itemData = this._signinData.continueAward[index];
        ...
        updateFirstPayPackage(body) {
          ...
          if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var keyArray = ["gid", "price", "goodsBaseMap", "firstIcon", "giftpack", "button", "popNum", "original_price"];
...
//# sourceMappingURL=304dffe12f78b4418c638997a9e6b7f6aef3d172.js.map