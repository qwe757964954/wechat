System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, Label, Node, Sprite, SpriteAtlas, SpriteFrame, _decorator, GCache, Encrypt, SpriteLoad, DelegateComponent, EventManager, Utils, BaseComponent, Platform, PlayerMgr, FXJConstant, FXJEvent, FXJRes, FXJSound, GameEvent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _crd, ccclass, property, menu, GameHeadInfoPrefabCtr;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      FXJConstant = _unresolved_11.FXJConstant;
    ...
    execute: function () {
      ...
      __checkObsolete__(['EventTouch', 'instantiate', 'Label', 'Node', 'Sprite', 'SpriteAtlas', 'SpriteFrame', '_decorator']);
      ...
      _export("GameHeadInfoPrefabCtr", GameHeadInfoPrefabCtr = (_dec = ccclass('GameHeadInfoPrefabCtr'), _dec2 = menu('prefab/game/GameHeadInfoPrefabCtr'), _dec3 = property({
        ...
        onInitModuleEvent() {
          ...
          this.addModelListener((_crd && FXJEvent === void 0 ? (_reportPossibleCrUseOfFXJEvent({
            error: Error()
          }), FXJEvent) : FXJEvent).USER_UPDATE_INFO, this.updateUserInfo); //玩家资产有更新

          this.addModelListener((_crd && FXJEvent === void 0 ? (_reportPossibleCrUseOfFXJEvent({
            error: Error()
          }), FXJEvent) : FXJEvent).USER_UPDATE_PROPERTY, this.updateCoin); //玩家退出
        ...
        updateHead() {
          ...
          var gameUserInfo = this._player.gameUserInfo;
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_isHttp(gameUserInfo.avatar_b)) {
        ...
        updateUserHeadBox() {
          ...
          var gameUserInfo = this._player.gameUserInfo;
          var spriteLoad = this.headFrameNode.getComponent(_crd && SpriteLoad === void 0 ? (_reportPossibleCrUseOfSpriteLoad({
            error: Error()
          }), SpriteLoad) : SpriteLoad);

          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_isHttp(gameUserInfo ? gameUserInfo["headBox"] : "")) {
        ...
        updateListProps() {
          ...
          var dataList = (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
            error: Error()
          }), FXJConstant) : FXJConstant).EmojiProp;
          var maxLen = this.propList.children.length;
          ...
          for (var i = 0; i < maxLen; i++) {
            if (dataList[i]) {
              (function () {
                var info = dataList[i];
                var itemNode = _this.propList.children[i];

                if (itemNode == null) {
                  itemNode = instantiate(_this.cloneProp);

                  _this.propList.addChild(itemNode);
                }

                var img_item = itemNode.getChildByName("img_item");

                _this.getPreLoaderRes((_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
                  error: Error()
                }), FXJRes) : FXJRes).Atlas_Game_EmojiProp.bundle, (_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
                  error: Error()
                }), FXJRes) : FXJRes).Atlas_Game_EmojiProp.path, SpriteAtlas, atlas => {
                  if (!img_item || img_item.isValid == false) {
                    return;
                  }

                  var spriteFrame = atlas.getSpriteFrame(info.icon);

                  if (spriteFrame) {
                    var spriteComponent = img_item.getComponent(Sprite);
                ...
                var node_price = itemNode.getChildByName("node_price");
                var money_icon = node_price.getChildByName("money_icon");
                var label_name = node_price.getChildByName("label_name");
        ...
        onClickProp(event) {
          ...
          var info = node["PropData"];
          console.log(info);
          var propsId = info.propID;
          var fromId = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          var text = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
            error: Error()
...
//# sourceMappingURL=eb23837aac48e19bcea88542cc913158c697afe2.js.map