    ...
    execute: function () {
      ...
      _export("FXJController", FXJController = class FXJController extends (_crd && RoomController === void 0 ? (_reportPossibleCrUseOfRoomController({
        ...
        onNextGameOperation(event) {
          ...
          // let data = GCache.SelectGame.getServerGameLevelTabListByGameID(this._intoGameData.GameID);
          console.log("onNextGameOperation____________________", (_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
            error: Error()
...
//# sourceMappingURL=347c3a4ef6576fc15ff8a632f6640dcac0109c3e.js.map