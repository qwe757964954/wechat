    ...
    execute: function () {
      ...
      _export("BankrupData", BankrupData = class BankrupData extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        getBankruptTimesInterval() {
          ...
          var intervals = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        getCurTotalTime() {
          var temp = this.curBankruptCount;
        ...
        getTotalTimeByCount(count) {
          ...
          var intervals = this.getBankruptTimesInterval();
          var temp = intervals.length;
          count = count <= 1 ? 1 : count;
          count = count >= temp ? temp : count;
          var time = intervals[count];
        ...
        isBankruptRewardRemain() {
          var curCount = this.curBankruptCount;
          var intervals = this.getBankruptTimesInterval().length; //大于0加1的原因是避免新用户进去的时候弹破产提示，以及第三次破产能够正常领取
        ...
        getBankruptStatus() {
          ...
          var totalMoney = this.__User.getUserSilver(); //总资产


          var curMoney = this.__User.getUserGameSilver(); // 现金


          var lowestMoney = this.getBankruptLowestMoney(); //破产下限
        ...
        checkIsBankrupt(money) {
          ...
          var lowestMoney = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        isMineBankrupt(isCheckSafebox) {
          if (isCheckSafebox === void 0) {
            isCheckSafebox = false;
          }

          var money = this.__User.getUserGameSilver(); // 现金
...
//# sourceMappingURL=fb3e70c511c605e14e8b34ded9e23d47638cec07.js.map