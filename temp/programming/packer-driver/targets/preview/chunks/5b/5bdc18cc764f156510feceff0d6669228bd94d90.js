    ...
    execute: function () {
      ...
      _export("NodeHandCardCtr", NodeHandCardCtr = (_dec = ccclass('NodeHandCardCtr'), _dec2 = property({
        ...
        constructor() {
          ...
          this._numList = null;
          this._seatList = null;
          this._seatListTarget = null;
          this._cardStart = 0;
          this._spaceLast = 0;
          this._width = 0;
          this._height = 0;
          this._thickness = 0;
          this._groundToCard = 0;
        ...
        initView() {
          var num = 14;
          var scale = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.ScaleHandCard;
          var width = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.Width * scale;
          var height = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.Height * scale;
          var thickness = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.Thickness * scale;
          var groundToCard = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.GroundToHandCard * scale;
          ...
          for (var dir = 0; dir < 4; dir++) {
            ...
            for (var i = 0; i < num; i++) {
              ...
              card.setPosition(leftToRight, groundToCard, (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
        ...
        resetView() {
          ...
          for (var dir = 0; dir < this._seatListTarget.length; dir++) {
            var targets = this._seatListTarget[dir];
          ...
          for (var _dir = 0; _dir < this._seatList.length; _dir++) {
            ...
            for (var _i = 0; _i < cards.length; _i++) {
              cards[_i].active = false;
              Tween.stopAllByTarget(cards[_i]);

              cards[_i].setRotationFromEuler(90, 0, 0);

              var pos = cards[_i].getPosition();

              cards[_i].setPosition(pos.x, this._groundToCard, (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.CenterToHandCard);
            }
          }
        ...
        adjustPosition(dir, offset) {
          ...
          for (var i = 0; i < num; i++) {
            var leftToRight = -this._cardStart + i * this._width;
            ...
            card.setPosition(leftToRight, this._groundToCard, (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
              error: Error()
            }), GameViewConfig) : GameViewConfig).CardConfig.CenterToHandCard + offset);
          }
        }
        /** 是否轮到我出牌 */
        ...
        playAnimOfSort() {
          ...
          tween(this.node).delay(t1 + t2 + 0.01).call(() => {
            ...
            for (var _dir2 = 0; _dir2 < this._seatList.length; _dir2++) {
              var cards = this._seatList[_dir2];
        ...
        playAnimOfSortByDir(dir, t1, t2) {
          ...
          var _loop = function _loop(_i2) {
            ...
            var rotaionEuler = new Vec3(cards[_i2].eulerAngles);
            var pos = new Vec3(cards[_i2].getPosition());
            var point = new Vec3(pos.x, 0, pos.z + _this._thickness - _this._groundToCard);
            var tweenTargetVec3 = new Vec3(0, 0, 0);
            var tw = new Tween(tweenTargetVec3).by(t1, new Vec3(90, 0, 0), {
              onUpdate: (target, ratio) => {
                (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  error: Error()
                }), Utils) : Utils).rotate3DAroundByPositionRotaion(cards[_i2], pos, rotaionEuler, point, target, true);
              }
            ...
            _this._seatListTarget[dir].push(tweenTargetVec3);
          };
        ...
        normalOutCardAny(dir, count) {
          ...
          for (var _i3 = 0; _i3 < num; _i3++) {
            var pos = cards[_i3].getPosition(); // 使用动画移动到目标位置


            var x = -this._cardStart + _i3 * this._width;

            if (_i3 == num - 1 && num % 3 == 2) {
              x += this._spaceLast;
            }

            tween(cards[_i3]).to(0.06 * count, {
        ...
        playAnimOfShow() {
          ...
          var _loop2 = function _loop2(dir) {
            var cards = _this2._seatList[dir];
            var num = _this2._numList[dir];
            ...
            var _loop3 = function _loop3(i) {
              ...
              var point = new Vec3(pos.x, 0, pos.z - _this2._groundToCard);
              var tweenTargetVec3 = new Vec3(0, 0, 0);
              ...
              _this2._seatListTarget[dir].push(tweenTargetVec3);
            };
...
//# sourceMappingURL=5bdc18cc764f156510feceff0d6669228bd94d90.js.map