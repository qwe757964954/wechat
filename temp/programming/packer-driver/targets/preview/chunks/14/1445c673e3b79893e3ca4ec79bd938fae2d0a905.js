System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, UITransform, Vec3, _decorator, tween, Utils, EventManager, BaseComponent, FXJConstant, FXJEvent, FXJRes, FXJSound, GameViewConfig, NodeUserCtr, NodeUserPrefabCtr, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, NodeNormalAnimCtr;
      ...
      _export("NodeNormalAnimCtr", NodeNormalAnimCtr = (_dec = ccclass('NodeNormalAnimCtr'), _dec2 = property({
        ...
        */
        ...
        startPlayOutCardAnim(event, data, camera3D, camera2D) {
          var aniNode = this.node.getChildByName("OutCardAni");
          ...
          switch (data.aniType) {
            ...
            case (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            ...
            }), GameViewConfig) : GameViewConfig).AnimType.GameOver:
              {
                ...
                (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                  ...
                  error: Error()
                }), FXJEvent) : FXJEvent).SYS_ANI_PLAY, _param);
              }
              break;
            ...
            case (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
              ...
              {
                var posWorld = camera2D.screenToWorld(camera3D.worldToScreen(data.pos));
                var pos = aniNode.getComponent(UITransform).convertToNodeSpaceAR(posWorld);
                var _param2 = {
                  resConf: (_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
                    error: Error()
                ...
                (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                  ...
                  error: Error()
                }), FXJEvent) : FXJEvent).SYS_ANI_PLAY, _param2);
              }
              break;
            ...
            case (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
              ...
              {
                var _posWorld = camera2D.screenToWorld(camera3D.worldToScreen(data.pos));

                var _pos = aniNode.getComponent(UITransform).convertToNodeSpaceAR(_posWorld);
                ...
                (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                  ...
                  error: Error()
                }), FXJEvent) : FXJEvent).SYS_ANI_PLAY, _param3);
              }
              break;
            ...
            case (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
              ...
              {
                var _posWorld2 = camera2D.screenToWorld(camera3D.worldToScreen(data.pos));

                var _pos2 = aniNode.getComponent(UITransform).convertToNodeSpaceAR(_posWorld2);
                ...
                (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                  ...
                  error: Error()
                }), FXJEvent) : FXJEvent).SYS_ANI_PLAY, _param4);
              }
              break;
...
//# sourceMappingURL=1445c673e3b79893e3ca4ec79bd938fae2d0a905.js.map