  ...
  return {
    ...
    execute: function () {
      ...
      _export("NetManager", NetManager = class NetManager {
        ...
        addNetNode() {
          var netnode = new (_crd && NetNode === void 0 ? (_reportPossibleCrUseOfNetNode({
            error: Error()
          }), NetNode) : NetNode)();
          var index = NetManager.getInstance().setNetNode(netnode);
        ...
        removeNetNode(channelId) {
          if (channelId) {
            var netNode = this._channels.has(channelId);
        ...
        send(channelId, reqProtocol, force) {
          if (force === void 0) {
            force = false;
          }
        ...
        request(channelId, reqProtocol, force) {
          if (force === void 0) {
            force = false;
          }
        ...
        requestUnique(channelId, reqProtocol, force) {
          if (force === void 0) {
            force = false;
          }
        ...
        closeAll(code, reason) {
          var netNodes = this._channels.values();
...
//# sourceMappingURL=44b1401b953b870da230f636216f90057b591007.js.map