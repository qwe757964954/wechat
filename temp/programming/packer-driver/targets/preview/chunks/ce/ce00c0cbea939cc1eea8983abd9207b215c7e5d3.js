System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, AppEvent, GConstants, StoreKey, GameTxt, UIID, LocalStorage, Utils, Encrypt, EventManager, BaseCache, SelectGame, _crd;
      ...
      _export("SelectGame", SelectGame = class SelectGame extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        checkQuickGame(gameId, tabId) {
          ...
          if (minRoomData) {
            ...
            var getBankruptRewardBol = this.__User.BankrupData.isBankruptRewardRemain(); // 破产
        ...
        checkIntoRoom(gameId, roomData) {
          ...
          if (max == -1) {
            ...
            if (userGold < min) {
              // 是否还有破产次数可以领
              var getBankruptRewardBol = this.__User.BankrupData.isBankruptRewardRemain();
            ...
            if (userGold < min) {
              var _getBankruptRewardBol = this.__User.BankrupData.isBankruptRewardRemain(); // 破产且有可领取的次数
...
//# sourceMappingURL=ce00c0cbea939cc1eea8983abd9207b215c7e5d3.js.map