System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Label, Node, sp, Sprite, SpriteAtlas, _decorator, resLoader, BaseComponent, PlayerMgr, FXJRes, NodeHead, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, Player;
      ...
      _export("Player", Player = (_dec = ccclass('Player'), _dec2 = property(Label), _dec3 = property(Sprite), _dec4 = property(Node), _dec5 = property(sp.Skeleton), _dec(_class = (_class2 = class Player extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        changeSkin(sex) {
          ...
          (_crd && resLoader === void 0 ? (_reportPossibleCrUseOfresLoader({
            ...
            var ani = this.player.setAnimation(0, 'idle1', true);
        ...
        updatePlayerProperty(player) {
          ...
          var nodeHeadCtr = this.headNode.getComponent(_crd && NodeHead === void 0 ? (_reportPossibleCrUseOfNodeHead({
            error: Error()
          }), NodeHead) : NodeHead);
...
//# sourceMappingURL=81c1f6f915ef13c5c6cdc5b1b16725fc646eda17.js.map