      ...
      _export("AudioManager", AudioManager = (_dec = ccclass('AudioManager'), _dec(_class = (_class2 = class AudioManager extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        static getInstance() {
          ...
          if (!this._instance._audioManagerNode) {
            var root = director.getScene().getChildByName("root");
            var nodeAudioManager = root.getChildByName("NodeAudioManager");
            ...
            var nodeUIMusic = nodeAudioManager.getChildByName("NodeUIMusic");
            ...
            var nodeUIEffect = nodeAudioManager.getChildByName("NodeUIEffect");
        ...
        preLoadAudioDir(bundle, dirPath, upFunc, cb) {
          if (upFunc === void 0) {
            upFunc = null;
          }
        ...
        receivePlayMusicLast(event) {
          ...
          var musicConf = this._lastPlayMusicData.pop();
        ...
        receiveStopPlayEffect(event, param) {
          if (param === void 0) {
            param = null;
          }

          for (var i = this.nodeEffectList.length - 1; i >= 0; i--) {
            var itemConf = void 0;
            itemConf = this.nodeEffectList[i];

            if (itemConf && itemConf["node"].isValid == true) {
              if (param) {
                var effectPlayConf = itemConf["commp"].getCurrowPlayConf();
        ...
        getNewEffect() {
          ...
          if (!nodeConf) {
            var nodeUIEffect = new Node("NodeUIEffect");
            ...
            var comp = nodeUIEffect.getComponent(_crd && AudioEffect === void 0 ? (_reportPossibleCrUseOfAudioEffect({
              error: Error()
            }), AudioEffect) : AudioEffect);
            nodeConf = {
              node: nodeUIEffect,
        ...
        playMusic(path, bundleName, isLoop, callback) {
        ...
        playEffect(path, bundleName) {
          if (bundleName === void 0) {
            bundleName = "resources";
          }

          if (this._switch_effect) {
            var effectConf = this.getNewEffect();
...
//# sourceMappingURL=2a6e84d1f77bc8a91321797bb92db7a2bcd47533.js.map