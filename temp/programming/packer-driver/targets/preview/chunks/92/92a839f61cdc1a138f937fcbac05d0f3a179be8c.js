      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cardAddTouchEvent(handNode) {
          ...
          handNode.on(Node.EventType.TOUCH_START, event => {
            ...
            this._touchNode = event.target; // this.startPosition = this._touchNode.getPosition();
          }, this);
        ...
        onTouchStart(event) {
          // if(Utils.isNull(this._touchNode) || GCache.Desk.turnMe === false){
          //     return;
          // }
        ...
        onTouchMove(event) {
          ...
          // }
          this._isTouched = true;
          this.movePositionY = this.movePositionY + event.getDeltaY();
          ...
          console.log("onTouchMove_________________", this.movePositionY, this.startPositionY);
        ...
        onTouchEnd(event) {
          ...
          //     return;
          // }
          var spacing = this.movePositionY - this.startPositionY;
          console.log("onTouchEnd_________________", this.movePositionY, this.startPositionY);
          console.log("onTouchEnd_________________", Math.abs(spacing), this.moveThreshold);

          if (Math.abs(spacing) >= this.moveThreshold) {
        ...
        onTouchCancel(event) {
          var spacing = this.movePositionY - this.startPositionY;
          console.log("onTouchCancel_________________", Math.abs(spacing), this.moveThreshold); // if(Utils.isNull(this._touchNode) || GCache.Desk.turnMe === false){
          //     return;
          // }
          // // 处理触摸取消事件
          // this._isTouched = false;
...
//# sourceMappingURL=92a839f61cdc1a138f937fcbac05d0f3a179be8c.js.map