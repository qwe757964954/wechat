  ...
  return {
    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        onTouchCancel(event) {
          var spacing = this.movePositionY - this.startPositionY;
          console.log("onTouchCancel_________________", Math.abs(spacing), this.moveThreshold);

          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).isNull(this._touchNode) || (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
...
//# sourceMappingURL=92b0a593bceb43057dc616f025bc3fae2c205eab.js.map