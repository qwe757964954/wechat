      ...
      _export("NodeHuCardCtr", NodeHuCardCtr = (_dec = ccclass('NodeHuCardCtr'), _dec2 = property({
        ...
        initView() {
          var scale = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.ScaleHuCard;
        ...
        pushCardA(dir, cardNumber, isReconnect) {
          ...
          var groundToCard = this._groundToCard;
          ...
          var x = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.CenterToHuCardX + (width + (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.SpaceHuCard) * col;
          var y = groundToCard + row * thickness;
        ...
        pushCardB(dir, cardNumber, isReconnect) {
          ...
          if (col == 1 || col == 2) {
            ...
            card.setPosition(_x, y, distance + height);
          }
...
//# sourceMappingURL=9232ac1d72a82f59e7e3e8e34980757b54962aec.js.map