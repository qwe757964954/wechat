  ...
  return {
    ...
    execute: function () {
      ...
      _export("loginCtr", loginCtr = (_dec = ccclass('loginCtr'), _dec2 = menu('prefab/login/loginCtr'), _dec3 = property({
        ...
        //获取用户协议与隐私政策同意状态 
        checkIsAgree() {
          var res = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
        ...
        updateLoginView() {
          if (this._isWxLogin) {
            ...
            var access_token = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            }), GCache) : GCache).User.getLastLoginValueByKey("access_token");
            this.editBox.string = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
        ...
        onClickUserAgreePrivate(event) {
          var state = !this.toggleAgreeGou.isChecked;
...
//# sourceMappingURL=c755d4c015be02f4c7d863b7dd9190416eac72cf.js.map