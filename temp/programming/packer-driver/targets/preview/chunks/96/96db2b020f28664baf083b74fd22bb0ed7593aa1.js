  ...
  return {
    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        foldAnimation() {
          // 创建一个 AnimationClip
          var animationClip = AnimationClip.createWithSpriteFrames([], 135 / 45 + 1); // 添加一个关键帧

          var frame = new SpriteFrame();
          animationClip.addKeyframe(frame, 0); // 在动画中设置关键帧的属性

          var curve = new AnimationClip.CreateCurve(frame, "eulerAngles.x");
        ...
        onTouchEnd(event) {
          if (this.moveDistance > this.thresholdDistance && (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            ...
            var byte = this._touchNode.getComponent(_crd && NodeCardCtr === void 0 ? (_reportPossibleCrUseOfNodeCardCtr({
              error: Error()
...
//# sourceMappingURL=96db2b020f28664baf083b74fd22bb0ed7593aa1.js.map