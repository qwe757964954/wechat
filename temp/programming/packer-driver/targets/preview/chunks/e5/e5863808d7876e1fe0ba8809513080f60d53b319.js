System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Node, Vec3, BaseComponent, RoomMgr, GameViewConfig, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, NodeDiceCtr;
      ...
      _export("NodeDiceCtr", NodeDiceCtr = (_dec = ccclass('NodeDiceCtr'), _dec2 = property({
        ...
        update(dt) {
          if (this._diceStatus == (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            ...
            this._time += dt;
            var dtLapLocal = dt * 360 * this._config.SECOND_LAP_LOCAL;
            var rotation1 = this.nodeDice1.eulerAngles;
            this.nodeDice1.setRotationFromEuler(rotation1.x + dtLapLocal, rotation1.y + dtLapLocal, rotation1.z + dtLapLocal);
            var rotation2 = this.nodeDice2.eulerAngles;
            this.nodeDice2.setRotationFromEuler(rotation2.x + dtLapLocal, rotation2.y + dtLapLocal, rotation2.z + dtLapLocal);
            var dtLap = dt * 360 * this._config.SECOND_LAP;
            var rotaionView = this.nodeDiceView.eulerAngles;
            ...
            if (this._time >= this._config.TIME_ROTATE) {
              var endRotation1 = this.getRotationByValue(this._dices[0]);
              this.nodeDice1.setRotationFromEuler(endRotation1);
              var endRotation2 = this.getRotationByValue(this._dices[1]);
...
//# sourceMappingURL=e5863808d7876e1fe0ba8809513080f60d53b319.js.map