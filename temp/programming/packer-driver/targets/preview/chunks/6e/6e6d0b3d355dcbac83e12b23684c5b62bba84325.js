    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        onLoad() {
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, this.onTouchMove, this); // this.node.on(Node.EventType.TOUCH_END, this.onTouchEnd, this);
        ...
        onTouchMove(event) {
          this._isTouched = true;
          this.movePositionY = this.startPositionY + event.getDeltaY();
          ...
          console.log("movePositionY__________", this.movePositionY);
...
//# sourceMappingURL=6e6d0b3d355dcbac83e12b23684c5b62bba84325.js.map