      ...
      _export("LoginController", LoginController = class LoginController extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        autoLogin(loginType) {
          ...
          if (!(_crd && GSocket === void 0 ? (_reportPossibleCrUseOfGSocket({
            ...
            var url = (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
              error: Error()
          ...
          var _loginType = loginType || (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        startByaccLogin() {
          var lastLoginInfo = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          var lastLoginByacc = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).User.getLastlocalByacc();
          var loginAccount, loginPsd, bid, access_token;
          var mType = 0;
          ...
          if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var [isExsit, key, value] = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
        ...
        _boyaaPassportLogin(account, password, bid, access_token, reg_type, verifyCode) {
          if (account === void 0) {
            account = null;
          }
          ...
          if (verifyCode === void 0) {
            verifyCode = null;
          }

          var loginType = (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
            error: Error()
          }), GConstants) : GConstants).UserLoginType.BoyaaPassportLogin;
          var uType = (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
            error: Error()
        ...
        _boyaaPassportBidTokenLogin(account, password, bid, access_token) {
          if (account === void 0) {
            account = null;
          }
        ...
        reqCoreGameLogin(event, loginType, uType, in_param, in_extParam, reg_type, verifyCode) {
          if (in_param === void 0) {
            in_param = null;
          }

          if (in_extParam === void 0) {
            in_extParam = null;
          }
          ...
          var curTime = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).time();

          var defaultParam = this._getLoginDefaultParam();
          ...
          var _in_param = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).table_verify(in_param);

          for (var key in _in_param) {
            if (Object.prototype.hasOwnProperty.call(_in_param, key)) {
              var value = _in_param[key];
          ...
          var extParam_data = this.getDefaultExtramParam();
          extParam_data.timestamp = curTime;

          var _in_extParam = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).table_verify(in_extParam);

          for (var _key in _in_extParam) {
            if (Object.prototype.hasOwnProperty.call(_in_extParam, _key)) {
              var _value = _in_extParam[_key];

              if (_value) {
                extParam_data[_key] = _value;
              }
            }
          }
        ...
        reqYoukeLogin() {
          ...
          var lastUType = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          if (lastUType == (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
            ...
            var token = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            }), GCache) : GCache).User.getLastLoginValueByKey("token");
        ...
        respNetLoginCore(event, isSuccess, respData, reqData) {
          ...
          if (!isSuccess) {
            ...
            if (!info || (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              ...
              var otherEx = {
                serverConf: (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
                  error: Error()
                }), GameConfig) : GameConfig).instance.AppUrlConf
              };
              (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                error: Error()
              }), GCache) : GCache).User.onloadLoginSuccessParams(info["user"], info["game"], info["account"], otherEx);
              isSuccess = true;
            }
          }
        ...
        receiveLoginSuccess() {
          ...
          if (this._viewLoginParam && (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var key = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
        ...
        receiveLoginFail(errInfo) {
          ...
          if (this._reqLoginNum < this._reqLoginMaxNum) {
            //更新每次请求的时间戳
            var extParam_data = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
              error: Error()
          ...
          var errorType = errInfo ? errInfo["errorType"] : null;
        ...
        respNetLoginSuccess(event, respData, reqData) {
          ...
          if (respData["ret"] == 1) {
            ...
            for (var key in (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              ...
              if (Object.prototype.hasOwnProperty.call((_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                ...
                var id = (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                  error: Error()
                }), GConstants) : GConstants).GameID[key];
          ...
          var matchRecInfo = respData["matchInfo"];
          var matchGameId = 0;
          ...
          var onlookerInfo = respData["onlookerInfo"];
          var onlookerGameId = 0;
            ...
            buttonsMap: [{
              ...
              click: () => {
                ...
                (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                  ...
                  error: Error()
                }), AppEvent) : AppEvent).RECOMMEND_POP_CLEAN_QUENE); // 点击回调
        ...
        _reqCommSuccessQuene() {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), GConstants) : GConstants).GameID.FXJ); //请求分享配置
        ...
        _checkServerChange(isFirstLogin) {
          if (isFirstLogin === void 0) {
            isFirstLogin = false;
          }
          ...
          var oldServerConf = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).User.getLastlocalLoginServerConf();
          var newServerConf = (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
          }), GameConfig) : GameConfig).instance.AppUrlConf;
          ...
          if (isChangeServer == true) {
            if (isFirstLogin == true) {
              ...
              for (var _key2 in (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
                error: Error()
                ...
                if (Object.prototype.hasOwnProperty.call((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
                  error: Error()
                }), GameConfig) : GameConfig).ServerUrlConf, _key2) && isFind == false) {
                  if (oldServerConf["Socket"] == (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
                    error: Error()
                  }), GameConfig) : GameConfig).ServerUrlConf[_key2].Socket) {
                    isFind = true;
                    currowServer = Number(_key2);
                  }
                }
              }
        ...
        _toForwardHallView(param, isNotNeedTip) {
          if (isNotNeedTip === void 0) {
            isNotNeedTip = false;
          }
...
//# sourceMappingURL=3ccfa2f5ff7d58cba2c51269c427815b2be8be93.js.map