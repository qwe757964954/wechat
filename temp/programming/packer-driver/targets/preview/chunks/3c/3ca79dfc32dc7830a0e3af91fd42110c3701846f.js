  ...
  return {
    ...
    execute: function () {
      ...
      (function (_RandomManager) {
        var seedrandom = _RandomManager.seedrandom = null;
        ...
        function getRandomByMinMaxList(min, max, n, type) {
          if (type === void 0) {
            type = 2;
          }
        ...
        function getRandomByObjectList(objects, n) {
          ...
          for (var i = 0; i < n; i++) {
            var index = RandomManager.getRandomInt(0, n, 1);
...
//# sourceMappingURL=3ca79dfc32dc7830a0e3af91fd42110c3701846f.js.map