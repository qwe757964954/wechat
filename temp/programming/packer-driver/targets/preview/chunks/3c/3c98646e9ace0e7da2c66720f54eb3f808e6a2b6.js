    ...
    execute: function () {
      ...
      _export("ResLoaderManager", ResLoaderManager = (_dec = ccclass('ResLoaderManager'), _dec(_class = (_class2 = class ResLoaderManager extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        getPreLoaderRes(bundle, path, resType, callback, isReload) {
          ...
          var self = this;
          var key = this.getKey(bundle, path, resType);

          if (isReload) {
            self.__preLoadMap.delete(key);
          }

          var preRes = self.__preLoadMap.get(key);
        ...
        removePreLoaderRecord(bundle, path, resType) {
          if (path === void 0) {
            path = null;
          }
...
//# sourceMappingURL=3c98646e9ace0e7da2c66720f54eb3f808e6a2b6.js.map