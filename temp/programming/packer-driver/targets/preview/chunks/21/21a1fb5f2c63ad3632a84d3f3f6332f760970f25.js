System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, AppEvent, UIID, EventManager, BaseComponent, PlayerMgr, FXJEvent, FXJSound, _dec, _dec2, _class, _crd, ccclass, property, menu, ToolBarPrefabCtr;
    ...
    execute: function () {
      ...
      _export("ToolBarPrefabCtr", ToolBarPrefabCtr = (_dec = ccclass('ToolBarPrefabCtr'), _dec2 = menu('prefab/game/ToolBarPrefabCtr'), _dec(_class = _dec2(_class = class ToolBarPrefabCtr extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        onTuoGuanClick(event) {
          // EventManager.dispatch(AppEvent.REPORT_CLIENT_CLICK, { eventID: ReportConfig.game_3 });
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            error: Error()
          }), EventManager) : EventManager).dispatch((_crd && FXJEvent === void 0 ? (_reportPossibleCrUseOfFXJEvent({
            error: Error()
        ...
        onSettingClick(event) {
          // EventManager.dispatch(AppEvent.REPORT_CLIENT_CLICK, { eventID: ReportConfig.setLayer_2 });
          // EventManager.dispatch(AppEvent.REPORT_CLIENT_CLICK, { eventID: ReportConfig.game_4 });
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            error: Error()
          }), EventManager) : EventManager).dispatch((_crd && FXJEvent === void 0 ? (_reportPossibleCrUseOfFXJEvent({
            error: Error()
...
//# sourceMappingURL=21a1fb5f2c63ad3632a84d3f3f6332f760970f25.js.map