      ...
      _export("FXJController", FXJController = class FXJController extends (_crd && RoomController === void 0 ? (_reportPossibleCrUseOfRoomController({
        ...
        onNextGameOperation(event) {
          ...
          var data = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).SelectGame.getServerGameLevelTabListByGameID(this._intoGameData.GameID);
          console.log("onNextGameOperation____________________", data);
...
//# sourceMappingURL=5474af5876b9ce36fa9dd5f319613afa7bb7340e.js.map