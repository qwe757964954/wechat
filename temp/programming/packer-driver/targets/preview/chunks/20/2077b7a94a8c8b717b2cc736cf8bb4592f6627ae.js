System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Label, Node, _decorator, GCache, AppEvent, AppSound, GConstants, GameRes, GameTxt, Utils, EventManager, BaseComponent, Platform, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, menu, friendPrefabCtr;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("friendPrefabCtr", friendPrefabCtr = (_dec = ccclass('friendPrefabCtr'), _dec2 = menu('prefab/activity/friendPrefabCtr'), _dec3 = property({
        ...
        updateShowBtn() {
          var len = this.sceneBtnLayer.children.length;

          for (var i = 0; i < len; i++) {
            var node = this.sceneBtnLayer.children[i];
            var selectDot = node.getChildByName("img_dot_selected");
            var selectImg = node.getChildByName("img_selected");
        ...
        updateSceneShow() {
          for (var i in this.sceneLayer) {
            var node = this.sceneLayer[i];
        ...
        onClickInviteFriend(event) {
          ...
          var _shareOptions = {};
          var shopShareMsg = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
...
//# sourceMappingURL=2077b7a94a8c8b717b2cc736cf8bb4592f6627ae.js.map