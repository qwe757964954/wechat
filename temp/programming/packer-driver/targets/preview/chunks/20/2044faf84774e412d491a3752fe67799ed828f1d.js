      ...
      _export("GameChatPrefabCtr", GameChatPrefabCtr = (_dec = ccclass('GameChatPrefabCtr'), _dec2 = menu('prefab/game/GameChatPrefabCtr'), _dec3 = property({
        ...
        updateMessageList() {
          ...
          if (currowDaysNum < chatTextData.length) {
            for (var _i2 = currowDaysNum; _i2 < chatTextData.length; _i2++) {
              var node = instantiate(this.nodeMsg);
              this.msgContent.addChild(node);
            }
          } else if (currowDaysNum > chatTextData.length) {
            for (var _i3 = currowDaysNum - 1; _i3 >= chatTextData.length; _i3--) {
              var _node = this.msgContent.children[_i3];
          ...
          for (var _i4 = 0; _i4 < this.msgContent.children.length; _i4++) {
            var _node2 = this.msgContent.children[_i4];
            this.updateMsgItem(_node2, _i4, chatTextData[_i4], _i4 == chatTextData.length - 1);
          }
        }
        /** 更新单条消息 */
        ...
        updateEmoList() {
          ...
          if (currowDaysNum < emojiDataList.length) {
            for (var _i5 = currowDaysNum; _i5 < emojiDataList.length; _i5++) {
              var node = instantiate(this.nodeEmoji);
              this.emojiContent.addChild(node);
            }
          } else if (currowDaysNum > emojiDataList.length) {
            for (var _i6 = currowDaysNum - 1; _i6 >= emojiDataList.length; _i6--) {
              var _node3 = this.emojiContent.children[_i6];
          ...
          for (var _i7 = 0; _i7 < this.emojiContent.children.length; _i7++) {
            var _node4 = this.emojiContent.children[_i7];
            this.updateEmojiItem(_node4, _i7, emojiDataList[_i7], _i7 == emojiDataList.length - 1);
          }
        }
        /** 更新单个表情 */
...
//# sourceMappingURL=2044faf84774e412d491a3752fe67799ed828f1d.js.map