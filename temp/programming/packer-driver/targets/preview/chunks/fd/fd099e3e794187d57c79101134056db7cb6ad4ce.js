System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Label, Node, SpriteAtlas, UITransform, Vec3, _decorator, GCache, SpriteLoad, EventManager, Utils, BaseComponent, PlayerMgr, RoomMgr, FXJConfig, FXJConstant, FXJEvent, FXJRes, FXJUIID, FXJSound, GameEvent, CardUtil, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, menu, NodeUserPrefabCtr;
    ...
    execute: function () {
      ...
      _export("NodeUserPrefabCtr", NodeUserPrefabCtr = (_dec = ccclass('NodeUserPrefabCtr'), _dec2 = menu('prefab/game/NodeUserPrefabCtr'), _dec3 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "headBoxNode", _descriptor5, this);

          _initializerDefineProperty(this, "coinLabel", _descriptor6, this);

          _initializerDefineProperty(this, "nodeChat", _descriptor7, this);

          _initializerDefineProperty(this, "nodeEmoji", _descriptor8, this);

          _initializerDefineProperty(this, "nodeZhuang", _descriptor9, this);
        ...
        updateUserHeadBox(headBox) {
          var spriteLoad = this.headBoxNode.getComponent(_crd && SpriteLoad === void 0 ? (_reportPossibleCrUseOfSpriteLoad({
            error: Error()
          }), SpriteLoad) : SpriteLoad);
        ...
        updatePos() {
          var uiTransform = this.node.getParent().getComponent(UITransform);
        ...
        showEmojMsg(event, body) {
          ...
          */
          ...
          var mojiIndex = body.faceValue - Math.pow(2, 16);
          var aniName = (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
            error: Error()
        ...
        showChatMsg(event, body) {
          ...
          */
          ...
          var PosId = (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
          }), CardUtil) : CardUtil).calculatePlayerSeat((_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
            error: Error()
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var msg = body.msg; //根据msg 去索引得到音效名

            var audioType = '';
            var audioIndex = -1;

            for (var key in (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
              error: Error()
              ...
              if (Object.prototype.hasOwnProperty.call((_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
                ...
                var arr = (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
                  error: Error()
                }), FXJConstant) : FXJConstant).ChatText[key];
            ...
            var audioName = audioType + '_' + audioIndex;
            var gender = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            ...
            var childNameList = ["right", "left", "bottom"];
            var currowName = childNameList[0];
            ...
            childNameList.forEach((nodeName, key) => {
              var pNode = this.nodeChat.getChildByName(nodeName);
            ...
            var bg = parentNode.getChildByName("bg");
            var label = bg == null ? void 0 : bg.getChildByName("Label");
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "headBoxNode", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "coinLabel", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "nodeChat", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "nodeZhuang", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=fd099e3e794187d57c79101134056db7cb6ad4ce.js.map