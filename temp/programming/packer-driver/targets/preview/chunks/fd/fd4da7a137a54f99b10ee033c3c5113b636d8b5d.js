  ...
  return {
    ...
    execute: function () {
      ...
      SuperWriteAndRead = class SuperWriteAndRead {
        ...
        //初始化通用模块命令
        initCommonCmd(headCmdBinding, isReset) {
          if (isReset === void 0) {
            isReset = false;
          }
          ...
          for (var headCmd in headCmdBinding) {
            if (Object.prototype.hasOwnProperty.call(headCmdBinding, headCmd)) {
              var value = headCmdBinding[headCmd];
        ...
        updateCmdArrayFunc(arrayList, isReset) {
          if (isReset === void 0) {
            isReset = false;
          }
          ...
          for (var index = 0; index < arrayList.length; index++) {
            var array = arrayList[index]; //只有类型无解析函数的全部用默认方式
      ...
      GPBRead = class GPBRead extends SuperWriteAndRead {
        ...
        ReadPhpRequest(headCmd, packetID) {
          ...
          var jsonStr = (_crd && WebSocketBuffer === void 0 ? (_reportPossibleCrUseOfWebSocketBuffer({
            error: Error()
        ...
        ReadPhpRequestNew(headCmd, packetID) {
          ...
          var strData = (_crd && WebSocketBuffer === void 0 ? (_reportPossibleCrUseOfWebSocketBuffer({
            error: Error()
          }), WebSocketBuffer) : WebSocketBuffer).Read.readString(packetID);

          if (strData && info.compressType != null) {
            //解析正文
            var jsonData = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
              error: Error()
        ...
        ReadHallLoginSuccess(headCmd, packetID) {
          ...
          info["objectInfo"] = {};
          var objectInfoStr = (_crd && WebSocketBuffer === void 0 ? (_reportPossibleCrUseOfWebSocketBuffer({
            error: Error()
          }), WebSocketBuffer) : WebSocketBuffer).Read.readString(packetID);
        ...
        ReadPhpGetUserVipInfo(headCmd, packetID) {
          ...
          var dataLen = (_crd && WebSocketBuffer === void 0 ? (_reportPossibleCrUseOfWebSocketBuffer({
            error: Error()
          }), WebSocketBuffer) : WebSocketBuffer).Read.readInt(packetID);

          if (dataLen != null) {
            for (var i = 0; i < dataLen; i++) {
              var encodeStr = (_crd && WebSocketBuffer === void 0 ? (_reportPossibleCrUseOfWebSocketBuffer({
                error: Error()
              }), WebSocketBuffer) : WebSocketBuffer).Read.readString(packetID);
              var realObj = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
                error: Error()
        ...
        comm_receiveStopGameInPlay(headCmd, packetID) {
          ...
          var personNum = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).nullToDefault((_crd && WebSocketBuffer === void 0 ? (_reportPossibleCrUseOfWebSocketBuffer({
            error: Error()
      ...
      GPBWrite = class GPBWrite extends SuperWriteAndRead {
        ...
        comm_OneKeyLoginGame(headCmd, packetID, reqProtocol) {
          ...
          var jsonUserInfo = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
            error: Error()
          ...
          var jsonExtParam = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
            error: Error()
...
//# sourceMappingURL=fd4da7a137a54f99b10ee033c3c5113b636d8b5d.js.map