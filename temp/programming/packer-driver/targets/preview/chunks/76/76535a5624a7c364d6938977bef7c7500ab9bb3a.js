  ...
  return {
    ...
    execute: function () {
      ...
      _export("Desk", Desk = class Desk extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        updatePlayerOnReady(mid, readyNum) {
          if (readyNum === void 0) {
            readyNum = null;
          }
        }
        ...
        isInMatchRoom() {
          var roomLevelId = this.getCurLevelID();
        ...
        checkIsMatchRoomLevel(roomLevel) {
          ...
          for (var i = 0; i < (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
            error: Error()
...
//# sourceMappingURL=76535a5624a7c364d6938977bef7c7500ab9bb3a.js.map