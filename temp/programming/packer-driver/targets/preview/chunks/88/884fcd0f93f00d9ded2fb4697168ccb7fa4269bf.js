System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, error, sys, AppEvent, ClientInfo, GameConfig, GConstants, StoreKey, GameRes, GameTxt, LocalStorage, Utils, Encrypt, Logger, EventManager, HttpRequest, WXSdk, WXSdk_AuthSetting, WXSdk_VibrateShortType, _Platform, _crd, Platform;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      HttpRequest = _unresolved_12.HttpRequest;
    ...
    execute: function () {
      ...
      _Platform = class _Platform {
        ...
        _initDeviceID() {
          var key = "DeviceID";
          var str_1 = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        checkTopBarHeight() {
          ...
          if (this._SystemInfo) {
            var model = this._SystemInfo["model"];
            var keyList = [["iPhone 11"], ["iPhone 12"], ["iPhone 13"], ["iPhone14,5"], ["iPhone14"], ["iPhone", "Pro"], ["iPhone", "mini"], ["iPhone", "X"]];
          ...
          switch (this._currowPlatForm) {
            case sys.Platform.WECHAT_GAME:
              ...
              (_crd && WXSdk === void 0 ? (_reportPossibleCrUseOfWXSdk({
                ...
                if (res) {
                  if (res["networkType"]) {
                    var netName = String(res["networkType"]).toUpperCase();
        ...
        get SystemInfo() {
          ...
          var initInfoBase = function initInfoBase() {
            self._Guid = "";
            self._Machineid = "";
            self._MachineModel = "";
            self._PhoneModel = "";
          ...
          switch (this._currowPlatForm) {
            case sys.Platform.WECHAT_GAME:
              if (!this._SystemInfo && (_crd && WXSdk === void 0 ? (_reportPossibleCrUseOfWXSdk({
                ...
                var sysInfo = (_crd && WXSdk === void 0 ? (_reportPossibleCrUseOfWXSdk({
                  error: Error()
        ...
        updateWxAuthSettingButtonVisible(visible) {
          if (visible === void 0) {
            visible = null;
          }
        ...
        reqPlatformLoginInfo(isNoCheckAuthSetting) {
          if (isNoCheckAuthSetting === void 0) {
            isNoCheckAuthSetting = false;
          }
          ...
          switch (this._currowPlatForm) {
            ...
            case sys.Platform.WECHAT_GAME:
              ...
              var startShowAuthorize = function startShowAuthorize(callback) {
                (_crd && WXSdk === void 0 ? (_reportPossibleCrUseOfWXSdk({
                  error: Error()
              ...
              var getSetting = function getSetting(callback) {
                (_crd && WXSdk === void 0 ? (_reportPossibleCrUseOfWXSdk({
                  error: Error()
              ...
              var getUserInfo = function getUserInfo(callback) {
                var sysInfo = Platform.SystemInfo;
                (_crd && WXSdk === void 0 ? (_reportPossibleCrUseOfWXSdk({
                  error: Error()
              ...
              var getOpenIDAndAccestToken = function getOpenIDAndAccestToken(callback) {
                  ...
                  if (loginRsp && loginRsp.code) {
                    ...
                    http.post((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
                      ...
                      if (openID && access_token) {
                        ...
                        (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
                          error: Error()
                        }), Logger) : Logger).logPlatform("Success:\u83B7\u53D6OpenID \u548C AccessToken\u6210\u529F openID=" + _data.openid + " access_token=" + _data.access_token);
                        callback(_data);
                      } else {
                        (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
                          error: Error()
        ...
        createrAuthSettingButton_WX() {
          ...
          var createrButton = function createrButton() {
            var sysInfo = Platform.SystemInfo;
            var buttonStyle = {
            ...
            var button = (_crd && WXSdk === void 0 ? (_reportPossibleCrUseOfWXSdk({
              error: Error()
        ...
        onNeedPrivacyAuthorization_WX(event) {
          if (event === void 0) {
            event = null;
          }
        ...
        openPrivacyContract_WX(callback) {
          if (callback === void 0) {
            callback = null;
          }
          ...
          var callFunc = function callFunc(state) {
        ...
        openCustomerServiceConversation(option, callback) {
          if (option === void 0) {
            option = {};
          }
          ...
          var callFunc = function callFunc(state, errParam) {
            if (errParam === void 0) {
              errParam = null;
            }
        ...
        setCustomShareInfo(friends, pyq) {
          if (friends === void 0) {
            friends = null;
          }
        ...
        getShareFriendFunc() {
          ...
          if (Platform.CustomShareFriendsInfo) {
            var info = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
        ...
        shareWXFriends(wxParam, callback, callbackData) {
          if (wxParam === void 0) {
            wxParam = null;
          }
        ...
        connectSocket(url, binaryType, success, fail, completed, header, timeout) {
        ...
        closeSocket(wsHandler, code, reason) {
          if (code === void 0) {
            code = 1000;
          }
        ...
        updateReFreshAccessToken(_callback) {
          if (_callback === void 0) {
            _callback = null;
          }
              ...
              if (loginRsp && loginRsp.code) {
                ...
                http.post((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
                  ...
                  if (openID && access_token) {
                    ...
                    (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
                      error: Error()
                    }), Logger) : Logger).logPlatform("Success:\u83B7\u53D6OpenID \u548C AccessToken\u6210\u529F openID=" + _data2.openid + " access_token=" + _data2.access_token);
                    callback(_data2);
                  } else {
                    (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
                      error: Error()
        ...
        reqPlatformFriendInteraction(callFunc) {
          if (callFunc === void 0) {
            callFunc = null;
          }
          ...
          var endFunc = function endFunc(res) {
            (_crd && Logger === void 0 ? (_reportPossibleCrUseOfLogger({
              error: Error()
        ...
        setPlatformCloudStorage(keyValueList, callback) {
          if (callback === void 0) {
            callback = null;
          }
        ...
        getPlatformCloudStorage(key, callback) {
          if (callback === void 0) {
            callback = null;
          }
        ...
        getSettingSubscribeMessageStates(callback) {
          if (callback === void 0) {
            callback = null;
          }
        ...
        vibrate(isLong, type, callback) {
          ...
          var shorkOpen = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
        ...
        playerAdVideo(callback, callData) {
          if (callback === void 0) {
            callback = null;
          }
          ...
          var startCallFunc = function startCallFunc() {
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
              error: Error()
          ...
          var failCallFunc = function failCallFunc() {
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
              error: Error()
          ...
          var onClickCloseCallFunc = function onClickCloseCallFunc(res) {
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
              error: Error()
        ...
        downloadFile(url, callback) {
          ...
          var callFunc = function callFunc(res) {
        ...
        getLaunchOptionsSync() {
          switch (this._currowPlatForm) {
            case sys.Platform.WECHAT_GAME:
              var res = (_crd && WXSdk === void 0 ? (_reportPossibleCrUseOfWXSdk({
                error: Error()
...
//# sourceMappingURL=884fcd0f93f00d9ded2fb4697168ccb7fa4269bf.js.map