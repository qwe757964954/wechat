        ...
        updateCardItemProp(opTypes) {
          ...
          var _loop = function _loop(i) {
            ...
            var _loop2 = function _loop2(idx) {
              ...
              rowNum++; // item_width = cards.length * 53
              //= item_width;
          ...
          var cardLayout = this.node.getComponent(Layout); // let constraintNum:number = rowNum > 2 ? 2 : rowNum;

          cardLayout.updateLayout(); // let transform = ;

          transform.height = Math.round(rowNum / 2) * 86;
          console.log("transform____________________", item_width, transform.width); // this.node.getComponent(UITransform).width = constraintNum * item_width;
          // console.log("transform____________________",transform.width);
...
//# sourceMappingURL=dfd91220cdf36701955f22fbf5c446bcbba19475.js.map