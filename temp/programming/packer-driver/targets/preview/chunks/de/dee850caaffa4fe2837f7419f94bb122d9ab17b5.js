    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        onSendCard(byte) {
          ...
          console.log("onSendCard______", index, (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
...
//# sourceMappingURL=dee850caaffa4fe2837f7419f94bb122d9ab17b5.js.map