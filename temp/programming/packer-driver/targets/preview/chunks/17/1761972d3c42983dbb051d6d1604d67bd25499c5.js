      ...
      _export("ShareServers", ShareServers = class ShareServers extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        reqShareConfig(event) {
          ...
          http.post((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            ...
            var _resultData = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            ...
            var isSuccess = !(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
        ...
        reqShareAward(event, shareID, type, isShop) {
          if (isShop === void 0) {
            isShop = false;
          }
          ...
          var _md5 = '123!@#*&908byaa' + type + shareID + (_crd && ClientInfo === void 0 ? (_reportPossibleCrUseOfClientInfo({
            error: Error()
          ...
          http.post((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            ...
            var _resultData = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
              error: Error()
        ...
        respShareAward(event, isSuccess, respData, reqData) {
          if (isSuccess == false) {
            var toastData = respData['error'] ? respData['error'] : '分享失败请联系客服';
          ...
          respData['result']['reward'].forEach(item => {
            var _type = Number(item['type']);

            var res = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            ...
            if (res != null) {
              var curentRich = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                error: Error()
        ...
        reqADSAWard(event, shareID, type, isShop) {
          if (isShop === void 0) {
            isShop = false;
          }
...
//# sourceMappingURL=1761972d3c42983dbb051d6d1604d67bd25499c5.js.map