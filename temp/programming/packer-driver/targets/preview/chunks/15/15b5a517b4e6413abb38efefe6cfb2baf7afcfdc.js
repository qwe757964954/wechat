    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        constructor() {
          ...
          this.startPosition = new Vec3(0, 0, 0);
        }
        ...
        cardAddTouchEvent(handNode) {
          ...
          handNode.on(Node.EventType.TOUCH_START, event => {
            ...
            this.startPosition = this._touchNode.getPosition();
          }, this);
        ...
        onTouchMove(event) {
          ...
          var deltaY = this.startPosition.y + delta.y;
          console.log("deltaY_________________", deltaY);

          this._touchNode.setPosition(this.startPosition.x, deltaY, this.startPosition.z);
        }
...
//# sourceMappingURL=15b5a517b4e6413abb38efefe6cfb2baf7afcfdc.js.map