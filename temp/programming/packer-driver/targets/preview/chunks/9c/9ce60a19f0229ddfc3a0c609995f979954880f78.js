    ...
    execute: function () {
      ...
      _export("Carditem", Carditem = (_dec = ccclass('Carditem'), _dec2 = property({
        ...
        updateCardItemProp(opTypes) {
          ...
          cardLayout.horizontalDirection = Layout.HorizontalDirection.RIGHT_TO_LEFT; // cardLayout.constraint = Layout.Constraint.FIXED_ROW;
          // cardLayout.constraintNum = rowNum;

          cardLayout.updateLayout(); // let transform = this.node.getComponent(UITransform);
...
//# sourceMappingURL=9ce60a19f0229ddfc3a0c609995f979954880f78.js.map