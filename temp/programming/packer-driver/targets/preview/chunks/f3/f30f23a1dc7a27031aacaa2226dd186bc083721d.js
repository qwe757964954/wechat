System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Node, _decorator, GCache, AppEvent, GameTxt, EventManager, BaseComponent, RoomMgr, FXJEvent, FXJUIID, FXJSound, GameEvent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, menu, GameMenuPrefabCtr;
    ...
    execute: function () {
      ...
      _export("GameMenuPrefabCtr", GameMenuPrefabCtr = (_dec = ccclass('GameMenuPrefabCtr'), _dec2 = menu('prefab/game/GameMenuPrefabCtr'), _dec3 = property({
        ...
        onPlayerInto(event, uid) {
          if (uid == (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        onClickBack(event) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), FXJEvent) : FXJEvent).NET_REQ_LOGOUT_IN_GAME); // EventManager.dispatch(FXJEvent.REPORT_CLIENT_CLICK, { eventID: ReportConfig.game_1 });
        } //点击更多
...
//# sourceMappingURL=f30f23a1dc7a27031aacaa2226dd186bc083721d.js.map