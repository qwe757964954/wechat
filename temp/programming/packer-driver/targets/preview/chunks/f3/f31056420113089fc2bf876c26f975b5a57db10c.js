System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Button, Label, Node, PageView, Sprite, SpriteAtlas, Tween, UIOpacity, UITransform, Vec3, _decorator, instantiate, tween, GCache, AppEvent, AppSound, GameRes, Utils, SpriteLoad, EventManager, BaseComponent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, signinCtr;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SpriteLoad = _unresolved_7.default;
    ...
    execute: function () {
      ...
      __checkObsolete__(['Button', 'EventTouch', 'Label', 'Node', 'PageView', 'Sprite', 'SpriteAtlas', 'Tween', 'UIOpacity', 'UITransform', 'Vec3', '_decorator', 'instantiate', 'tween']);
      ...
      _export("signinCtr", signinCtr = (_dec = ccclass('signinCtr'), _dec2 = property({
        ...
        updateViewItemList(isRunAni) {
          ...
          if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var data = this._data.signAward;
            var childLength = this.itemView.children.length;
            ...
            for (var _i = max - 1; _i >= 0; _i--) {
              var nodeItem = this.itemView.children[_i];
            ...
            for (var index = 0; index < data.length; index++) {
              var _nodeItem = this.itemView.children[index];

              if (!_nodeItem) {
                _nodeItem = instantiate(this.itemTemplate);
                this.itemView.addChild(_nodeItem);
              }

              var uiTransform = _nodeItem.getComponent(UITransform);

              _nodeItem.position = new Vec3(uiTransform.contentSize.width * index, 100, _nodeItem.position.z);
              _nodeItem.active = true;

              var uiOpacity = _nodeItem.getComponent(UIOpacity);

              uiOpacity.opacity = 0;
              this.updateViewItem(_nodeItem, index, data[index]);
              Tween.stopAllByTarget(_nodeItem);
              Tween.stopAllByTarget(uiOpacity);

              if (data[index].day == data[index].today) {
                if (isRunAni == true) {
                  tween(_nodeItem).delay(0.1 * index).to(0.5, {
                    position: new Vec3(uiTransform.contentSize.width * index, 0, _nodeItem.position.z)
                  }, {
                    easing: "backOut"
                  }).delay(0.1 * (this._data.signAward.length - index)).to(0.3, {
                    position: new Vec3(uiTransform.contentSize.width * index, 40, _nodeItem.position.z)
                  }, {
                    easing: "sineOut"
                  }).start();
                  ...
                  _nodeItem.setPosition(new Vec3(uiTransform.contentSize.width * index, 40, _nodeItem.position.z));

                  uiOpacity.opacity = 255;
                }

                this._itemToday = _nodeItem;
                ...
                if (isRunAni == true) {
                  ...
                  _nodeItem.setPosition(new Vec3(uiTransform.contentSize.width * index, 0, _nodeItem.position.z));
        ...
        updateViewItem(item, index, itemData) {
          ...
          var itemDay = itemBg.getChildByName("itemDay");
          var awardView = itemBg.getChildByName("awardView");
          var itemTag = itemBg.getChildByName("itemTag");
          var itemGet = itemBg.getChildByName("itemGet");
          var awardViewIcon = awardView.getChildByName("icon");
          var awardViewText = awardView.getChildByName("text");
          var framePngPath = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          ...
          this.getPreLoaderRes((_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
            ...
            var spriteFrame = atlas.getSpriteFrame(framePngPath);

            if (spriteFrame) {
              var spriteComponent = itemDay.getComponent(Sprite);
          ...
          var spriteLoad = awardViewIcon.getComponent(_crd && SpriteLoad === void 0 ? (_reportPossibleCrUseOfSpriteLoad({
            error: Error()
          ...
          var label = awardViewText.getComponent(Label);
        ...
        updateViewContinueList() {
          if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var pageView = this.continueView.getComponent(PageView);
            var data = this._data.continueAward;
            var childLength = pageView.getPages().length;
            ...
            for (var _i2 = max - 1; _i2 >= 0; _i2--) {
              var nodeItem = this.itemView.children[_i2];

              if (nodeItem && !data[_i2]) {
                nodeItem.destroy();
              }
            }

            var pageIndex = 0;
            var allPages = pageView.getPages();

            for (var index = 0; index < data.length; index++) {
              var _nodeItem2 = allPages[index];

              if (!_nodeItem2) {
                _nodeItem2 = instantiate(this.continueTemplate);
                pageView.addPage(_nodeItem2);
              }

              _nodeItem2.active = true;
              this.updateViewContinue(_nodeItem2, index, data[index]);
        ...
        updateViewContinue(item, index, itemData) {
          var continueBg = item.getChildByName("continueBg");
          var icon = item.getChildByName("icon");
          var tag = item.getChildByName("tag");
          var awardNumBg = item.getChildByName("awardNumBg");
          var awardNum = awardNumBg.getChildByName("awardNum");
          var continueAnim = item.getChildByName("continueAnim");
          var spriteContinueBg = continueBg.getComponent(Sprite);
          ...
          if (spriteContinueBg != null) {
            if (itemData.day == 3) {
              this.getPreLoaderRes((_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
                ...
                var spriteFrame = atlas.getSpriteFrame("3days");
              ...
              this.getPreLoaderRes((_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
                ...
                var spriteFrame = atlas.getSpriteFrame("7days");
          ...
          var spriteLoadIcon = icon.getComponent(_crd && SpriteLoad === void 0 ? (_reportPossibleCrUseOfSpriteLoad({
            error: Error()
          }), SpriteLoad) : SpriteLoad);
          ...
          var label = awardNum.getComponent(Label);
        ...
        updateViewBtn() {
          if (this._data.todayStatus == 0) {
            ...
            var childrenComponent = this.confirmBtn.getComponentsInChildren(Sprite);

            for (var index = 0; index < childrenComponent.length; index++) {
            ...
            var _childrenComponent = this.confirmBtn.getComponentsInChildren(Sprite);

            for (var _index = 0; _index < _childrenComponent.length; _index++) {
              _childrenComponent[_index].grayscale = true;
            }
        ...
        checkContinueBtnActive() {
          ...
          var length = pageView.getPages().length;
        ...
        onClickContinueAward(event, customEventData) {
          ...
          if (!(_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            var data = this._data.continueAward[index];
...
//# sourceMappingURL=f31056420113089fc2bf876c26f975b5a57db10c.js.map