    ...
    execute: function () {
      ...
      _export("Room", Room = class Room extends (_crd && Desk === void 0 ? (_reportPossibleCrUseOfDesk({
        ...
        reconnectionRoomUpdate(resp) {
          ...
          (_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
            error: Error()
          }), RoomMgr) : RoomMgr).getInstance().timePass = resp.timePass;
          ...
          if (resp.operation) {
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), GameEvent) : GameEvent).VIEW_USER_OPERATION, resp.operation);
          }
...
//# sourceMappingURL=5d15e48e0666a166e24d0a6693be4b8dabcea903.js.map