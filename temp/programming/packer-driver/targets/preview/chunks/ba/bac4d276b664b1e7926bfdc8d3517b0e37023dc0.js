  ...
  return {
    ...
    execute: function () {
      ...
      (function (_GConstants) {
        var AppRunLife = _GConstants.AppRunLife = {
          /** main场景运行 */
        ...
        var LoginStateCode = _GConstants.LoginStateCode = {
          /** wx平台登录code获取失败 */
        ...
        var UserLoginType = _GConstants.UserLoginType = {
          NONE: -1,
          // 默认
          Token: 1,
          Acount: 2,
        ...
        var UserUType = _GConstants.UserUType = {
          None: -1,
          //没有登录过
          Guest: 1,
          //试玩登录
        ...
        var UserIdentity = _GConstants.UserIdentity = {
          Normal: 0,
          //普通用户
          Rmb: 1,
          //付费用户
        ...
        var UserPropsType = _GConstants.UserPropsType = {
          TYPE_VIP: 1,
          //vip
          TYPE_VIP_HEAD: 2,
          //专属头像
        ...
        var PropertyType = _GConstants.PropertyType = {
          /** 银币 */
          SILVER_COIN: 0,
        ...
        var UserGameRecodeState = _GConstants.UserGameRecodeState = {
          Lose: -1,
          //输
          Draw: 0,
          //平局
        ...
        var GameRoomState = _GConstants.GameRoomState = {
          STATUS_NORMAL: 0,
          //未开始
          STATUS_READY: 1,
          //开始准备
        ...
        var GameRoomLevelConf = _GConstants.GameRoomLevelConf = {
          XINSHOU_ROOMID: 12,
          //新手场
          PRIVATE_ROOMID: 100,
          //私人房银币场
        ...
        var UserLoginFailCode = _GConstants.UserLoginFailCode = {
        ...
        var UserLoginState = _GConstants.UserLoginState = {
          None: 0,
          //没登录
          Logining: 1,
          //正在登录中
        ...
        var RedDotConf = _GConstants.RedDotConf = {
          /** 七日签到 */
          Sign: "Sign",
        ...
        var GoodsSubTypes = _GConstants.GoodsSubTypes = {
          PROP: 1,
          // 其他道具
          ROLE_EXPER: 2,
          // 角色体验卡 
        ...
        var UserBankUpState = _GConstants.UserBankUpState = {
          /** 假破产 */
          Fake: -1,
        ...
        var UserBankUpType = _GConstants.UserBankUpType = {
          /** 保险箱资产足够 */
        ...
        var BankupDialogType = _GConstants.BankupDialogType = {
          FIRST_SAFEBOX: 1,
        ...
        var MsgStatus = _GConstants.MsgStatus = {
          /** 原始状态 */
          MSG_STATUS_FRESH: 1,
        ...
        var MsgAwardStatus = _GConstants.MsgAwardStatus = {
          GOT: 1,
          NOT_GOT: 0
        };
        var MessageMaxNum = _GConstants.MessageMaxNum = 100;
        var UserGoodsDataType = _GConstants.UserGoodsDataType = {
          GOODS_CONFIG: 1,
          // 物品配置
          ROLES_CONFIG: 2,
          // 角色配置
        ...
        var ShopBigTabType = _GConstants.ShopBigTabType = {
          ALL: 0,
          SILVER_COIN: 1,
          //银币
          PROPS: 3 // 道具
        ...
        var GoodsListID = _GConstants.GoodsListID = {
          MarketSilver: 1,
          //商城银币商品信息
          MarketVip: 2,
          //商城VIP商品信息
        ...
        var GoodsType = _GConstants.GoodsType = {
          SILVER_COIN: {
            id: 0,
            name: "银币"
          },
        ...
        var ShopSmallTabType = _GConstants.ShopSmallTabType = {
          SILVER_COIN: 1,
          //金条
          PROPS: 3 //道具
          // GOLD: 12, // 金条
        ...
        var getGoodsTypeNameByScene = _GConstants.getGoodsTypeNameByScene = [{
          scene: 1,
          name: '银币'
        }, {
          scene: 3,
        ...
        var GoodMoneyType = _GConstants.GoodMoneyType = {
          rmb: 1,
          //人民币
          gold: 2,
          //银币
        ...
        var AppPayResult = _GConstants.AppPayResult = {
          /** 不支持 */
          UNINE: -1,
        ...
        var GameID = _GConstants.GameID = {
          // DDZ: 203,
          FXJ: 2000
        };
        var GameTab = _GConstants.GameTab = {
          /** 可吃场 */
          kechi: "kechi",
        ...
        var UBPaySceneConfig = _GConstants.UBPaySceneConfig = {
          kHallMarketGold: "1",
          //大厅商城银币
          kHallMarketVip: "2",
          //大厅商城VIP购买
        ...
        var UBPayLastSceneConfig = _GConstants.UBPayLastSceneConfig = {
          kHallScene: 1,
          // 大厅场景
          kHallSceneButton: 2,
          // 大厅场景按钮
        ...
        var JumpViewConf = _GConstants.JumpViewConf = {
          /** 登录 */
          POS_LOGIN: 1,
        ...
        var PopupPos = _GConstants.PopupPos = {
          /** 登录 */
          POS_LOGIN: 1,
        ...
        var PopupIds = _GConstants.PopupIds = {
          /** 签到 */
          SIGNIN: 1000,
        ...
        var PayMode = _GConstants.PayMode = {
          WEIXIN_PMODE: "431",
          // 微信支付3.0
          WEBCHAT_PMODE: "756",
          // 微信web支付
        ...
        var PayType = _GConstants.PayType = {
          /** 免费 */
          FREE: 0,
        ...
        var PayScene = _GConstants.PayScene = {
          hall: "大厅",
          game: "游戏"
        };
        var PayModel = _GConstants.PayModel = {
          sign_card: "签到_补签卡",
          sign_video: "签到_视频补签",
        ...
        var BtnConf = _GConstants.BtnConf = {
          /**同意-小 */
          Label_Agree: "agree",
        ...
        var DialogTitle = _GConstants.DialogTitle = {
          /**添加标签*/
          Add_tag: "add_tag",
        ...
        var ShareSceneConf = _GConstants.ShareSceneConf = {
          /** 客服分享 */
          kefugift: "kefugift",
        ...
        var MenuIDConf = _GConstants.MenuIDConf = {
          ZKLB: 1 // 折扣礼包
        ...
        var WatchMessageFrdType = _GConstants.WatchMessageFrdType = {
          inval: 0,
          // 非法值
          invite: 1,
          // 点赞邀请
        ...
        var FriendUserInfoSceneTab = _GConstants.FriendUserInfoSceneTab = {
          list: 1,
          lately: 2,
          friendMsg: 3
        };
        var ReqUrl = _GConstants.ReqUrl = {
        ...
        var goodsIsHave = _GConstants.goodsIsHave = {
          isNotHave: 0,
          isHave: 1
        };
        var AppLunchScene = _GConstants.AppLunchScene = {
          ["1000"]: 1000,
        ...
        var shareSucConditions = _GConstants.shareSucConditions = {
          shareUseTime: 3
        };
...
//# sourceMappingURL=bac4d276b664b1e7926bfdc8d3517b0e37023dc0.js.map