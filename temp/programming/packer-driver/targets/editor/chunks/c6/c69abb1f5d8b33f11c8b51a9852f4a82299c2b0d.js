      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onOutCard() {
          ...
          if (this.isChiInRange((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().myOpCode)) {// PlayerMgr.getInstance().updateMyhands(OperationMgr.getInstance().outCardList)
...
//# sourceMappingURL=c69abb1f5d8b33f11c8b51a9852f4a82299c2b0d.js.map