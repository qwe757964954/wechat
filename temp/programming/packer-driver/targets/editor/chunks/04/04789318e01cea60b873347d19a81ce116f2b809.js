System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Layout, Node, Prefab, _decorator, EventManager, Utils, BaseComponent, OperationMgr, RoomMgr, GameStatus, OPCode, GameEvent, Card, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, OpInfo;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("OpInfo", OpInfo = (_dec = ccclass('OpInfo'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Layout), _dec9 = property(Layout), _dec10 = property(Layout), _dec11 = property({
        tooltip: "手牌预制体",
        type: Prefab
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "CardItemPrefab", _descriptor10, this);
        ...
        updateOpration(resp) {
          ...
          let result = this.findOpTypesWithSameNodeAndCode(this.opTypeArr);

          for (let i = 0; i < result.length; i++) {
            let cardArr = (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
              error: Error()
            }), OperationMgr) : OperationMgr).getInstance().getOprationListNumber();
          }
        ...
        findOpTypesWithSameNodeAndCode(opTypes) {
          const opTypesMap = new Map(); // 遍历 opTypes 数组，将具有相同 node 和 code 的 OpType 放入映射中
          ...
          const optypedEntries = Array.from(opTypesMap.entries()).filter(([key, opTypes]) => opTypes.length > 1); // 构建一个新的 Map 包含筛选结果

          const opMap = new Map(optypedEntries); // 从映射中提取所有具有相同 node 和 code 的 OpType 数组
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "CardItemPrefab", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=04789318e01cea60b873347d19a81ce116f2b809.js.map