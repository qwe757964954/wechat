    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        foldAnimation() {
          ...
          let trackDraw = new animation.VectorTrack();
          trackDraw.componentsCount = 3;
          trackDraw.path = new animation.TrackPath().toProperty("RotateClip"); // let [drawX] = trackDraw.channels();
...
//# sourceMappingURL=04980eb9789a83549634813873a8bea7f1f7b090.js.map