  ...
  return {
    ...
    execute: function () {
      ...
      _export("LayerPopUp", LayerPopUp = class LayerPopUp extends (_crd && LayerUI === void 0 ? (_reportPossibleCrUseOfLayerUI({
        ...
        reloadMaskSprite(color = new Color(0, 0, 0, 150)) {
          let width = 100;
          let height = 100;
        ...
        onTouchMaskEnd(event) {
          if (this.children.length >= 2) {
            ...
            if (topChild && topChild.active == true && topChild.isValid == true) {
              let delegateComponent = topChild.getComponent(_crd && DelegateComponent === void 0 ? (_reportPossibleCrUseOfDelegateComponent({
                error: Error()
              }), DelegateComponent) : DelegateComponent);

              if (delegateComponent) {
                let viewParams = delegateComponent.viewParams;
...
//# sourceMappingURL=82abe890da324ba3efba8a0550a12470b97648a3.js.map