      ...
      _export("NodeUserPrefabCtr", NodeUserPrefabCtr = (_dec = ccclass('NodeUserPrefabCtr'), _dec2 = menu('prefab/game/NodeUserPrefabCtr'), _dec3 = property({
        ...
        showChatMsg(event, body) {
          ...
          */
          ...
          let audioName = body['index'];
          let arr = audioName.split('_');
          ...
          let tagArr = (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
            error: Error()
          }), FXJConstant) : FXJConstant).ChatText[tag];
...
//# sourceMappingURL=448aadf2c4e7170c6fea53ab63da1f88292fc4f1.js.map