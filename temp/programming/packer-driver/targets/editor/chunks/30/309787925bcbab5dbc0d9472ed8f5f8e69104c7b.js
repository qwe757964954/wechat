System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, MeshRenderer, Node, Texture2D, _decorator, GCache, Utils, BaseComponent, RoomMgr, GameStatus, FXJRes, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, NodeClockCtr;
    ...
    execute: function () {
      ...
      _export("NodeClockCtr", NodeClockCtr = (_dec = ccclass('NodeClockCtr'), _dec2 = property({
        ...
        onReconnect(data) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).isNull(data.operationSeatId) || data.operationSeatId < 1 || data.operationSeatId > 4) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).isNull(data.operationTimePass)) {
...
//# sourceMappingURL=309787925bcbab5dbc0d9472ed8f5f8e69104c7b.js.map