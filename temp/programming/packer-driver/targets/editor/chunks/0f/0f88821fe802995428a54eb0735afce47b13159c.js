System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, Layout, Node, Prefab, _decorator, EventManager, Utils, BaseComponent, OperationMgr, RoomMgr, GameStatus, OPCode, FXJEvent, FXJRes, FXJSound, GameEvent, Card, Carditem, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, OpInfo;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Carditem = _unresolved_13.Carditem;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("OpInfo", OpInfo = (_dec = ccclass('OpInfo'), _dec2 = property(Node), _dec3 = property(Layout), _dec4 = property(Layout), _dec5 = property(Layout), _dec6 = property(Layout), _dec7 = property(Layout), _dec8 = property(Layout), _dec9 = property(Layout), _dec10 = property({
            ...
            if (layout instanceof Layout) {
              ...
              if (card) {
                card.getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
                  ...
                  error: Error()
                }), OperationMgr) : OperationMgr).getInstance().getHuNumber());
              }

              let opNode = layout.node.getChildByName("sk");
        ...
        cleanLayout() {
          let opLayouts = [this.chiLayout, this.pengLayout, this.gangLayout];
...
//# sourceMappingURL=0f88821fe802995428a54eb0735afce47b13159c.js.map