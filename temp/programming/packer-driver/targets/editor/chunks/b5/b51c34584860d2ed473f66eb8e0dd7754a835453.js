System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, Layout, Node, Prefab, _decorator, EventManager, Utils, BaseComponent, OperationMgr, RoomMgr, GameStatus, OPCode, GameEvent, Card, Carditem, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, OpInfo;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Carditem = _unresolved_10.Carditem;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("OpInfo", OpInfo = (_dec = ccclass('OpInfo'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Layout), _dec9 = property(Layout), _dec10 = property(Layout), _dec11 = property({
        ...
        findOpTypesWithSameNodeAndCode(opTypes) {
          ...
          for (const [name, group] of opMap) {
            ...
            let cardItem = node.getComponent(_crd && Carditem === void 0 ? (_reportPossibleCrUseOfCarditem({
              error: Error()
            }), Carditem) : Carditem);
            cardItem.updateCardItemProp(name, group);
          }
        }
...
//# sourceMappingURL=b51c34584860d2ed473f66eb8e0dd7754a835453.js.map