  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameHandCardPrefabCtr", GameHandCardPrefabCtr = (_dec = ccclass('GameHandCardPrefabCtr'), _dec2 = property({
        ...
        cleanHandCard() {
          let cardMgr = this.cardZone.getComponent(_crd && CardPlayManeger === void 0 ? (_reportPossibleCrUseOfCardPlayManeger({
            error: Error()
...
//# sourceMappingURL=e8c708fc82a22707900f496e46f392c266f2021a.js.map