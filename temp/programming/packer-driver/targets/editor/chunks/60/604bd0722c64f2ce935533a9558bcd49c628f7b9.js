      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onOutCard() {
          ...
          console.log("onOutCard______", (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().myOpCode, indexs, (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
...
//# sourceMappingURL=604bd0722c64f2ce935533a9558bcd49c628f7b9.js.map