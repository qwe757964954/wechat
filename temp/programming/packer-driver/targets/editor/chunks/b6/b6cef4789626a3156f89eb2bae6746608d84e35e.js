        ...
        updateTabList() {
          ...
          for (let key in this.tabLayer) {
            ...
            if (key == String(this.currowChooseTabID)) {
              ...
              select.active = false; // 判断未选中的数据是否有红点
              // if(){}
          ...
          if (this.currowChooseTabID == 0) {
            if (this.bgPanelActivity["ReloadUrl"] != this.currowChooseData["bg_pic"]) {
              ...
              if (String(this.currowChooseData["bg_pic"]).includes(".gif")) {
                ...
                let gifRenderLoad = pngNode.addComponent(_crd && GifRenderLoad === void 0 ? (_reportPossibleCrUseOfGifRenderLoad({
                  error: Error()
...
//# sourceMappingURL=b6cef4789626a3156f89eb2bae6746608d84e35e.js.map