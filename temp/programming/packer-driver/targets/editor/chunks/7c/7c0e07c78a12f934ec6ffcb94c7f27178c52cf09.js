    ...
    execute: function () {
      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onOutCard() {
          ...
          console.log("OPE_OUT_CARD__________________________", removed);
          ...
          if (removed) {
            ...
            console.log("OPE_OUT_CARD__________________________", insertIndex);
          ...
          if (!this.isChiInRange((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            ...
            console.log("OPE_OUT_CARD__________________________", (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
              error: Error()
            }), OperationMgr) : OperationMgr).getInstance().myOpCode);
        ...
        onAnGangCard() {
          ...
          if (isGrab) {
            ...
            myHand.stackAnim(indexs); // OperationMgr.getInstance().getMyHandCardResult(OperationResultMgr.getInstance().opCards);
          } else {
        ...
        onChiCard() {
          ...
          myHand.cancelOpcardTouch((_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCard); // myHand.updateHandPositionAndName();
        }
          ...
          switch ((_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            ...
            case (_crd && OPCode === void 0 ? (_reportPossibleCrUseOfOPCode({
              ...
              if (this.isChiInRange((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
                ...
                console.log("OPE_OUT_CARD__________________________");
              } //自己出牌
...
//# sourceMappingURL=7c0e07c78a12f934ec6ffcb94c7f27178c52cf09.js.map