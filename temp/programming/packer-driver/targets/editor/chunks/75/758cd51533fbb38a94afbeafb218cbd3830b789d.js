      ...
      _export("PopWindowComponent", PopWindowComponent = (_dec = ccclass('PopWindowComponent'), _dec2 = menu('vc/PopWindowComponent'), _dec3 = property({
        ...
        updateView() {
              ...
              case 1:
                ...
                for (let key in this._params.buttonsMap) {
                  if (Object.prototype.hasOwnProperty.call(this._params.buttonsMap, key)) {
                    let btnConf = this._params.buttonsMap[key];
                  ...
                  if (Object.prototype.hasOwnProperty.call(this._params.buttonsMap, key)) {
                    ...
                    if (btn) {
                      ...
                      if (btnLabel) {
                        ...
                        if (labelComm) {
                          labelComm.string = (btnConf == null ? void 0 : btnConf.label) || (num == 1 ? (_crd && GameTxt === void 0 ? (_reportPossibleCrUseOfGameTxt({
                            error: Error()
          ...
          if (chooseType == 1) {
            ...
            labelDesc.string = ((_this$_params10 = this._params) == null ? void 0 : _this$_params10.txt_desc) || "";
...
//# sourceMappingURL=758cd51533fbb38a94afbeafb218cbd3830b789d.js.map