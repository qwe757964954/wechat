      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cancelOpcardTouch(opcard) {
          ...
          for (let i = 0; i < this._mjList.length; i++) {
            ...
            console.log("cancelOpcardTouch____________", (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
              error: Error()
...
//# sourceMappingURL=9e65e8a0e1829e7f52cadd7f287617cd6b414430.js.map