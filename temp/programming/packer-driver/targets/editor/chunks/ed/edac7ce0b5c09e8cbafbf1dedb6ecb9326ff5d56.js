    ...
    execute: function () {
      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onPengGangCard() {
          ...
          console.log("indexs_________________", indexs);
        ...
        onAnGangCard() {
          ...
          console.log("indexs_________________", isGrab, indexs);
          ...
          switch ((_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            ...
            case (_crd && OPCode === void 0 ? (_reportPossibleCrUseOfOPCode({
              ...
              (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                ...
                error: Error()
              }), GameEvent) : GameEvent).CLOSE_OPRATION_INFO); //自己出牌
...
//# sourceMappingURL=edac7ce0b5c09e8cbafbf1dedb6ecb9326ff5d56.js.map