System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Color, Label, Layout, Node, Prefab, ScrollView, Sprite, SpriteAtlas, SpriteFrame, UITransform, _decorator, instantiate, GCache, AppEvent, AppSound, APPState, GConstants, GameRes, GameTxt, ReportConfig, UIID, Utils, Encrypt, ButtonSimple, DelegateComponent, resLoader, EventManager, BaseComponent, Platform, commonBtnPrefabCtr, shopGoodsPrefabCtr, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _crd, ccclass, property, menu, mallPrefabCtr;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Encrypt = _unresolved_12.Encrypt;
    }, function (_unresolved_13) {
      ButtonSimple = _unresolved_13.default;
    }, function (_unresolved_14) {
      DelegateComponent = _unresolved_14.DelegateComponent;
    }, function (_unresolved_15) {
      resLoader = _unresolved_15.resLoader;
    }, function (_unresolved_16) {
      EventManager = _unresolved_16.EventManager;
    }, function (_unresolved_17) {
      BaseComponent = _unresolved_17.BaseComponent;
    }, function (_unresolved_18) {
      Platform = _unresolved_18.Platform;
    }, function (_unresolved_19) {
      commonBtnPrefabCtr = _unresolved_19.commonBtnPrefabCtr;
    }, function (_unresolved_20) {
      shopGoodsPrefabCtr = _unresolved_20.shopGoodsPrefabCtr;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("mallPrefabCtr", mallPrefabCtr = (_dec = ccclass('mallPrefabCtr'), _dec2 = menu('prefab/hall/mallPrefabCtr'), _dec3 = property({
        ...
        getShopData(type = null) {
          let res = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        processApplicationActions(event, state) {
          ...
          if (state == (_crd && APPState === void 0 ? (_reportPossibleCrUseOfAPPState({
            ...
            let isCanShare = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            ...
            if (isCanShare == true && this._currowShareData) {
              ...
              // 判断支付方式是分享再提示
              if (Number(this._currowShareData['currency']) == (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                error: Error()
        ...
        initView(isOnload = false) {
          ...
          if (isOnload) {
            ...
            this.getPreLoaderRes((_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
              ...
              let comp = res.getComponent(_crd && commonBtnPrefabCtr === void 0 ? (_reportPossibleCrUseOfcommonBtnPrefabCtr({
                error: Error()
        ...
        updateBigTab() {
          ...
          let bigTagData = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          for (let i = 0; i < this._bigTabList.length; i++) {
            ...
            if (!nodeItem) {
              ...
              let nodeNormal = nodeItem.getChildByName("normal");
              let nodeChoose = nodeItem.getChildByName("choose");
            ...
            if (nodeItem['pageID'] != this._bigTabList[i].scene) {
              this.getPreLoaderRes((_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
                ...
                let normal = atlas.getSpriteFrame(self._bigTabList[i].normal);
                let choose = atlas.getSpriteFrame(self._bigTabList[i].choose);
        ...
        updateSmallTag() {
          let smallTagData = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          for (let i = 0; i < smallTagData.length; i++) {
            ...
            if (!nodeItem["aniNode"]) {
              nodeItem["aniNode"] = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                error: Error()
          ...
          if (this.currowChooseSmallTagCid != null && allSmallNode.length > 0) {
            for (let i = 0; i < allSmallNode.length; i++) {
              let buttonSimple = allSmallNode[i].getComponent(_crd && ButtonSimple === void 0 ? (_reportPossibleCrUseOfButtonSimple({
                error: Error()
        ...
        showSilverView() {
          ...
          for (let i = 0; i < goodsData.length; i++) {
            ...
            let comp = nodeItem.getComponent(_crd && shopGoodsPrefabCtr === void 0 ? (_reportPossibleCrUseOfshopGoodsPrefabCtr({
              error: Error()
        ...
        onClickGoodsItem(event) {
          let nodeGoodItem = event.target.parent;
          let nodeGoodItemComp = nodeGoodItem.getComponent(_crd && shopGoodsPrefabCtr === void 0 ? (_reportPossibleCrUseOfshopGoodsPrefabCtr({
            error: Error()
          }), shopGoodsPrefabCtr) : shopGoodsPrefabCtr);
          ...
          let goodsData = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        payProcess(goodsItem) {
          ...
          switch (goodsItem.currency) {
            case (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              ...
              let pmodes = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
                error: Error()
              }), Encrypt) : Encrypt).JsonDecode(goodsItem.pmodes);
              (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                error: Error()
              }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
                error: Error()
        ...
        onClickSmallTag(event) {
          ...
          for (let child of this.smallTabLayer.children) {
            if (child["cid"]) {
              let buttonSimple = child.getComponent(_crd && ButtonSimple === void 0 ? (_reportPossibleCrUseOfButtonSimple({
                error: Error()
              }), ButtonSimple) : ButtonSimple);
...
//# sourceMappingURL=ed12d4c9d6d201315ca6944521e0e7724350199a.js.map