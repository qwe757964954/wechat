  ...
  return {
    ...
    execute: function () {
      ...
      ResLoader = class ResLoader {
        ...
        loadBundle(url, callback = null, v) {
          return new Promise((resolve, reject) => {
        ...
        loadRemote(url, options, onComplete) {
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_isHttp(url) && (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
        ...
        releaseList(pathList, bundleName = "resources") {
...
//# sourceMappingURL=06d539a4c91c138517023a7a87e925e3a382768b.js.map