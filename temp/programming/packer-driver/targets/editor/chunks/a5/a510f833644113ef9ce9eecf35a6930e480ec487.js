    ...
    execute: function () {
      ...
      _export("ReportServers", ReportServers = class ReportServers extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        updateLoggerReportInfo() {
          let uid = null;
          let platform = (_crd && Platform === void 0 ? (_reportPossibleCrUseOfPlatform({
            error: Error()
          }), Platform) : Platform).ClientPlatform;
          let sdkVersion = (_crd && Platform === void 0 ? (_reportPossibleCrUseOfPlatform({
            error: Error()
          ...
          let info = `[HallVer:${(_crd && ClientInfo === void 0 ? (_reportPossibleCrUseOfClientInfo({
            error: Error()
        ...
        __startReport() {
          ...
          let appid = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        __checkCanReport(isFouce = false) {
          //空数据、网络异常时不上报
        ...
        __genPackageBody(eventID, param = null) {
...
//# sourceMappingURL=a510f833644113ef9ce9eecf35a6930e480ec487.js.map