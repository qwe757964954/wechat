      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cardAddTouchEvent(handNode) {
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            // 获取当前节点的位置
            const nodePosition = this.node.position; // 获取触摸的上一帧位置

            const touchDelta = event.getDelta(); // 在Y轴上添加触摸位移
            // nodePosition.y += touchDelta.y;
            // // 更新节点的位置
...
//# sourceMappingURL=024f8ee7e1401e37ea8d6c410e52b4d886286a8a.js.map