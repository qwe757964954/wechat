System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Node, Tween, Vec3, _decorator, instantiate, tween, Utils, BaseComponent, RoomMgr, OPCode, GameViewConfig, NodeCardCtr, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, NodeHandCardCtr;
    ...
    execute: function () {
      ...
      _export("NodeHandCardCtr", NodeHandCardCtr = (_dec = ccclass('NodeHandCardCtr'), _dec2 = property({
        ...
        initView() {
          ...
          for (let dir = 0; dir < 4; dir++) {
            ...
            for (let i = 0; i < num; i++) {
              ...
              this._seatList[dir].push(card); // card.getComponent(NodeCardCtr).byte = i + 1;
        ...
        adjustPosition(dir) {
          ...
          for (let i = 0; i < num; i++) {
            let leftToRight = -this._cardStart + i * (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
              error: Error()
            }), GameViewConfig) : GameViewConfig).CardConfig.Width;
        ...
        normalOutCardAny(dir, count) {
          ...
          for (let i = 0; i < num; i++) {
            ...
            let x = -this._cardStart + i * (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
              error: Error()
            }), GameViewConfig) : GameViewConfig).CardConfig.Width;
...
//# sourceMappingURL=dd9d02af4f1f00c0a9483ba12f3d2108084bd0e8.js.map