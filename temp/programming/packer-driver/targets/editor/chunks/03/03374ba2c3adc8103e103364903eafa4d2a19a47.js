System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Button, Node, Sprite, _decorator, GCache, AppEvent, GConstants, GameTxt, Utils, resLoader, EventManager, BaseComponent, Platform, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, menu, bankupGift;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("bankupGift", bankupGift = (_dec = ccclass('bankupGift'), _dec2 = menu('bankupGift'), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = _dec2(_class = (_class2 = class bankupGift extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        */
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "BGNode", _descriptor4, this);

          _initializerDefineProperty(this, "item_1", _descriptor5, this);

          _initializerDefineProperty(this, "item_2", _descriptor6, this);

          _initializerDefineProperty(this, "item_3", _descriptor7, this);
        ...
        updateView() {
          ...
          if (giftPack && giftPack.length != 0) {
            ...
            for (let index = 0; index < len; index++) {
              // 当前节点
              let itemNode = this._goodsGiftArray[index]; // 商品图片
        ...
        onClickBuyGoods(event, custom) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            let gid = this._bankrupFeedbackData["giftPack"][this._currowChooseIndex]["id"]; //查找支付类型
        ...
        onClickGoods(event) {
          ...
          for (let index = 0; index < this._goodsGiftArray.length; index++) {
            ...
            if (Checkmark.name == this._goodsGiftArray[index].name) {
              this._currowChooseIndex = index;
              let currentGood = this._bankrupFeedbackData["giftPack"][index]; // 选中状态  
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "logoNode", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "BGNode", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "item_1", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "item_2", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "item_3", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=03374ba2c3adc8103e103364903eafa4d2a19a47.js.map