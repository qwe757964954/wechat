  ...
  return {
    ...
    execute: function () {
      ...
      _LayerManager = class _LayerManager {
        ...
        updateZorder() {
          for (let layerType in this.NodeList) {
            if (Object.prototype.hasOwnProperty.call(this.NodeList, layerType)) {
              let node = this.NodeList[layerType];
        ...
        open(uiId, uiArgs = null, callbacks = null, parent = null, isClickSpanceClose = false, isAutoRecover = false) {
        ...
        remove(uiId, isDestroy = true, parent = null) {
          if (LayerManager.loadState == false) {
        ...
        clear(layerType = null, isDestroy = true, parent = null) {
          if (!this.root) {
        ...
        clearOther(layerType = null, isIncludeNetWindow = false) {
          if (!this.root) {
            warn(`Layermanager还没有初始化`);
            return;
          }
...
//# sourceMappingURL=03d89f2d7913cd149778382afc6552304231681b.js.map