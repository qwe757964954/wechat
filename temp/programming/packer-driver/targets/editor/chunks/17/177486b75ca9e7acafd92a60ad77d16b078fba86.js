System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Color, instantiate, Label, Layout, Node, Prefab, ScrollView, Sprite, SpriteAtlas, UITransform, Vec3, _decorator, resLoader, EventManager, Utils, BaseComponent, PlayerMgr, SettleMgr, FXJEvent, FXJRes, FXJUIID, GameEvent, Card, BottomItem, FanItem, List, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _crd, ccclass, property, TitleColor, Settle;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Color', 'instantiate', 'Label', 'Layout', 'Node', 'Prefab', 'ScrollView', 'Sprite', 'SpriteAtlas', 'UITransform', 'Vec3', '_decorator']);
      ...
      _export("Settle", Settle = (_dec = ccclass('Settle'), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(ScrollView), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Layout), _dec11 = property(Prefab), _dec12 = property(Node), _dec13 = property(_crd && List === void 0 ? (_reportPossibleCrUseOfList({
        ...
        updateMyselfCards() {
          ...
          for (let i = 0; i < array.length; i++) {
            ...
            node.getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
              error: Error()
            }), Card) : Card).setCardAngle(90, 0, 0); // let transform = node.getComponent(UITransform);
        ...
        async updateWinCards() {
          ...
          let transform = hu_node.getComponent(UITransform);
          transform.setContentSize(53, 78);
...
//# sourceMappingURL=177486b75ca9e7acafd92a60ad77d16b078fba86.js.map