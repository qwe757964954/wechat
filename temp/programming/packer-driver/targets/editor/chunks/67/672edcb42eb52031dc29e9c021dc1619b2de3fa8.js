  ...
  return {
    ...
    execute: function () {
      ...
      (function (_FXJConstant) {
        const PlayType = _FXJConstant.PlayType = {
          NORMAL: "normal",
          MATCH: "match"
        };
        const QuickChatDelay = _FXJConstant.QuickChatDelay = 3;
        const ChatText = _FXJConstant.ChatText = {
          /** 热门聊天语 */
          // hot: [
          // 	"Bro，靠你了",
          // 	"退退退",
        ...
        const ChatEmojiAniConf = _FXJConstant.ChatEmojiAniConf = {
          [1]: "1_XYX",
          [2]: "2_KS",
          [3]: "3_Heng",
          [4]: "4_MR",
        ...
        const EmojiProp = _FXJConstant.EmojiProp = [//鸡蛋
        {
          name: "鸡蛋",
          propID: 100,
          icon: "jidan",
        ...
        const AnimNormal = _FXJConstant.AnimNormal = {
          /** 互动道具 */
          HudongProp: "HudongProp"
        };
        const HuDongPropConf = _FXJConstant.HuDongPropConf = {
          direction: {
            [1]: "_l",
            [2]: "_r",
            [3]: "_l"
...
//# sourceMappingURL=672edcb42eb52031dc29e9c021dc1619b2de3fa8.js.map