System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Layout, Prefab, _decorator, EventManager, BaseComponent, PlayerMgr, RoomMgr, FXJEvent, FXJRes, GameEvent, CardUtil, Player, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Match;
      ...
      _export("Match", Match = (_dec = ccclass('Match'), _dec2 = property({
        ...
        showPlayer(player) {
          ...
          if (this.playerList[seatId]) {
            ...
            let scriptPlayer = this.playerList[seatId].getComponent(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              error: Error()
            }), Player) : Player);
          ...
          this.getPreLoaderRes((_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            ...
            let scriptPlayer = nodeRes.getComponent(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              error: Error()
            }), Player) : Player);
            scriptPlayer.updatePlayerProperty(player);
...
//# sourceMappingURL=67bec0c76c66661747da58550e8bf777fbd2cf10.js.map