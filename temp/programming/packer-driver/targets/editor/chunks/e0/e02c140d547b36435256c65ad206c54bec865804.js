System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19", "__unresolved_20", "__unresolved_21", "__unresolved_22", "__unresolved_23"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, AppEvent, ClientInfo, CloundKey, GConstants, StoreKey, Encrypt, LocalStorage, EventManager, Utils, BaseCache, Platform, Activity, BackPack, BankrupData, GoodsData, MailInfo, MenuInfo, PropsConf, RecommendPop, RedDot, SelectGame, ShareInfo, ShopInfo, TaskInfo, WatchMessage, User, _crd;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      LocalStorage = _unresolved_6.LocalStorage;
    }, function (_unresolved_7) {
      EventManager = _unresolved_7.EventManager;
    }, function (_unresolved_8) {
      Utils = _unresolved_8.Utils;
    }, function (_unresolved_9) {
      BaseCache = _unresolved_9.BaseCache;
    }, function (_unresolved_10) {
      Platform = _unresolved_10.Platform;
    }, function (_unresolved_11) {
      Activity = _unresolved_11.Activity;
    }, function (_unresolved_12) {
      BackPack = _unresolved_12.BackPack;
    }, function (_unresolved_13) {
      BankrupData = _unresolved_13.BankrupData;
    }, function (_unresolved_14) {
      GoodsData = _unresolved_14.GoodsData;
    }, function (_unresolved_15) {
      MailInfo = _unresolved_15.MailInfo;
    }, function (_unresolved_16) {
      MenuInfo = _unresolved_16.MenuInfo;
    }, function (_unresolved_17) {
      PropsConf = _unresolved_17.PropsConf;
    }, function (_unresolved_18) {
      RecommendPop = _unresolved_18.RecommendPop;
    }, function (_unresolved_19) {
      RedDot = _unresolved_19.RedDot;
    }, function (_unresolved_20) {
      SelectGame = _unresolved_20.SelectGame;
    }, function (_unresolved_21) {
      ShareInfo = _unresolved_21.ShareInfo;
    }, function (_unresolved_22) {
      ShopInfo = _unresolved_22.ShopInfo;
    }, function (_unresolved_23) {
      TaskInfo = _unresolved_23.TaskInfo;
    }, function (_unresolved_24) {
      WatchMessage = _unresolved_24.WatchMessage;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("User", User = class User extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        setTodayLocalRecord(key, saveData = null) {
          ...
          let realKey = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          ...
          if (!this._todayEventData) {
            let oldData = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
              error: Error()
        ...
        updateLastLoginTime() {
          ...
          let lastLoginTime = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
        ...
        getDataAccount(key = null, del = null) {
          if (key) {
        ...
        updateDataUserKey(key = null, value = null) {
          if (key) {
            let user = this.getData("user");
        ...
        updateDataGameKey(key = null, value = null) {
          if (key) {
            let game = this.getData("game");
        ...
        updateDataAccountKey(key = null, value = null) {
          if (key) {
            let account = this.getData("account");
        ...
        saveLastlocalLoginInfo(param) {
          let res = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
            error: Error()
        ...
        getLastLoginValueByKey(key, def = null) {
          if (!key) {
            return def;
          }
        ...
        getUserCity(del = null) {
          return this.getDataUser("city", del);
        } //获取用户头像数组


        getUserHeadArray(del = null) {
          let headArray = {
        ...
        getUserMoneyByID(moneyID = 0, isAll = false) {
        ...
        updateUserMoneyByID(moneyID = 0, value = 0, isAll = false) {
          let oldNum = null;
          let newNum = null;
        ...
        updateAccountHistory(param) {
          ...
          let temp = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
            error: Error()
          }), Encrypt) : Encrypt).JsonEncode2(param);
        ...
        updateLoginSuccessCount() {
          ...
          let jsonStr = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
            error: Error()
        ...
        updateLevelExpConfig(body) {
          ...
          let oneArray = ["exp", "name", "level"]; //已经排序过了
        ...
        setVipTime(time) {
          let leftTime = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        getLoginSuccessCount(mid) {
          if (!this._loginSuccessCountArray || !this._loginSuccessCountArray[mid]) {
            let record = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
              error: Error()
            }), LocalStorage) : LocalStorage).get((_crd && StoreKey === void 0 ? (_reportPossibleCrUseOfStoreKey({
              error: Error()
        ...
        getGamePlayRecordByKey(gameID, itemKey = null) {
          gameID = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).number_valueOf(gameID, null);
        ...
        updateGamePlayRecordByKey(gameID, itemKey = null) {
          gameID = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).number_valueOf(gameID, null);
        ...
        getCloudStorageKeys() {
          let keys = [(_crd && CloundKey === void 0 ? (_reportPossibleCrUseOfCloundKey({
            error: Error()
        ...
        getCloudStorageParam() {
          //当前用户openID的数据
          let key_openid = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_format((_crd && StoreKey === void 0 ? (_reportPossibleCrUseOfStoreKey({
            error: Error()
          }), StoreKey) : StoreKey).LOGIN_USER_OPENID, this.getUserMid());
          let currentOpenid = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            let shopShareMsg = this.__shareInfo.getShareConfigByType((_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              error: Error()
...
//# sourceMappingURL=e02c140d547b36435256c65ad206c54bec865804.js.map