  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerOutCards", PlayerOutCards = (_dec = ccclass('PlayerOutCards'), _dec(_class = class PlayerOutCards extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        getOutCardPos() {
          let posInfo = this.getOutCardPosInfo(this._mjList.length); // return new Vec3(MjSize.width/2 +posInfo.column * MjSize.width, MjSize.length/2 + posInfo.height * MjSize.length, MjSize.height/2 + MjSize.height * posInfo.row);
...
//# sourceMappingURL=e010d3813282cc53421cfe83aad11eeea99b48f9.js.map