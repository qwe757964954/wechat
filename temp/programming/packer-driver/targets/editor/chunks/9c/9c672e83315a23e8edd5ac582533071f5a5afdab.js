    ...
    execute: function () {
      ...
      _export("MenuInfo", MenuInfo = class MenuInfo extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        initMapping() {
          ...
          for (let i = 0; i < (_crd && UIDataMapping === void 0 ? (_reportPossibleCrUseOfUIDataMapping({
            error: Error()
          }), UIDataMapping) : UIDataMapping).length; i++) {
            let conf = (_crd && UIDataMapping === void 0 ? (_reportPossibleCrUseOfUIDataMapping({
              error: Error()
            }), UIDataMapping) : UIDataMapping)[i];
            let newConf = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
        ...
        */
        ...
        sortCustomMenus(menuArray, notCheckSwitch = false) {
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
...
//# sourceMappingURL=9c672e83315a23e8edd5ac582533071f5a5afdab.js.map