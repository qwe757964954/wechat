System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Node, _decorator, EventManager, Utils, BaseComponent, RoomMgr, GameStatus, FXJCMDHead, Card, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, BugangBottom;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      FXJCMDHead = _unresolved_7.FXJCMDHead;
    }, function (_unresolved_8) {
      Card = _unresolved_8.Card;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("BugangBottom", BugangBottom = (_dec = ccclass('BugangBottom'), _dec2 = property(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
        ...
        opClick(byte) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            error: Error()
          }), EventManager) : EventManager).dispatch(FXJEvent.NET_SEND_MSG, sendMsg);
          this.node.active = false;
        }
...
//# sourceMappingURL=b2f30243d6c237d785839b38092dd2c288ff0e5e.js.map