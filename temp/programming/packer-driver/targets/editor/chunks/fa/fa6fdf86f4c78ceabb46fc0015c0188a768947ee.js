      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onOutCard() {
          ...
          if ((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().myOpCode === (_crd && OPCode === void 0 ? (_reportPossibleCrUseOfOPCode({
            error: Error()
...
//# sourceMappingURL=fa6fdf86f4c78ceabb46fc0015c0188a768947ee.js.map