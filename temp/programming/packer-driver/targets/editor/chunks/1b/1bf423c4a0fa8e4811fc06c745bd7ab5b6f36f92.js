System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Node, _decorator, GCache, EventManager, BaseComponent, PlayerMgr, FXJEvent, FXJUIID, FXJSound, GameEvent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, menu, GameMenuPrefabCtr;
    ...
    execute: function () {
      ...
      _export("GameMenuPrefabCtr", GameMenuPrefabCtr = (_dec = ccclass('GameMenuPrefabCtr'), _dec2 = menu('prefab/game/GameMenuPrefabCtr'), _dec3 = property({
        ...
        onInitModuleEvent() {
          ...
          this.addModelListener((_crd && FXJEvent === void 0 ? (_reportPossibleCrUseOfFXJEvent({
            error: Error()
          }), FXJEvent) : FXJEvent).NOTIFY_UPDATE_RED_DOT, this.refreshRedDot); // this.node.on(Node.EventType.TOUCH_END, this.onOprationTouchEnd, this);
        }
...
//# sourceMappingURL=1bf423c4a0fa8e4811fc06c745bd7ab5b6f36f92.js.map