    ...
    execute: function () {
      ...
      _export("LayerUI", LayerUI = class LayerUI extends Node {
        ...
        create_Mask(name = null) {
          ...
          let widget = this._maskNode.getComponent(Widget);
          ...
          let mask = this._maskNode.addComponent(MaskComponent);
        ...
        create_2DSprite(spriteFrame, name = null) {
        ...
        */
        ...
        getSoleID(prefabPath) {
          ...
          let soleKey = soleNum.replace(/\//g, "_"); //记录历史
        ...
        add(config, params, callbacks, isClickSpanceClose, isAutoRecover) {
          ...
          let prefabPath = config.prefab; //唯一标识

          let soleKey = this.getSoleID(prefabPath);
          let viewParams = new (_crd && inf_ViewParams === void 0 ? (_reportPossibleCrUseOfinf_ViewParams({
            error: Error()
        ...
        load(viewParams) {
          ...
          if (viewParams && viewParams.prefabPath) {
            ...
            let prefab = (_crd && resLoader === void 0 ? (_reportPossibleCrUseOfresLoader({
              error: Error()
            ...
            if (!prefab) {
              ...
              let childNode = instantiate(prefab);
              let comp = childNode.addComponent(_crd && DelegateComponent === void 0 ? (_reportPossibleCrUseOfDelegateComponent({
                error: Error()
              }), DelegateComponent) : DelegateComponent);
              comp.viewParams = viewParams;
        ...
        createNode(nedAddNode, viewParams) {
          ...
          let childNode = nedAddNode;
          let comp = childNode.getComponent(_crd && DelegateComponent === void 0 ? (_reportPossibleCrUseOfDelegateComponent({
            error: Error()
          }), DelegateComponent) : DelegateComponent);
          ...
          if (this.children && this.children.length > 0) {
            ...
            for (let i = this.children.length - 1; i >= 0; i--) {
              ...
              if (childNode && childNode.isValid == true) {
                let delegateComponent = childNode.getComponent(_crd && DelegateComponent === void 0 ? (_reportPossibleCrUseOfDelegateComponent({
                  error: Error()
                }), DelegateComponent) : DelegateComponent);
        ...
        __nodes() {
          ...
          for (let i = 0; i < children.length; i++) {
            ...
            if (children[i] && (_children$i = children[i]) != null && _children$i.components) {
              let comp = children[i].getComponent(_crd && DelegateComponent === void 0 ? (_reportPossibleCrUseOfDelegateComponent({
                error: Error()
              }), DelegateComponent) : DelegateComponent);
...
//# sourceMappingURL=018cbc76ba6ed2e447c7860a6ccd37f7f53d7aea.js.map