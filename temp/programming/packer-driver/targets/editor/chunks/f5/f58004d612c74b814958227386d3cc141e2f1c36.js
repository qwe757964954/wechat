    ...
    execute: function () {
      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onDealCard(event, resp) {
          ...
          myHand.node.active = true; // myHand.playAnimOfShow();
        } //重连分牌
        ...
        receiveDealCard(event) {
          ...
          myHand.addHandCards((_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
          }), PlayerMgr) : PlayerMgr).getInstance().getMyhands(), false, null, false); // myHand.playAnimOfShow();
        } //自己出牌
...
//# sourceMappingURL=f58004d612c74b814958227386d3cc141e2f1c36.js.map