    ...
    execute: function () {
      ...
      */
      _export("WebSocketTask", WebSocketTask = class WebSocketTask extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        onMessaged(param = null) {
          if (this._onMessage) {
            this._onMessage(param == null ? void 0 : param.data);
          }
        }
        /** 连接失败 */


        onErrored(param = null) {
        ...
        send(buffer) {
          let data = buffer == null ? void 0 : buffer.buffer;
...
//# sourceMappingURL=2100d04aeafe13d4f34e01c85567a59cc4b83205.js.map