System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, GCache, AppEvent, ClientInfo, GConstants, GameTxt, Encrypt, CountTime, EventManager, Utils, BaseControll, GameEvent, GameRoomHelper, GlobalCMDHead, RoomController, _crd;
  ...
  function _reportPossibleCrUseOfGameEvent(extras) {
    _reporterNs.report("GameEvent", "../package/game/common/GameEvent", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GameRoomHelper = _unresolved_13.GameRoomHelper;
    ...
    execute: function () {
      ...
      _export("RoomController", RoomController = class RoomController extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        onInitModuleEvent() {
          ...
          this.addModelListener((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
            error: Error()
          }), AppEvent) : AppEvent).ACTIVITY_BANKUP_BACK, this.receiveBankUpBack); //手动退出游戏
        ...
        __reConnection(isHaveView = false) {
        ...
        resetIntoGameDataToLogin(event = null) {
          if ((_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        reqEnterGameLogin(event = null) {
          ...
          let gameID = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).number_valueOf(this._intoGameData.GameID, 0);
          let roomLevel = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).number_valueOf(this._intoGameData.Level, 0);
          let tableID = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          ...
          let loginParam = null; //登录发送的数据

          let loginSendCMD = null; //吐司文本
          ...
          if (tableID > 0) {
            ...
            let minMoney = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).number_valueOf(roomData["min_money"]);
            let currowMoney = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
        ...
        stopcheckLoginCheckTimeOut(event = null) {
        ...
        receiveLoginRoomSuccess(event = null, respData = null) {
          ...
          this._isExitsGame = false; //关闭网络loading
        ...
        receiveLoginRoomFail(event = null, respData = null) {
        ...
        receiveRoomInfo(event = null, respData = null) {
        ...
        receiveReadyInfo(event = null, respData = null) {
        ...
        receiveStopPlaying(event = null, respData = null) {
        ...
        reqLogOutInGameForce(event = null) {
          if ((_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        respTryLogOutInGame(event = null, respData = null) {
        ...
        reqGamePlayerAI(event = null, state) {
          //0表示取消托管，非0表示托管
        ...
        receiveRoomLevelUp(event = null, respData = null) {
          this.dump(respData, "广播:收到升降场信息==>");
        }
        /** 请求：换桌 */


        reqGameChangeTable(event = null, isNeedLogout = false) {
          let sendMsg = {
            cmd: (_crd && GlobalCMDHead === void 0 ? (_reportPossibleCrUseOfGlobalCMDHead({
              error: Error()
        ...
        receiveChangeTableError(event = null, respData = null) {
          this.dump(respData, "返回：换桌失败==>");
        }
        /** 房间状态改变 */


        receiveRoomStateChange(event = null, currowRoomState, param = null) {
        ...
        startShowMathChing(isReconn = false) {} //开始显示准备


        startShowReady(param = null) {} //开始显示退出成功


        startShowExitSuccess(param = null) {}
        /** 延迟退出游戏 */


        detailExitGame(isDetail = true) {
          if (isDetail) {
            this.StopCountTime();
        ...
        StartCountTime(key, maxTime, updateCallback, stopCallback, isClearAll = false) {
          if (!key) {
            return;
          }
        ...
        showBankUpView(event) {
          let isInMatchRoom = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).Desk.isInMatchRoom();
          let isInPrivateRoom = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
...
//# sourceMappingURL=92c0e89bfe8108413e3006ed92faa46525b0f86f.js.map