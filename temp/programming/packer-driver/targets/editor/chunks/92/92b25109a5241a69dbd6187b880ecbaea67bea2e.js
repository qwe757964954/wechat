System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, Label, Node, Prefab, Quat, ScrollView, Sprite, SpriteAtlas, SpriteFrame, tween, Vec3, _decorator, GCache, AppEvent, AppSound, GConstants, GameRes, UIID, DelegateComponent, resLoader, EventManager, Utils, BaseComponent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _crd, ccclass, property, menu, selectGameLevelPrefabCtr;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      DelegateComponent = _unresolved_8.DelegateComponent;
    ...
    execute: function () {
      ...
      __checkObsolete__(['EventTouch', 'instantiate', 'Label', 'Node', 'Prefab', 'Quat', 'ScrollView', 'Sprite', 'SpriteAtlas', 'SpriteFrame', 'tween', 'Vec3', '_decorator']);
      ...
      _export("selectGameLevelPrefabCtr", selectGameLevelPrefabCtr = (_dec = ccclass('selectGameLevelPrefabCtr'), _dec2 = menu('prefab/hall/selectGameLevelPrefabCtr'), _dec3 = property({
        ...
        constructor(...args) {
          ...
          this.roomTab = [(_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
            error: Error()
          }), GConstants) : GConstants).GameTab.bukechi, (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
            error: Error()
          }), GConstants) : GConstants).GameTab.kechi];
          this.roomTabID = {
            [(_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              error: Error()
            }), GConstants) : GConstants).GameTab.bukechi]: 0,
            [(_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              error: Error()
            }), GConstants) : GConstants).GameTab.kechi]: 1
          };
        ...
        showLevlelList() {
          ...
          let levelData = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        createCommonItem(play, itemData, isHightLight = false) {
          ...
          let lowScore = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_moneyToShortNumber(itemData.min_money, true);
          let hightScore = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_moneyToShortNumber(itemData.max_money, true); // //小于等于0代表无上限
        ...
        hightLightGameLevel(data) {
          ...
          let currentMin = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          for (let i = 0; i < data.length; i++) {
            ...
            let different = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
        ...
        onClickKeChi(event) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), AppSound) : AppSound).CommClick); //EventManager.dispatch(AppEvent.REPORT_CLIENT_CLICK, { eventID: ReportConfig.selectGame_7 });
        ...
        onClickBtnRule(event) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), UIID) : UIID).PictureTabDialog, "玩法规则", null, null, true);
        } //销毁
...
//# sourceMappingURL=92b25109a5241a69dbd6187b880ecbaea67bea2e.js.map