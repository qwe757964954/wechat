  ...
  return {
    ...
    execute: function () {
      ...
      _export("buyPropDialogCtr", buyPropDialogCtr = (_dec = ccclass('buyPropDialogCtr'), _dec2 = menu('vc/buyPropDialogCtr'), _dec3 = property({
        ...
        updateView() {
          let isExitGoods = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          if (isExitGoods == false) {
            if (this._currowParam.itmeId != null) {
              let temp = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                error: Error()
        ...
        updateBuyConf() {
          ...
          if (this._currowViewParam.payInfo.payID == (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
            ...
            let path = (_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
              error: Error()
...
//# sourceMappingURL=d852c89da6a64d2ea6355d74a2f533750f6b2691.js.map