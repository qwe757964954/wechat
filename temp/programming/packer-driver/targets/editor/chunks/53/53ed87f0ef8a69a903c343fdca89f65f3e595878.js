    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cardAddTouchEvent(handNode) {
          ...
          handNode.on(Node.EventType.TOUCH_END, event => {// this.playSelectAnim(event.target);
          }, this);
        }
...
//# sourceMappingURL=53ed87f0ef8a69a903c343fdca89f65f3e595878.js.map