  ...
  return {
    ...
    execute: function () {
      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onOutCard() {
          console.log("onOutCard_____________________0", (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().outCardList);
          let myHand = this.nodeCardView.getComponent(_crd && MyPlayerCard === void 0 ? (_reportPossibleCrUseOfMyPlayerCard({
            error: Error()
          }), MyPlayerCard) : MyPlayerCard);
          ...
          console.log("onOutCard_____________________1", (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().outCardList);
          ...
          console.log("onOutCard_____________________2", (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().outCardList);
        ...
        onChiCard() {
          ...
          console.log("onChiCard_____________________", (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().outCardList); // myHand.updateHandPositionAndName();
        }
...
//# sourceMappingURL=5cd240b9e16e15352bfd070126907a0d61f86cfb.js.map