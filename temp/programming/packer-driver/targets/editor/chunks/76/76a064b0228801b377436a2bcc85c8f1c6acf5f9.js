  ...
  return {
    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        onTouchMove(event) {
          this._isTouched = true;
          let location = event.getDelta(); // Vec3.add(this.movePosition,this.startPosition,new Vec3(location.x,location.y,0));
...
//# sourceMappingURL=76a064b0228801b377436a2bcc85c8f1c6acf5f9.js.map