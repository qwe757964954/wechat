System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Button, Node, Sprite, _decorator, GCache, AppEvent, GConstants, GameTxt, resLoader, EventManager, Utils, BaseComponent, Platform, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, menu, bankupGift;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      resLoader = _unresolved_6.resLoader;
      ...
      _export("bankupGift", bankupGift = (_dec = ccclass('bankupGift'), _dec2 = menu('bankupGift'), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = _dec2(_class = (_class2 = class bankupGift extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        onInitModuleEvent() {
          ...
          this.addModelListener((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
            error: Error()
          }), AppEvent) : AppEvent).NET_RESP_BANKRUPT_GIFT_CONF, this.respBankUpGiftConf); //领取补助结果返回
...
//# sourceMappingURL=a3812d39986f4bcfb6cae6b6e4048ff6d6629492.js.map