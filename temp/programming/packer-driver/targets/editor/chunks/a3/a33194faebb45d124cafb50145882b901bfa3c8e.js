    ...
    execute: function () {
      ...
      _export("GoodsDataServers", GoodsDataServers = class GoodsDataServers extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        resqGoodsInfo(event, isSuccess, respData, reqData) {
          ...
          let sceneData = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        respBuyMallProp(event, isSuccess, respData, reqData) {
          ...
          if (isSuccess && respData['flag'] >= 0) {
            let flag = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).number_valueOf(respData["flag"]);

            let _data = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
        ...
        reqWillPay(event, goodID, gid, callback = null) {
          ...
          let payAgent = new (_crd && PayAgent === void 0 ? (_reportPossibleCrUseOfPayAgent({
            error: Error()
        ...
        otherShareFriend(event, shareResult) {
          if (shareResult) {
            // 获取邀请好友奖励配置
            let shareId = 0;
            let friendShareMsg = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            ...
            if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              ...
              if (friendShareMsg && friendShareMsg[0]['share_id']) shareId = friendShareMsg[0]['share_id'];
              (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                error: Error()
              }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
                error: Error()
...
//# sourceMappingURL=a33194faebb45d124cafb50145882b901bfa3c8e.js.map