  ...
  return {
    ...
    execute: function () {
      ...
      _export("TaskInfo", TaskInfo = class TaskInfo extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        /** 活动数据 */
        get atyData() {
          let atyList = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        get NoticeData() {
          let noticeList = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        checkUserReceiveInToByDesk() {
          ...
          for (let index = 0; index < this.atyData.length; index++) {
            ...
            if (item['is_jump']) {
              ...
              let mallScene = _jumpData['tag'] || 0; // 存 删 查 key
              ...
              if (_jumpCmd == (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                ...
                if ((_crd && Platform === void 0 ? (_reportPossibleCrUseOfPlatform({
                  ...
                  let referrerInfo = (_crd && Platform === void 0 ? (_reportPossibleCrUseOfPlatform({
                    error: Error()
                  ...
                  if (Number(referrerInfo['scene']) == (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                    ...
                    let startTime = new (_crd && CountTime === void 0 ? (_reportPossibleCrUseOfCountTime({
                      error: Error()
                    }), CountTime) : CountTime)();
                    ...
                    if (this._allowShareTime - (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                      ...
                      (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
                        error: Error()
                      }), LocalStorage) : LocalStorage).remove(key);
                      startTime.Stop(); // 关闭计时
                    }

                    let _uid = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
                      error: Error()
                  ...
                  if (!_uid) {
                    ...
                    let key_uid = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                      error: Error()
                    }), Utils) : Utils).string_format((_crd && StoreKey === void 0 ? (_reportPossibleCrUseOfStoreKey({
                      error: Error()
                    }), StoreKey) : StoreKey).USER_REWARD_BY_DESK, this.__User.getUserMid());
                    (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
                      error: Error()
                    }), LocalStorage) : LocalStorage).set(key_uid, this.__User.getUserMid()); // 缓存第一次领奖成功的uid
...
//# sourceMappingURL=72aded8481bf8301971f800e9f15bf1f6c57faa0.js.map