    ...
    execute: function () {
      ...
      _export("NodeOutCardCtr", NodeOutCardCtr = (_dec = ccclass('NodeOutCardCtr'), _dec2 = property({
        ...
        initView() {
          ...
          let indexStart = (width * 6 + (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          ...
          for (let dir = 0; dir < 4; dir++) {
            ...
            for (let i = 0; i < 18; i++) {
              ...
              let leftToRight = -indexStart + index * (width + (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
            ...
            for (let i = 0; i < 9; i++) {
              ...
              let leftToRight = -indexStart + 6 * width + 1 + index * (width + (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
                error: Error()
              }), GameViewConfig) : GameViewConfig).CardConfig.SpaceOutCard); // 指定层的第index张牌的位置
...
//# sourceMappingURL=282eb8dd8b8778ab1b477553bb2e9fa5a67467c4.js.map