    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        func(node) {
          ...
          let trackDraw = new animation.VectorTrack();
          trackDraw.componentsCount = 3;
          trackDraw.path = new animation.TrackPath().toProperty("rotation"); // let [drawX] = trackDraw.channels();
...
//# sourceMappingURL=10a86db945d0549409facf0d710ea5fb5ea06ae9.js.map