    ...
    execute: function () {
      ...
      _export("PictureTabDialogComponent", PictureTabDialogComponent = (_dec = ccclass('PictureTabDialogComponent'), _dec2 = property({
            ...
            for (let i = 0; i < resConf.length; i++) {
              ...
              for (let j = 0; j < oneResConf.tab.length; j++) {
                ...
                (_crd && resLoader === void 0 ? (_reportPossibleCrUseOfresLoader({
                  ...
                  self._curResNum.get(type).push(imageAsset);
        ...
        updateView() {
          ...
          if (this._curResNum.get(this._dialogType).length != this._curMaxResNum.get(this._dialogType)) {
...
//# sourceMappingURL=39dfe53017d328382cf79a60c62e0ee9b0165d81.js.map