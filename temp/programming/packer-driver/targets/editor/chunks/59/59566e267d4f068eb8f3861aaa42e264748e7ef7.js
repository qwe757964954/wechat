      ...
      _export("getPopPrefabCtr", getPopPrefabCtr = (_dec = ccclass('getPopPrefabCtr'), _dec2 = menu('prefab/activity/getPopPrefabCtr'), _dec3 = property({
        ...
        showItem() {
          ...
          for (let j = 0; j < this.awardData.length; j++) {
            ...
            let name = data['name'];
            let str = "";
            let numStr = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).string_moneyToShortNumber(num);
...
//# sourceMappingURL=59566e267d4f068eb8f3861aaa42e264748e7ef7.js.map