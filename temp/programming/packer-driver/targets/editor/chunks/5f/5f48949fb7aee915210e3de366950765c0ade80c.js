System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Sprite, SpriteAtlas, _decorator, resLoader, Utils, BaseComponent, PlayerMgr, OPCode, FXJRes, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, OprationItem;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Sprite', 'SpriteAtlas', '_decorator']);
      ...
      _export("OprationItem", OprationItem = (_dec = ccclass('OprationItem'), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec(_class = (_class2 = class OprationItem extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        updateAtlasCodeMap() {
          ...
          this.atlasCodeMap.set((_crd && OPCode === void 0 ? (_reportPossibleCrUseOfOPCode({
            error: Error()
          }), OPCode) : OPCode).OPE_RIGHT_CHI, "hu");
          this.atlasCodeMap.set((_crd && OPCode === void 0 ? (_reportPossibleCrUseOfOPCode({
            error: Error()
          }), OPCode) : OPCode).OPE_MIDDLE_CHI, "hu");
          this.atlasCodeMap.set((_crd && OPCode === void 0 ? (_reportPossibleCrUseOfOPCode({
            error: Error()
          }), OPCode) : OPCode).OPE_LEFT_CHI, "hu");
          this.atlasCodeMap.set((_crd && OPCode === void 0 ? (_reportPossibleCrUseOfOPCode({
            error: Error()
        ...
        updateItemProps(userId, opCode) {
          let userInfo = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
...
//# sourceMappingURL=5f48949fb7aee915210e3de366950765c0ade80c.js.map