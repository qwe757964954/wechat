System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, GCache, AppEvent, GConstants, UIID, Utils, EventManager, BaseControll, GlobalCMD, PopupServers, RecommendPopServers, _crd;
    ...
    execute: function () {
      ...
      _export("RecommendPopServers", RecommendPopServers = class RecommendPopServers extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        */
        ...
        setCloseAllFunc(event = null, callback) {
        ...
        getDelayRecommend() {
          this.reqPopAdvByPos(this._currowPosID);
          this._delayPosID = null;
        }
         ...
         * @param params 附加参数
         */
        reqPopAdvByPos(popupPos, params = null) {
        ...
        getRecommend(event = null, id, data = null, isDelay = false) {
          if (id == null) {
            return;
          }
        ...
        getRecommendAllPopData(event = null, data) {
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          ...
          let popupPos = this._currowPosID; // 当前主场景

          let _cur_pos = (_crd && PopupServers === void 0 ? (_reportPossibleCrUseOfPopupServers({
            error: Error()
          }), PopupServers) : PopupServers).getInstance().MainLayerCode;
        ...
        checkRecommendPopup(pData) {
          if (pData && pData instanceof Array && pData.length > 0) {
                  ...
                  for (let m = 0; m < alrCheckInfo.length; m++) {
                    if (this.PopupID_UIIDMap[alrCheckInfo[m]["toolid"]]) {
                      if (this.PopupID_UIIDMap[alrCheckInfo[m]["toolid"]].ckFunc && this[this.PopupID_UIIDMap[alrCheckInfo[m]["toolid"]].ckFunc] != null) {
                        ...
                        this[this.PopupID_UIIDMap[alrCheckInfo[m]["toolid"]].ckFunc](alrCheckInfo[m]); //满足了一个数据变动 就就终止
            ...
            this.showRecommendPopup(this._curCheckPosData ? this._curCheckPosData["allCloseCallFunc"] : null);
          } else {
            //关闭正在加载中
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
        ...
        showRecommendPopup(callback) {
          ...
          if (this._popUpResult && this._popUpResult.length > 0) {
            ...
            if (this._noResultTip) {
              (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                error: Error()
              }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
                error: Error()
              }), AppEvent) : AppEvent).SYS_TOAST_TIP, {
                content: this._noResultTip
              });
            }
        ...
        openViewQuene(event = null, finishCallback) {
          if (this._popUIDQueue.length <= 0) {
          ...
          let curMainLayer = (_crd && PopupServers === void 0 ? (_reportPossibleCrUseOfPopupServers({
            error: Error()
          }), PopupServers) : PopupServers).getInstance().MainLayerCode;
          let info = null;
        ...
        checkSignin(info) {
          let isShow = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        checkHoliday(info) {
          let isShow = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).RedDot.has_reddot_holiday();
        ...
        checkFirstPay(info) {
          let isShow = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).RedDot.has_reddot_firstPay();
...
//# sourceMappingURL=23498caf20c05923544c1e787f387efd984cd75a.js.map