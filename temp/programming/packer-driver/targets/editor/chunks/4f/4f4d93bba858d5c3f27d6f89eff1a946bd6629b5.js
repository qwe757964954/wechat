System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Color, instantiate, Label, Layout, Node, Prefab, ScrollView, Sprite, SpriteAtlas, Vec3, _decorator, resLoader, EventManager, Utils, BaseComponent, PlayerMgr, SettleMgr, FXJEvent, FXJRes, FXJUIID, GameEvent, Card, BottomItem, FanItem, List, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _crd, ccclass, property, TitleColor, Gender, VictoryStatus, settle;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      BottomItem = _unresolved_12.BottomItem;
    }, function (_unresolved_13) {
      FanItem = _unresolved_13.FanItem;
    ...
    execute: function () {
      ...
      __checkObsolete__(['Color', 'instantiate', 'Label', 'Layout', 'Node', 'Prefab', 'ScrollView', 'Sprite', 'SpriteAtlas', 'Vec3', '_decorator']);
      ...
      _export("settle", settle = (_dec = ccclass('settle'), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(Sprite), _dec7 = property(ScrollView), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Label), _dec11 = property(Layout), _dec12 = property(Prefab), _dec13 = property(Node), _dec14 = property(_crd && List === void 0 ? (_reportPossibleCrUseOfList({
        ...
        onLoad() {
          ...
          let fanExtendInfos = (_crd && SettleMgr === void 0 ? (_reportPossibleCrUseOfSettleMgr({
            error: Error()
          }), SettleMgr) : SettleMgr).getInstance().filterFanExtendInfo();
          this.moneyScroll.numItems = fanExtendInfos.length;
          let opponentInfos = (_crd && SettleMgr === void 0 ? (_reportPossibleCrUseOfSettleMgr({
            error: Error()
        ...
        onListMoneyVRender(item, idx) {
          ...
          let fanExtendInfo = fanExtendInfos[idx];
        ...
        updateSettleInfo() {
          let myInfo = (_crd && SettleMgr === void 0 ? (_reportPossibleCrUseOfSettleMgr({
            error: Error()
          }), SettleMgr) : SettleMgr).getInstance().getMyTotalInfo();
          let fanData = (_crd && SettleMgr === void 0 ? (_reportPossibleCrUseOfSettleMgr({
            error: Error()
          ...
          let colorStr = myInfo.bWin !== -1 ? TitleColor.Win : TitleColor.Fail;
          let normalColor = new Color(colorStr);
          this.tittle_str.color = normalColor;
          let bgStr = myInfo.bWin !== -1 ? "win_bg" : "failure_bg";
          let leftStr = myInfo.bWin !== -1 ? "settle_win" : "settle_failure";
          let titleStr = myInfo.bWin !== -1 ? "win_title_bg" : "fail_title_bg";
          let forward = myInfo.bWin !== -1 ? "+" : "";
          let moneyAtlas = myInfo.bWin !== -1 ? (_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            error: Error()
          }), FXJRes) : FXJRes).Prefab_Settle_Win : (_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            error: Error()
          }), FXJRes) : FXJRes).Prefab_Settle_Fail;
          let huAtlas = myInfo.bWin !== -1 ? (_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            error: Error()
          }), FXJRes) : FXJRes).Prefab_Settle_Hu_Win : (_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            error: Error()
          }), FXJRes) : FXJRes).Prefab_Settle_Hu_Fail;
          let frameBg = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          ...
          let frameLeft = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_format((_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            error: Error()
          }), FXJRes) : FXJRes).Prefab_Settle_Image.plistKey, leftStr);
          let frameTitle = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).string_format((_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            error: Error()
          }), FXJRes) : FXJRes).Prefab_Settle_Image.plistKey, titleStr); // playerSprite
          ...
          let moneyStr = `${forward}${myInfo.winMoney}`;
        ...
        updatePlayerStatus() {
          ...
          let gameUserInfo = JSON.parse(myInfo.strUserInfo);
          let playerAtlas = gameUserInfo.sex !== 2 ? (_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            error: Error()
          }), FXJRes) : FXJRes).Prefab_Settle_Xiapbo : (_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            error: Error()
          ...
          let playerFrame = `${playerName}${playerStatus}`;
          (_crd && resLoader === void 0 ? (_reportPossibleCrUseOfresLoader({
            error: Error()
        ...
        updateMyselfCards() {
          let array = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
          }), PlayerMgr) : PlayerMgr).getInstance().getMyhands();

          for (let i = 0; i < array.length; i++) {
            let cardValue = array[i];
        ...
        asyncForLoop() {
          let winPlayer = (_crd && SettleMgr === void 0 ? (_reportPossibleCrUseOfSettleMgr({
            error: Error()
          ...
          return new Promise(resolve => {
            ...
            for (let i = 0; i < array.length; i++) {
              let cardValue = winPlayer.handCards[i];
              let node = instantiate(this.card_Prefab);
              node.getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
                error: Error()
              }), Card) : Card).setCardByte(cardValue);
        ...
        createNumSprImg(parent, plist, keyList, dianPosY = 0) {
          ...
          this.getPreLoaderRes(plist.bundle, plist.path, SpriteAtlas, atlas => {
            keyList.forEach((key, index) => {
              ...
              if (spriteFrame) {
                let sprNode = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  error: Error()
...
//# sourceMappingURL=4f4d93bba858d5c3f27d6f89eff1a946bd6629b5.js.map