System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      FXJUIID.GameAiPrefab = (_crd && GetUIID === void 0 ? (_reportPossibleCrUseOfGetUIID({
        error: Error()
      }), GetUIID) : GetUIID)();
      ...
      _export("FXJRes", FXJRes = {
        ...
        Prefab_Settle_Xiapbo: {
          bundle: (_crd && GamePackage === void 0 ? (_reportPossibleCrUseOfGamePackage({
            error: Error()
          }), GamePackage) : GamePackage).GAME,
          path: "module/settle/res/image/settle_xiaobo",
          plistKey: "{0}"
        },
        Prefab_Settle_Xiaoya: {
          bundle: (_crd && GamePackage === void 0 ? (_reportPossibleCrUseOfGamePackage({
            error: Error()
          }), GamePackage) : GamePackage).GAME,
          path: "module/settle/res/image/xiaoya",
          plistKey: "{0}"
        },
      ...
      _export("FXJUIConfig", FXJUIConfig = {
        ...
        //ai
        [FXJUIID.GameAiPrefab]: {
          layer: (_crd && inf_LayerType === void 0 ? (_reportPossibleCrUseOfinf_LayerType({
            error: Error()
          }), inf_LayerType) : inf_LayerType).PopUp,
          prefab: FXJRes.Prefab_Ai.path,
          bundle: FXJRes.Prefab_Ai.bundle
        }
      });
...
//# sourceMappingURL=4f298ae4ac46fc4b0ad880dd0980df95e39684d0.js.map