  ...
  return {
    ...
    execute: function () {
      ...
      _export("NodeWallCtr", NodeWallCtr = (_dec = ccclass('NodeWallCtr'), _dec2 = property({
        ...
        /** 初始化数据 */
        initData() {
          let cardTotalNum = (_crd && GameRuleConfig === void 0 ? (_reportPossibleCrUseOfGameRuleConfig({
            error: Error()
        ...
        initView() {
          ...
          let scale = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.ScaleWallCard;
          ...
          let groundHeight = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          ...
          let distance = (_crd && GameViewConfig === void 0 ? (_reportPossibleCrUseOfGameViewConfig({
            error: Error()
          }), GameViewConfig) : GameViewConfig).CardConfig.CenterToWallCard; // mark：待优化

          let indexWall = 0;

          for (let dir = 4 - 1; dir >= 0; dir--) {
            let size = this._numList[dir] / 2;
            let cardList = new Array(size);
        ...
        riseUp() {
          ...
          for (let i = 0; i < this._nodeDeskLiftList.length; i++) {
            ...
            let pos = node.getPosition();
            tween(node).to(1.6, {
              position: new Vec3(pos.x, pos.y + riseupHeight / 100, pos.z)
            }).start();
          }
...
//# sourceMappingURL=35ce5ae8e5d5bb67185bb008af9ee598ad6078d7.js.map