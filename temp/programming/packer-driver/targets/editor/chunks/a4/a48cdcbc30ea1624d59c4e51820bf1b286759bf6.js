System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, AudioPackage, GConstants, _crd, GamePackage, GameRes, GameResPreLoad;
  ...
  function _reportPossibleCrUseOfAudioPackage(extras) {
    _reporterNs.report("AudioPackage", "./AppSound", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameRes", GameRes = {
        ...
        //游戏规则弹框
        Prefab_GameRuleDialog: {
          bundle: GamePackage.HALL,
          path: "prefab/gameRuleDialogPrefab"
        },
        //个人信息界面
        ...
        Audio_HallBg: {
          bundle: GamePackage.HALL,
          path: "audio/Audio_Game_Back"
        },
        //按钮点击音效
        Audio_Button_Click: {
          bundle: GamePackage.DEFAULT,
          path: "audio/Audio_Button_Click"
        },
        ...
        [(_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
          ...
          audio: [{
            bundle: (_crd && AudioPackage === void 0 ? (_reportPossibleCrUseOfAudioPackage({
              error: Error()
            }), AudioPackage) : AudioPackage).COMMON,
            path: ""
          }]
        },
...
//# sourceMappingURL=a48cdcbc30ea1624d59c4e51820bf1b286759bf6.js.map