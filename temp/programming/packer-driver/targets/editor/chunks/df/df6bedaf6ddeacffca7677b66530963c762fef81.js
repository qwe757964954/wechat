    ...
    execute: function () {
      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        receiveDealCard(event) {
          console.log("receiveDealCard___________________________");
          let myHand = this.nodeCardView.getComponent(_crd && MyPlayerCard === void 0 ? (_reportPossibleCrUseOfMyPlayerCard({
            error: Error()
          }), MyPlayerCard) : MyPlayerCard);
          myHand.node.active = true;
        ...
        onChiCard() {
          ...
          const filterArray = (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          ...
          (_crd && MajiangUtil === void 0 ? (_reportPossibleCrUseOfMajiangUtil({
            ...
            error: Error()
          }), PlayerMgr) : PlayerMgr).getInstance().getMyhands(), filterArray);
          myHand.stackAnim(indexs); // myHand.updateHandPositionAndName();
        }
...
//# sourceMappingURL=df6bedaf6ddeacffca7677b66530963c762fef81.js.map