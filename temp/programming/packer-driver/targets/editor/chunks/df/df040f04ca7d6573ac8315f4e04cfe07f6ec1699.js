System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['math', 'Node', 'UITransform', '_decorator']);
      ...
      _export("Card", Card = (_dec = ccclass('Card'), _dec2 = property(UITransform), _dec3 = property({
        ...
        setCardAngle(x, y, z) {
          let quat = this.nodeCardTemplate.getChildByName("majiangzi").getRotation();
          this.nodeCardTemplate.getChildByName("majiangzi").setRotation(x, y, z, quat.w);
        }
...
//# sourceMappingURL=df040f04ca7d6573ac8315f4e04cfe07f6ec1699.js.map