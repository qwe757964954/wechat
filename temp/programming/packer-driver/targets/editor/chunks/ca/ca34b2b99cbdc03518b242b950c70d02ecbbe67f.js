    ...
    execute: function () {
      ...
      _export("ActivityController", ActivityController = class ActivityController extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        onInitModuleEvent() {
          ...
          this.addModelListener((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
            error: Error()
          }), AppEvent) : AppEvent).NET_REQ_BANKRUPT_CONFIG, this.reqBankUpData); //返回获取破产线、破产次数
        ...
        reqBankUpGiftConf(event = null, gameID = null, levelID = null) {
        ...
        respBankUpGiftConf(event, isSuccess, respData, reqData) {
          ...
          if (isTrueData && (_crd && GameRoomHelper === void 0 ? (_reportPossibleCrUseOfGameRoomHelper({
            ...
            let toData = (_crd && GameRoomHelper === void 0 ? (_reportPossibleCrUseOfGameRoomHelper({
              error: Error()
            }), GameRoomHelper) : GameRoomHelper).checkShowBankruptParam;
        ...
        reqBankUpData(event = null) {
          this.dump("请求破产线、破产次数==>");
          let sendMsg = {
        ...
        respBankUpData(event = null, respData = null) {
          this.dump(respData, "广播:破产线、破产次数返回==>");
        ...
        reqBankUpCount(event = null, hasShard = 0) {
        ...
        respBankUpCount(event = null, respData = null) {
          this.dump(respData, "广播:破产次数==>");
          ...
          if (respData) {
            ...
            let isPayUser = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            ...
            this.reqBankUpToast(null, (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            }), GCache) : GCache).BankrupData.curBankruptCount); //通知到大厅 自动领取破产救济金

            this.print("通知到大厅 自动领取破产救济金===>");
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).dispatch((_crd && AppEvent === void 0 ? (_reportPossibleCrUseOfAppEvent({
              error: Error()
            }), AppEvent) : AppEvent).HALL_RECEIVE_BANKRUP_MONEY);
          }
        }
        /** 请求破产文案 */


        reqBankUpToast(event = null, num = null) {
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        reqBankUpMoney(event = null, param = null) {
          this.print("领取破产救济金===>");
        ...
        respBankUpMoney(event = null, respData = null) {
          this.dump(respData, "广播:领取破产救济金返回==>");
          ...
          if (respData) {
            ...
            let content = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            }), GCache) : GCache).BankrupData.bankToast;
            ...
            if (isSuccess && packetInfo.brokeMoney > 0) {
              ...
              let money = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                error: Error()
        ...
        respSignContinusAward(event, isSuccess, respData, reqData) {
          ...
          if (isSuccess) {
            ...
            let day = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
...
//# sourceMappingURL=ca34b2b99cbdc03518b242b950c70d02ecbbe67f.js.map