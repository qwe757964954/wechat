System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, Layout, Node, Prefab, sp, _decorator, resLoader, EventManager, Utils, BaseComponent, OperationMgr, RoomMgr, GameStatus, OPCode, FXJRes, GameEvent, Card, Carditem, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, OpInfo;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['instantiate', 'Layout', 'Node', 'Prefab', 'sp', '_decorator']);
      ...
      _export("OpInfo", OpInfo = (_dec = ccclass('OpInfo'), _dec2 = property(Node), _dec3 = property(Layout), _dec4 = property(Layout), _dec5 = property(Layout), _dec6 = property(Layout), _dec7 = property(Layout), _dec8 = property(Layout), _dec9 = property(Layout), _dec10 = property({
        ...
        updateOpration(resp) {
          ...
          resp.opGroups.forEach(opInfo => {
            ...
            if (layout instanceof Layout) {
              ...
              let opNode = layout.node.getChildByName("op");
        ...
        changeSkin(opcode, skel) {
          (_crd && resLoader === void 0 ? (_reportPossibleCrUseOfresLoader({
            ...
            error: Error()
          }), FXJRes) : FXJRes).Spine_op.bundle, (_crd && FXJRes === void 0 ? (_reportPossibleCrUseOfFXJRes({
            error: Error()
          }), FXJRes) : FXJRes).Spine_op.path, sp.SkeletonData, (err, spineAsset) => {
            if (err) {
            ...
            skel.skeletonData = spineAsset;
            let ani = skel.setAnimation(0, this.btnSkelMap.get(opcode), true);
...
//# sourceMappingURL=1581efdb5af38b60864a01de9521a559c34ec2d8.js.map