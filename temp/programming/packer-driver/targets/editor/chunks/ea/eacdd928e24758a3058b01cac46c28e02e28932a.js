System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Color, Label, Sprite, SpriteAtlas, _decorator, Utils, SettleMgr, FXJRes, ListItem, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, WinItemColor, FailItemColor, FanItem;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SettleMgr = _unresolved_3.SettleMgr;
    }, function (_unresolved_4) {
      FXJRes = _unresolved_4.FXJRes;
    }, function (_unresolved_5) {
      ListItem = _unresolved_5.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("FanItem", FanItem = (_dec = ccclass('ListItem'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class FanItem extends (_crd && ListItem === void 0 ? (_reportPossibleCrUseOfListItem({
        ...
        updateItemProps(index, data) {
          let totalStr = data.totalFanStr ? data.totalFanStr : "0";
          this.multiple_num.string = totalStr + "番";
          this.up_down.string = `[${data.seatStr}]`;
          let fanList = data.fanInfo;
          let fanStr = "";

          for (let i = 0; i < fanList.length; i++) {
            const num = parseInt(fanList[i].fan);
            let fanName = fanList[i].fanName;
        ...
        setListBgColor(data) {
          ...
          let prefixStr = myInfo.bWin !== -1 ? "win_" : "fail_";
          let listStr = data.totalFan > 0 ? "list2" : "list1";
          let bgStr = `${prefixStr}${listStr}`;
          ...
          let colorItem = myInfo.bWin !== -1 ? WinItemColor : FailItemColor;
          let colorStr = data.totalFan > 0 ? colorItem.Win : colorItem.Fail;
...
//# sourceMappingURL=eacdd928e24758a3058b01cac46c28e02e28932a.js.map