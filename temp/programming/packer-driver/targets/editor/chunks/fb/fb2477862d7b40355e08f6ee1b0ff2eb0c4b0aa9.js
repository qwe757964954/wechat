System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, ImageAsset, Node, Sprite, Toggle, _decorator, instantiate, GCache, AppEvent, AppSound, GameRes, Utils, resLoader, EventManager, BaseComponent, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, PictureTabDialogComponent;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['ImageAsset', 'Node', 'Sprite', 'SpriteFrame', 'Toggle', '_decorator', 'instantiate']);
      ...
      _export("PictureTabDialogComponent", PictureTabDialogComponent = (_dec = ccclass('PictureTabDialogComponent'), _dec2 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "menuListNode", _descriptor4, this);

          _initializerDefineProperty(this, "menuTemplate", _descriptor5, this);

          _initializerDefineProperty(this, "nodeNoTips", _descriptor6, this);
          ...
          if (this.menuListNode.children.length <= 1) {
            for (let i = 0; i < resLoad.size; i++) {
              ...
              if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                ...
                let checkmark = menuNode.getChildByName("Checkmark");
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "menuListNode", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "menuTemplate", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "nodeNoTips", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=fb2477862d7b40355e08f6ee1b0ff2eb0c4b0aa9.js.map