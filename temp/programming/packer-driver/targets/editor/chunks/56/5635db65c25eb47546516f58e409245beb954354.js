    ...
    execute: function () {
      ...
      _export("ShareInfo", ShareInfo = class ShareInfo extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        shareTimeAllowed(gid, shareType) {
          ...
          let coolDownTime = shopShareMsg[0]['cool_down_type'] ? shopShareMsg[0]['cool_down_time'] * 60 : 0; //当前物品 距离上次分享的时间
...
//# sourceMappingURL=5635db65c25eb47546516f58e409245beb954354.js.map