        ...
        onOutCard() {
          ...
          if (this.isChiInRange((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            ...
            (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
              error: Error()
            }), PlayerMgr) : PlayerMgr).getInstance().updateMyhands((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
              error: Error()
            }), OperationMgr) : OperationMgr).getInstance().outCardList);
            (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
              error: Error()
...
//# sourceMappingURL=6327568fe824290f8a448a4dfbd06a86f423f0b4.js.map