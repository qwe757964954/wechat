    ...
    execute: function () {
      ...
      _export("FXJController", FXJController = class FXJController extends (_crd && RoomController === void 0 ? (_reportPossibleCrUseOfRoomController({
        ...
        onNextGameOperation(event = null) {
          let roomInfo = (_crd && RoomMgr === void 0 ? (_reportPossibleCrUseOfRoomMgr({
            error: Error()
        ...
        receiveExitRoomSuccess(event = null, respData = null) {
          ...
          if (respData) {
            ...
            if (msg && msg['from'] && msg['to']) {
              ...
              if (fromUid > 0 && toUid > 0 && index > 0) {
                let minPorpID = (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
                  error: Error()
                }), FXJConstant) : FXJConstant).EmojiProp[0].propID;
                let maxPorpID = (_crd && FXJConstant === void 0 ? (_reportPossibleCrUseOfFXJConstant({
                  error: Error()
...
//# sourceMappingURL=9a15591103a20b7df16d6d56ea38c675904dd2ba.js.map