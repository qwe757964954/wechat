System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ListItem = _unresolved_7.default;
    }, function (_unresolved_8) {
      NodeHead = _unresolved_8.NodeHead;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("BottomItem", BottomItem = (_dec = ccclass('BottomItem'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Sprite), _dec7 = property(Node), _dec(_class = (_class2 = class BottomItem extends (_crd && ListItem === void 0 ? (_reportPossibleCrUseOfListItem({
        ...
        updateItemProps(info) {
          let gameUserInfo = JSON.parse(info.strUserInfo);
          let nodeHeadCtr = this.node_head.getComponent(_crd && NodeHead === void 0 ? (_reportPossibleCrUseOfNodeHead({
            error: Error()
          }), NodeHead) : NodeHead);
          ...
          const colorStr = info.bWin === -1 ? losingColor : winningColor;
          let normalColor = new Color(colorStr);
          this.money.color = normalColor;
          let bgStr = info.bWin === -1 ? "player_fail_bg" : "player_win_bg";
...
//# sourceMappingURL=9a988764426cba163a3664b4b1573e309d397ca6.js.map