      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onPengGangCard() {
          ...
          (_crd && MajiangUtil === void 0 ? (_reportPossibleCrUseOfMajiangUtil({
            ...
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCards); // myHand.updateHandPositionAndName();
        }
...
//# sourceMappingURL=368ed1d1c4dceb903c5ea7978d3a4663ccc2400c.js.map