    ...
    execute: function () {
      ...
      _export("Carditem", Carditem = (_dec = ccclass('Carditem'), _dec2 = property({
        ...
        updateCardItemProp(opTypes) {
          ...
          let transform = this.node.getComponent(UITransform); // transform.height = Math.round(rowNum / 2) * 100;
...
//# sourceMappingURL=36bea89208a08043977db3ca52f8100741d9276d.js.map