System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Button, ImageAsset, Node, ScrollView, Sprite, _decorator, GCache, AppEvent, AppSound, StoreKey, GameRes, resLoader, LocalStorage, EventManager, Utils, BaseComponent, Platform, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _crd, ccclass, property, UserAgreePrivateCtr;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Button', 'ImageAsset', 'Node', 'ScrollView', 'Sprite', 'SpriteFrame', '_decorator']);
      ...
      _export("UserAgreePrivateCtr", UserAgreePrivateCtr = (_dec = ccclass('UserAgreePrivateCtr'), _dec2 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "scrollContent", _descriptor4, this);

          _initializerDefineProperty(this, "scrollowBarNode", _descriptor5, this);

          _initializerDefineProperty(this, "menuUserAgree", _descriptor6, this);

          _initializerDefineProperty(this, "menuPrivatePro", _descriptor7, this);

          _initializerDefineProperty(this, "nodeTwoBtn", _descriptor8, this);

          _initializerDefineProperty(this, "nodeOneBtn", _descriptor9, this);

          _initializerDefineProperty(this, "nodeNoTips", _descriptor10, this);

          _initializerDefineProperty(this, "nodeTab", _descriptor11, this);
        ...
        preLoad() {
          ...
          for (let i = 0; i < (_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
            error: Error()
          }), GameRes) : GameRes).Picture_UserPrivacyPolicy.length; i++) {
            let oneResConf = (_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
              error: Error()
          ...
          for (let i = 0; i < (_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
            error: Error()
          }), GameRes) : GameRes).Picture_UserAgree.length; i++) {
            let oneResConf = (_crd && GameRes === void 0 ? (_reportPossibleCrUseOfGameRes({
              error: Error()
            }), GameRes) : GameRes).Picture_UserAgree[i];
            (_crd && resLoader === void 0 ? (_reportPossibleCrUseOfresLoader({
              error: Error()
            }), resLoader) : resLoader).load(oneResConf.bundle, oneResConf.path, ImageAsset, (err, imageAsset) => {
        ...
        onLoad() {
          ...
          if (comp) {
            let params = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
        ...
        updateView() {
          let isAgree = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
            error: Error()
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "scrollowBarNode", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "menuUserAgree", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "menuPrivatePro", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "nodeTwoBtn", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "nodeOneBtn", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "nodeNoTips", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "nodeTab", [_dec12], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=a8901cfb0d81431b23180d5dfdf8a74fd6d5944d.js.map