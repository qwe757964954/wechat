    ...
    execute: function () {
      ...
      _GameRoomHelper = class _GameRoomHelper extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        getBankruptGifts(gameId, levelID) {
          ...
          let newBankUpGiftData = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
            ...
            for (let i in newBankUpGiftData["levelids"]) {
              if (Object.prototype.hasOwnProperty.call(newBankUpGiftData["levelids"], i)) {
                ...
                if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  ...
                  error: Error()
                }), Utils) : Utils).nullToDefault(v, -1)) == true) {
                  isExit = true;
                }
              }
            }
        ...
        checkShowBankruptView(gameID, levelID, moneyID, status = null, time = null) {
          ...
          if ((_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            ...
            let needMoney = 3000;
            let info = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
        ...
        checkBankruptFeedBackRedDot() {
          let bankruptFeedBackData = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          if (bankruptFeedBackData["stallData"]) {
            ...
            for (let i in bankruptFeedBackData["stallData"]) {
              if (Object.prototype.hasOwnProperty.call(bankruptFeedBackData["stallData"], i)) {
                ...
                if (value["state"] == 1) {
                  //已购买
                  let goods = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                    error: Error()
        ...
        checkIsBankruptAfterGameOver() {
          let state = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).BankrupData.isMineBankrupt();
        ...
        checkIsLevelUp(isByLoginMoney = false) {
          let kickStatus = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          let flag = false;
          let roomUpLevelInfo = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        _handleLevelDown(newLevelId) {
          ...
          let curGameId = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).Desk.getCurGameID();
          let curLevelId = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).Desk.getCurLevelID();
          let minLoginMoney = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          let userMoney = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).Desk.mySelfPlayer.money;
          let diff = minLoginMoney - userMoney; // let data = {
          // 	gameid : curGameId,
          // 	level :curLevelId,
          // 	newLevel : level,
...
//# sourceMappingURL=93972245029dd15efc9148907317d83b5780555f.js.map