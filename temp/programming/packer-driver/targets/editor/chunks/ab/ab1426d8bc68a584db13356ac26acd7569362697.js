    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        onTouchEnd(event) {
          ...
          const distance = endPos.subtract(this.touchNodePos).length();

          if (distance > this.thresholdDistance && (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
...
//# sourceMappingURL=ab1426d8bc68a584db13356ac26acd7569362697.js.map