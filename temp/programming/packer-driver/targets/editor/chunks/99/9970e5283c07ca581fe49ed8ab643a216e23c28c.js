    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cardAddTouchEvent(handNode) {
          ...
          handNode.off(Node.EventType.MOUSE_MOVE);
          handNode.off(Node.EventType.MOUSE_UP); // handNode.on(Node.EventType.TOUCH_END, (event) => {
          ...
          handNode.on(Node.EventType.MOUSE_UP, event => {
            console.log(event); // this.playSelectAnim(event.target);
          }, this);
        } //将抓上来的牌打出去
...
//# sourceMappingURL=9970e5283c07ca581fe49ed8ab643a216e23c28c.js.map