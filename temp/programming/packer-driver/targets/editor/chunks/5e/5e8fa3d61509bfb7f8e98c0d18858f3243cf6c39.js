    ...
    execute: function () {
      ...
      _export("GUI", GUI = (_dec = ccclass('GUI'), _dec2 = property({
        ...
        adaptiveDesignResolution() {
          //设计分辨率
          let dr = (_crd && SystemConf === void 0 ? (_reportPossibleCrUseOfSystemConf({
            error: Error()
        ...
        adaptiveSize() {
          ...
          let realHeight = this._height * this._finalScaleY; // console.log(`初始宽高:${this._width}${this._height} 结果宽高: ${realWidth}${realHeight}`)
...
//# sourceMappingURL=5e8fa3d61509bfb7f8e98c0d18858f3243cf6c39.js.map