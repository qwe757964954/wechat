System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Layout, Node, _decorator, EventManager, Utils, BaseComponent, OperationMgr, RoomMgr, GameStatus, OPCode, GameEvent, Card, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, OpInfo;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("OpInfo", OpInfo = (_dec = ccclass('OpInfo'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Layout), _dec8 = property(Layout), _dec9 = property(Layout), _dec(_class = (_class2 = class OpInfo extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        error: Error()
        ...
        updateOpration(resp) {
          ...
          if (resp.opGroups && resp.opGroups.length === 1) {
            return;
          }
...
//# sourceMappingURL=a994f6e826c9924b2db162c83d378dd075860842.js.map