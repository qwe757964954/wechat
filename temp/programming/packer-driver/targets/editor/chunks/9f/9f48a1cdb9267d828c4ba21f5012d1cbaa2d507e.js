    ...
    execute: function () {
      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        drawMyCard(event) {
          ...
          console.log("onBuGangCard________________________", cardsList, (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
          }), CardUtil) : CardUtil).getMajiangValues(cardsList));
        ...
        onOutCard() {
          ...
          let opCards = (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCards;
          let opCard = (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCard;
          let indexs = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
          }), PlayerMgr) : PlayerMgr).getInstance().getOpIndexs(opCards);
          let removed = myHand.playCardFromHandAnim(indexs[0], indexs.length === 0);

          if (removed) {
            let insertIndex = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
              error: Error()
            }), PlayerMgr) : PlayerMgr).getInstance().getIndexByHandCards(myHand.drawByte, opCard);
            myHand.makeSlotAnim(insertIndex);
            myHand.drawCardToSlot();
          }

          if (!this.isChiInRange((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().myOpCode)) {
            (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
              error: Error()
            }), OperationMgr) : OperationMgr).getInstance().getMyHandCardResult(opCards);
          }
        ...
        onPengGangCard() {
          ...
          (_crd && MajiangUtil === void 0 ? (_reportPossibleCrUseOfMajiangUtil({
            ...
            error: Error()
          }), PlayerMgr) : PlayerMgr).getInstance().getMyhands(), opCards);
        ...
        onBuGangCard() {
          ...
          (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
          }), CardUtil) : CardUtil).getMajiangValues(opCards);
          let indexs = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
          }), PlayerMgr) : PlayerMgr).getInstance().getOpIndexs(opCards);
          let removed = myHand.playCardFromHandAnim(indexs[0], indexs.length === 0);
          ...
          (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().getMyHandCardResult(opCards); // MajiangUtil.deleteHasInList(PlayerMgr.getInstance().getMyhands(),opCards);

          console.log("onBuGangCard________________________", opCards, (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
          }), CardUtil) : CardUtil).getMajiangValues(opCards));
          (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
        ...
        onChiCard() {
          ...
          opCards = opCards.filter(item => item !== (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCard);
          (_crd && MajiangUtil === void 0 ? (_reportPossibleCrUseOfMajiangUtil({
            error: Error()
...
//# sourceMappingURL=9f48a1cdb9267d828c4ba21f5012d1cbaa2d507e.js.map