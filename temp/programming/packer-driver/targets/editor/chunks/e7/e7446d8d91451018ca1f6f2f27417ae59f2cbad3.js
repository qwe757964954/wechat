  ...
  return {
    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        foldAnimation() {
          let acDraw = new AnimationClip();
          acDraw.duration = 0.1; // let trackDraw = new animation.VectorTrack();
          // trackDraw.componentsCount = 3;
          // trackDraw.path = new animation.TrackPath().toProperty("RotateClip")
          // let [drawX] = trackDraw.channels();
...
//# sourceMappingURL=e7446d8d91451018ca1f6f2f27417ae59f2cbad3.js.map