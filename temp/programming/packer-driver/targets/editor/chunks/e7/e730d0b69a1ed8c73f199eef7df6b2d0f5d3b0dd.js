    ...
    execute: function () {
      ...
      _export("ShopInfo", ShopInfo = class ShopInfo extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        getGoodsTypeNameByScene(type) {
          ...
          if (type) {
            let sceneData = (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              error: Error()
        ...
        update(body) {
          ...
          let newBody = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        isExitFreeGoods(needDispatch = false) {
          let res = false;
          return res;
        }
        /** 购买分享看视频成功，刷新商品的信息 */
        ...
        _onGoodsBuySucc(gid, data) {
          ...
          if (goods) {
            ...
            if (goods["bought_num"] && data['finish_num']) {
        ...
        detailPrice(data) {
          for (let i = 0; i < data.length; i++) {
            ...
            for (let m = 0; m < value["pay"].length; m++) {
              let v = value["pay"][m]; //只有人民币的才需要除一百
        ...
        getSubTbs(_type) {
          if (_type && this._shopSubTab[_type]) {
            let temp = this._shopSubTab[_type];
            return temp;
          }
        }
        /**
...
//# sourceMappingURL=e730d0b69a1ed8c73f199eef7df6b2d0f5d3b0dd.js.map