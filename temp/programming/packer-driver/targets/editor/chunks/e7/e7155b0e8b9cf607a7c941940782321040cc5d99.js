    ...
    execute: function () {
      ...
      _export("GPBAdaptive", GPBAdaptive = class GPBAdaptive {
        ...
        generatPacket(cmd, body) {
          ...
          let phpSendCmd = (_crd && GCmdMapping === void 0 ? (_reportPossibleCrUseOfGCmdMapping({
            error: Error()
        ...
        isCompressByHeadCmd(headCmd = null) {
        ...
        getJsonTable(cmd) {
          ...
          let mid = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
...
//# sourceMappingURL=e7155b0e8b9cf607a7c941940782321040cc5d99.js.map