    ...
    execute: function () {
      ...
      _export("MessageServers", MessageServers = class MessageServers extends (_crd && BaseControll === void 0 ? (_reportPossibleCrUseOfBaseControll({
        ...
        reqMessageData(event) {
          //客户端存的最大的的邮箱ID
          let maxId = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
        ...
        respEmailAward(event, isSuccess, respData, reqData) {
          ...
          let awards = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
            error: Error()
            ...
            for (let i = 0; i < respData["awards"].length; i++) {
              if (awards[i]) {
                if (respData["awards"][i]["havegot"] == (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                  ...
                  let goodNum = Number(respData["awards"][i]["num"]); //领取成功，加银币加钱
...
//# sourceMappingURL=fd9568c41b3330fdca13e6d57ac4f9e02bfb07eb.js.map