      ...
      _export("SelectGame", SelectGame = class SelectGame extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        checkQuickGame(gameId, tabId = null) {
          ...
          if (minRoomData) {
            ...
            let min = minRoomData.min_money; //当前用户资产
            ...
            let isBankruptRewardBol = this.__User.BankrupData.isBankruptRewardRemain(); //破产
...
//# sourceMappingURL=32c21c73060c179bf70b9d31bb09810b48b120db.js.map