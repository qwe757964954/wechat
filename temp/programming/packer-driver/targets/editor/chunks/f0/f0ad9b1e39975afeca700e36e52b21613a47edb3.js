System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Node, UITransform, _decorator, BaseComponent, NodeCardCtr, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, NormalSize, Card;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Node', 'UITransform', '_decorator']);
      ...
      _export("Card", Card = (_dec = ccclass('Card'), _dec2 = property(UITransform), _dec3 = property({
        ...
        setCardSize(width, height) {
          let scale = width / NormalSize.Width * 1000;
          console.log("scale_________", scale);
          this.nodeCardTemplate.getChildByName("majiangzi").setScale(scale, scale, scale);
          this.cardTabTemplate.setScale(scale, scale, scale);
          this.nodeCardTemplate.getComponent(UITransform).width = width;
          this.nodeCardTemplate.getComponent(UITransform).height = height;
          this.card.width = width;
          this.card.height = height;
        }

        setCardAngle(x, y, z) {
          this.nodeCardTemplate.getChildByName("majiangzi").setRotation(x, y, z, 0);
        }
...
//# sourceMappingURL=f0ad9b1e39975afeca700e36e52b21613a47edb3.js.map