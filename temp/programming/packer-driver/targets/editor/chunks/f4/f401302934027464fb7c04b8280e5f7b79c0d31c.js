    ...
    execute: function () {
      ...
      _export("SelectGame", SelectGame = class SelectGame extends (_crd && BaseCache === void 0 ? (_reportPossibleCrUseOfBaseCache({
        ...
        willEnterGame(gameID = null, roomLevel = null) {
          ...
          if (roomLevel == 0) {
            //快速开始
            let roomList = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
        ...
        checkQuickGame(gameId, tabId = null) {
          ...
          let brokeLevel = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          if (!minRoomData) {
            let getBankruptRewardBol = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
...
//# sourceMappingURL=f401302934027464fb7c04b8280e5f7b79c0d31c.js.map