              ...
              if (item['is_jump']) {
                ...
                if (_jumpCmd == (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                  ...
                  if ((_crd && Platform === void 0 ? (_reportPossibleCrUseOfPlatform({
                    ...
                    let _uid = (_crd && LocalStorage === void 0 ? (_reportPossibleCrUseOfLocalStorage({
                      error: Error()
                    }), LocalStorage) : LocalStorage).get(key, 0);

                    console.log('_uid', 2503647, _uid, !_uid, this.__User.getUserMid()); // 不存在就去发奖
...
//# sourceMappingURL=71ffc94c3f21028aa26022ac13f10ec4c576b7cb.js.map