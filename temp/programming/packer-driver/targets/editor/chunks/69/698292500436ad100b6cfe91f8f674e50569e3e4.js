  ...
  return {
    ...
    execute: function () {
      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        onBuGangCard() {
          console.log("onBuGangCard________________________");
          let opCards = (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCards;
          ...
          console.log("onBuGangCard________________________", indexs, (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
          }), CardUtil) : CardUtil).getMajiangValues(opCards));
          let myHand = this.nodeCardView.getComponent(_crd && MyPlayerCard === void 0 ? (_reportPossibleCrUseOfMyPlayerCard({
            error: Error()
...
//# sourceMappingURL=698292500436ad100b6cfe91f8f674e50569e3e4.js.map