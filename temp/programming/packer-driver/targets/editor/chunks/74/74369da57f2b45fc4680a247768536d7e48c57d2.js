  ...
  return {
    ...
    execute: function () {
      ...
      _export("BaseComponent", BaseComponent = (_dec = ccclass('BaseComponent'), _dec2 = menu('vc/BaseComponent'), _dec(_class = _dec2(_class = class BaseComponent extends Component {
        ...
        addSchedulerOnce(time = 0, callback = this.onSchedulerUpdate) {
          const content = this;
          let handler = (_crd && SchedulerManager === void 0 ? (_reportPossibleCrUseOfSchedulerManager({
            error: Error()
        ...
        addScheduler(time = 0, callback = this.onSchedulerUpdate) {
          const content = this;
          let handler = (_crd && SchedulerManager === void 0 ? (_reportPossibleCrUseOfSchedulerManager({
            error: Error()
        ...
        getPreLoaderArrayRes(list, callback = null, isReload = false) {
          if (!list.length) {
            return;
          }
...
//# sourceMappingURL=74369da57f2b45fc4680a247768536d7e48c57d2.js.map