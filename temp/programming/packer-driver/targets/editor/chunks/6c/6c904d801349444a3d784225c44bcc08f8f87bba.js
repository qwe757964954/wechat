            ...
            case (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
              ...
              if (_allowShareMsg['allowShare']) {
                (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                  ...
                  error: Error()
                }), AppEvent) : AppEvent).NET_REQ_SHARE_AWARD, _allowShareMsg['gid'], (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                  error: Error()
                }), GConstants) : GConstants).ReqUrl.shareType.shop, true); // Platform.shareWXFriends(_allowShareMsg['shareParams'], Utils.handler(self, self.__doCallBackShare), _allowShareMsg['gid'])
              } else {
                // 请勿在短时间内重复分享
                (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
                  error: Error()
...
//# sourceMappingURL=6c904d801349444a3d784225c44bcc08f8f87bba.js.map