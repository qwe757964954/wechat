  ...
  return {
    ...
    execute: function () {
      ...
      _export("CardPlayManeger", CardPlayManeger = (_dec = ccclass('CardPlayManeger'), _dec2 = property({
        ...
        //自己抓牌
        drawMyCard(event) {
          let cardsList = (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          ...
          let myHand = this.nodeCardView.getComponent(_crd && MyPlayerCard === void 0 ? (_reportPossibleCrUseOfMyPlayerCard({
            error: Error()
          }), MyPlayerCard) : MyPlayerCard);
          myHand.drawByte = cardsList[0];
          console.log("自己抓牌", (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
          }), CardUtil) : CardUtil).getMajiangValue(myHand.drawByte), myHand.drawByte); //自己抓牌
        ...
        onDealCard(event, resp) {
          ...
          let isDealer = resp.cards.length === 14;
        ...
        onOutCard() {
          ...
          let indexs = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
          ...
          console.log("onOutCard______", (_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().myOpCode, (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCode, (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCards, indexs, (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
            error: Error()
          }), CardUtil) : CardUtil).getMajiangValues((_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
          }), OperationResultMgr) : OperationResultMgr).getInstance().opCards));
          ...
          if (this.pengArr.indexOf((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().myOpCode) !== -1) {
            ...
            let insertIndex = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
              error: Error()
            ...
            console.log("peng_______________", insertIndex, (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
              error: Error()
            }), CardUtil) : CardUtil).getMajiangValue(myHand.drawByte), (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
              error: Error()
            }), CardUtil) : CardUtil).getMajiangValue((_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
              error: Error()
            }), OperationResultMgr) : OperationResultMgr).getInstance().opCard));
            myHand.makeSlotAnim(insertIndex);
            myHand.drawCardToSlot();
          } else if (this.chiArr.indexOf((_crd && OperationMgr === void 0 ? (_reportPossibleCrUseOfOperationMgr({
            error: Error()
          }), OperationMgr) : OperationMgr).getInstance().myOpCode) !== -1) {
            myHand.playCardFromHandAnim(indexs[0]);
            (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
        ...
        getIndexByCards(insertCard) {
          let myCards = (_crd && PlayerMgr === void 0 ? (_reportPossibleCrUseOfPlayerMgr({
            error: Error()
        ...
        onAnGangCard() {
          ...
          let isGrab = (_crd && OperationResultMgr === void 0 ? (_reportPossibleCrUseOfOperationResultMgr({
            error: Error()
...
//# sourceMappingURL=586403979beddba437febf7846f30d9381ff42c5.js.map