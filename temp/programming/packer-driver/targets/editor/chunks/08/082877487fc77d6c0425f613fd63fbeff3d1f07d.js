    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cardAddTouchEvent(handNode) {
          ...
          handNode.on(Node.EventType.TOUCH_END, event => {// console.log(event);
            // if(this._isTouched){
            // }
        ...
        onTouchMove(event) {
          ...
          console.log(touchDelta); // 在Y轴上添加触摸位移
...
//# sourceMappingURL=082877487fc77d6c0425f613fd63fbeff3d1f07d.js.map