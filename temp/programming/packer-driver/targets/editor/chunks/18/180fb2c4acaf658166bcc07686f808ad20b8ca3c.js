    ...
    execute: function () {
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        onTouchMove(event) {
          ...
          const touchPos = event.getLocation(); // 获取之前的触摸点位置

          const prevTouchPos = event.getPreviousLocation(); // 计算Y轴上的移动距离

          const deltaY = touchPos.y - prevTouchPos.y;
          console.log("deltaY_________________", deltaY); // 在Y轴上移动相应的位置

          const newPosition = this.node.position.add(new Vec3(0, deltaY, 0));
...
//# sourceMappingURL=180fb2c4acaf658166bcc07686f808ad20b8ca3c.js.map