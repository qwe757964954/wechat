System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, animation, Animation, AnimationClip, instantiate, Node, Tween, Vec3, _decorator, GCache, EventManager, Utils, BaseComponent, OperationMgr, PlayerMgr, OPCode, GameEvent, CardUtil, NodeCardCtr, drawCardDisRatio, MjSize, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, MyPlayerCard;
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        playAnimOfShow() {
          ...
          for (let i = 0; i < this._mjList.length; i++) {
            ...
            let point = new Vec3(pos.x, 0, 0);
            let tweenTargetVec3 = new Vec3(0, 0, 0);
            let tw = new Tween(tweenTargetVec3).by(duration, new Vec3(90, 0, 0), {
              onUpdate: (target, ratio) => {// Utils.rotate3DAroundByPositionRotaion(this._mjList[i], pos, rotaionEuler, point, target, true)
              }
            }).by(duration, new Vec3(0, 0, 0), {
              onUpdate: (target, ratio) => {
                (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  error: Error()
                }), Utils) : Utils).rotate3DAroundByPositionRotaion(this._mjList[i], pos, rotaionEuler, point, target, true);
              }
            }).start();
          }
        }
...
//# sourceMappingURL=cbd52c45d29ce58a1942daae36e02cd0f1a9b3c8.js.map