    ...
    execute: function () {
      ...
      _export("GameHeadInfoPrefabCtr", GameHeadInfoPrefabCtr = (_dec = ccclass('GameHeadInfoPrefabCtr'), _dec2 = menu('prefab/game/GameHeadInfoPrefabCtr'), _dec3 = property({
        ...
        updateUserHeadBox() {
          ...
          let gameUserInfo = this._player.gameUserInfo;
          let spriteLoad = this.headFrameNode.getComponent(_crd && SpriteLoad === void 0 ? (_reportPossibleCrUseOfSpriteLoad({
            error: Error()
          }), SpriteLoad) : SpriteLoad);
...
//# sourceMappingURL=95000f0c07ca98bd51b22cbc769c8f36b4bd3318.js.map