    ...
    execute: function () {
      ...
      _GCmdMapping = class _GCmdMapping {
        ...
        refreshGloabelMapping() {
          ...
          for (let headCmd in _crd && GlobalHeadCmdBinding === void 0 ? (_reportPossibleCrUseOfGlobalHeadCmdBinding({
            error: Error()
            ...
            if (Object.prototype.hasOwnProperty.call(_crd && GlobalHeadCmdBinding === void 0 ? (_reportPossibleCrUseOfGlobalHeadCmdBinding({
              ...
              let mapping = (_crd && GlobalHeadCmdBinding === void 0 ? (_reportPossibleCrUseOfGlobalHeadCmdBinding({
                error: Error()
              }), GlobalHeadCmdBinding) : GlobalHeadCmdBinding)[headCmd];
              /** 序列化 方便查找 */
          ...
          for (let cmd in _crd && GlobalCmdBindingHead === void 0 ? (_reportPossibleCrUseOfGlobalCmdBindingHead({
            error: Error()
            ...
            if (Object.prototype.hasOwnProperty.call(_crd && GlobalCmdBindingHead === void 0 ? (_reportPossibleCrUseOfGlobalCmdBindingHead({
              ...
              let mapping = (_crd && GlobalCmdBindingHead === void 0 ? (_reportPossibleCrUseOfGlobalCmdBindingHead({
                error: Error()
              }), GlobalCmdBindingHead) : GlobalCmdBindingHead)[cmd];
              /** 序列化 方便查找 */
...
//# sourceMappingURL=4082e96744131a440dfe6eaf3be43090d3822f6b.js.map