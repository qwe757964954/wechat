    ...
    execute: function () {
      ...
      _export("OpInfo", OpInfo = (_dec = ccclass('OpInfo'), _dec2 = property(Node), _dec3 = property(Layout), _dec4 = property(Layout), _dec5 = property(Layout), _dec6 = property(Layout), _dec7 = property(Layout), _dec8 = property(Layout), _dec9 = property(Layout), _dec10 = property({
        ...
        updateOpration(resp) {
          ...
          resp.opGroups.forEach(opInfo => {
            ...
            if (layout instanceof Layout) {
              ...
              let opNode = layout.node.getChildByName("sk"); // let skel = opNode.getChildByName("sk").getComponent(sp.Skeleton);
        ...
        changeSkin(opcode, skNode) {
          ...
          /*
          resLoader.load(FXJRes.Spine_op.bundle, FXJRes.Spine_op.path, sp.SkeletonData, (err, spineAsset)=> {
          if(err) {
        ...
        findOpTypesWithSameNodeAndCode(opTypes) {
          ...
          for (const [name, group] of opMap) {
            ...
            cardItem.updateCardItemProp(group); // this.opBtns.addChild(node);
          }
...
//# sourceMappingURL=869407072967aa35d1b02b2a069699d57bc0e725.js.map