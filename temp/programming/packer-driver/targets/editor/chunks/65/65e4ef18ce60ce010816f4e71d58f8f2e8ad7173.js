System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Color, Label, Layout, Node, ScrollView, Sprite, SpriteFrame, UITransform, _decorator, instantiate, GCache, AppEvent, AppSound, GConstants, GameRes, GameTxt, ReportConfig, UIID, Utils, Encrypt, resLoader, EventManager, BaseComponent, Platform, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _crd, ccclass, property, menu, atyCenterPrefabCtr;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("atyCenterPrefabCtr", atyCenterPrefabCtr = (_dec = ccclass('atyCenterPrefabCtr'), _dec2 = menu('prefab/activity/atyCenterPrefabCtr'), _dec3 = property({
        ...
        findFirstShowAct() {
          //判断红点展示
          let showIndexByRed = this.atyData.findIndex(item => {
            return item['red_dot_type'] == 1;
          }); //判断进入活动中心优先要展示的活动数据 

          let showIndexByFirst = this.atyData.findIndex(item => {
        ...
        setSpriteFrame(node, path) {
          ...
          if ((_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            (_crd && resLoader === void 0 ? (_reportPossibleCrUseOfresLoader({
              ...
              if (spriteFrame) {
                let pngNode = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                  error: Error()
        ...
        setAdaptivePng(sizeConf, pngNode, isOnlyWidth = true) {
        ...
        updateSubList() {
          ...
          let data = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          ...
          for (let i = 0; i < data.length; i++) {
            ...
            nodeItem["data"] = data[i]; // 全部更新一次红点

            img_reddot.active = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
              error: Error()
            }), GCache) : GCache).RedDot.hasRedDot(smallTabConf.redKey, data[i]["config_id"]);
            ...
            if (i == this.currowChooseSubID) {
              ...
              smallTabConf.redUpdateFunc.call((_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                error: Error()
              }), GCache) : GCache).RedDot, data[i], false);
              select.active = true;
        ...
        onClickActJump(event) {
          ...
          if (this.currowChooseData['is_jump'] == 1) {
            //跳转位置
            let _jumpData = (_crd && Encrypt === void 0 ? (_reportPossibleCrUseOfEncrypt({
              error: Error()
            }), Encrypt) : Encrypt).JsonDecode(this.currowChooseData['jump_code']);

            let jmmpCmd = Number(_jumpData['cmd']) || 0;
            let mallScene = _jumpData['tag'] || 0; // 只要进行跳转都是关掉活动中心
              ...
              case (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                ...
                switch (mallScene) {
                  ...
                  case (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                    ...
                    let shareKefuData = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                      error: Error()
          ...
          let goodsProp = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          ...
          if (jmmpGoodsID) {
            switch (jmmpGoodsType) {
              case (_crd && GConstants === void 0 ? (_reportPossibleCrUseOfGConstants({
                ...
                let goodsItem = (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
                  error: Error()
                }), GCache) : GCache).ShopInfo.getShopDataByGoodsID(jmmpGoodsID);
                let param = {
...
//# sourceMappingURL=65e4ef18ce60ce010816f4e71d58f8f2e8ad7173.js.map