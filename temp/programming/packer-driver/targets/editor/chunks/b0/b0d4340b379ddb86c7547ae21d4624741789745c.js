      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        cancelOpcardTouch(opcard) {
          ...
          for (let i = 0; i < this._mjList.length; i++) {
            ...
            console.log("cancelOpcardTouch____________", byte, opcard, (_crd && CardUtil === void 0 ? (_reportPossibleCrUseOfCardUtil({
              error: Error()
...
//# sourceMappingURL=b0d4340b379ddb86c7547ae21d4624741789745c.js.map