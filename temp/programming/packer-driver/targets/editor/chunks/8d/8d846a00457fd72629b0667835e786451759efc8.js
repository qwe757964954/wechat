System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, animation, Animation, AnimationClip, instantiate, Node, SpriteFrame, Vec3, _decorator, GCache, EventManager, Utils, BaseComponent, OperationMgr, PlayerMgr, OPCode, GameEvent, CardUtil, NodeCardCtr, drawCardDisRatio, MjSize, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, MyPlayerCard;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['animation', 'Animation', 'AnimationClip', 'EventTouch', 'instantiate', 'Node', 'SpriteFrame', 'Vec3', '_decorator']);
      ...
      _export("MyPlayerCard", MyPlayerCard = (_dec = ccclass('MyPlayerCard'), _dec2 = property({
        ...
        onLoad() {
          ...
          this.node.on(Node.EventType.TOUCH_END, this.onTouchEnd, this); // this.node.on(Node.EventType.TOUCH_CANCEL, this.onTouchCancel, this);
        ...
        foldAnimation() {
          // 创建一个 AnimationClip
          const animationClip = AnimationClip.createWithSpriteFrames([], 135 / 45 + 1); // 添加一个关键帧

          const frame = new SpriteFrame();
          animationClip.addKeyframe(frame, 0); // 在动画中设置关键帧的属性

          const curve = new AnimationClip.CreateCurve(frame, "eulerAngles.x");
          curve.values = [0, 135, 0];
          animationClip.curveBindings.push(curve); // 将 AnimationClip 添加到 Animation 组件中

          const animation = this.getComponent(cc.Animation);
          animation.addClip(animationClip, "rotate");
          animation.play("rotate"); // 在动画结束后恢复原始状态
        ...
        onTouchEnd(event) {
          if (this.moveDistance > this.thresholdDistance && (_crd && GCache === void 0 ? (_reportPossibleCrUseOfGCache({
            error: Error()
          }), GCache) : GCache).Desk.turnMe) {
            // 出牌
            console.log('出牌');

            let byte = this._touchNode.getComponent(_crd && NodeCardCtr === void 0 ? (_reportPossibleCrUseOfNodeCardCtr({
              error: Error()
...
//# sourceMappingURL=8d846a00457fd72629b0667835e786451759efc8.js.map