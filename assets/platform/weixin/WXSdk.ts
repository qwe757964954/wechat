/**
 * Name = WXSdk
 * URL = db://assets/platform/weixin/WXSdk.ts
 * Time = Wed Apr 27 2022 14:14:08 GMT+0800 (中国标准时间)
 * Author = xueya
 *微信小程序 针对官方Api的扩展
 *WeiXinApi:https://developers.weixin.qq.com/minigame/dev/api/
 */

import { Utils } from "../../framework/Utils";
import { WXSdk_VibrateShortType, _InterFace_WXSdk_CreateUserInfoButton, __InterFace_WXSdk_GetLaunchOptionsSync, __InterFace_WXSdk_KVData, __InterFace_WXSdk_ModalTips, __InterFace_WXSdk_OnShareAppMessage, __InterFace_WXSdk_ShowLoading, __InterFace_WXSdk_ShowToast } from "./WXSdkDefines";
...
export class WXSdk {
	...
	_fileSystemManager;
	/** 激励视频广告实例 */
	_adRewardedVideo = null;
	/** 视频回调 */
	public VideoCallFunc = { onLoad: null, onError: null, onClickClose: null, isReturn: false, isClick: false }
	/** 注册实现自定义隐私弹窗的回调函数 */
	public NeedPrivacyAuthorization = null;
	 ...
	 */
	getSystemInfoAsync(success: Function = null, fail: Function = null, complete: Function = null) {
		this.wxSdk.getSystemInfoAsync({ success, fail, complete })
	}
	/**
	 ...
	 * @param complete 接口调用结束的回调函数（调用成功、失败都会执行）
	 */
	checkSession(success: Function = null, fail: Function = null, complete: Function = null) {
		this.wxSdk.checkSession({ success, fail, complete })
	}
	/**
	 ...
	 */
	login(timeout: number = null, success: Function = null, fail: Function = null, complete: Function = null) {
		this.wxSdk.login({ timeout, success, fail, complete })
	}
	 ...
	 */
	request(url: string, success: Function = null, fail: Function = null, complete: Function = null, data: string | object | ArrayBuffer = null, header: object = null, timeout: number = 6000, method: string = "GET", dataType: string = "json", responseType: string = "text") {
		this.wxSdk.request({
			url: url,
			data: data,
			header: header,
	 ...
	 * @returns 
	 */
	openSetting(withSubscriptions: boolean = false, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '2.10.3'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			this.showModelNotKeep();
			return;
		}
		this.wxSdk.openSetting({ withSubscriptions, success, fail, complete })
	}
	 ...
	 */
	getSetting(withSubscriptions: boolean = false, success: Function = null, fail: Function = null, complete: Function = null) {
		this.wxSdk.getSetting({ withSubscriptions, success, fail, complete })
	}
	/**
	 * 获取用户信息
	 ...
	 */
	getUserInfo(withCredentials: boolean = false, lang: string = "en", success: Function = null, fail: Function = null, complete: Function = null) {
	 ...
	 * @param complete 接口调用结束的回调函数（调用成功、失败都会执行）
	 */
	authorize(scope: string, success: Function = null, fail: Function = null, complete: Function = null) {
		this.wxSdk.authorize({ scope, success, fail, complete })
	}
	 ...
	 */
	createUserInfoButton(options: _InterFace_WXSdk_CreateUserInfoButton) {
	 ...
	 * @returns 
	 */
	onNeedPrivacyAuthorization(event: string = null, callback: Function = null) {
		let baseVer = '2.33.0';
		...
		if (WXSdk.instance.NeedPrivacyAuthorization != null) {
			...
			if (event) {
				WXSdk.instance.NeedPrivacyAuthorization({ event: String(event) })
			}
			if (callback) {
	 ...
	 * @returns 
	 */
	openPrivacyContract(isCheck = false, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '2.33.0';
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			return false;
		} else {
	 ...
	 */
	showModal(options: __InterFace_WXSdk_ModalTips) {
	 ...
	 */
	showToast(options: __InterFace_WXSdk_ShowToast) {
	 ...
	 * @param options 详见 __InterFace_WXSdk_ShowToast 中的定义
	 */
	showLoading(options: __InterFace_WXSdk_ShowLoading) {
	 ...
	 * @param complete 接口调用结束的回调函数（调用成功、失败都会执行）
	 */
	hideToast(noConflict?: number, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '2.22.1'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			return;
		}
		this.wxSdk.hideToast({ noConflict, success, fail, complete })
	}
	/**
	 * 隐藏 loading 提示框
	 * @param noConflict 目前 toast 和 loading 相关接口可以相互混用，此参数可用于取消混用特性 最低版本 2.22.1
	 ...
	 * @param complete 接口调用结束的回调函数（调用成功、失败都会执行）
	 */
	hideLoading(noConflict?: number, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '2.22.1'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			return;
		}
		this.wxSdk.hideLoading({ noConflict, success, fail, complete })
	}
	/**
	 ...
	 * @param complete 
	 */
	setClipboardData(data: string, success: Function = null, fail: Function = null, complete: Function = null) {
		this.wxSdk.setClipboardData({ data: data, success, fail, complete })
	}
	 ...
	 * @param complete 
	 */
	getClipboardData(success: Function = null, fail: Function = null, complete: Function = null) {
		this.wxSdk.getClipboardData({ success, fail, complete })
	}
	 ...
	 * @param complete 接口调用结束的回调函数（调用成功、失败都会执行）
	 */
	showShareMenu(withShareTicket: boolean = true, menus: Array<string>, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '2.11.3'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			this.showModelNotKeep();
			return;
	 ...
	 */
	shareAppMessage(param: __InterFace_WXSdk_OnShareAppMessage) {
	 ...
	 * @param callback 
	 */
	onShareAppMessage(callback: Function) {
	 ...
	 * @param callback 
	 */
	onShareTimeline(callback: Function) {
	 ...
	 */
	onShareMessageToFriend(callback: Function) {
	 ...
	 */
	openCustomerServiceConversation(sessionFrom: string = "", success: Function = null, fail: Function = null, complete: Function = null, showMessageCard: boolean = false, sendMessageTitle: string = null, sendMessagePath: string = null, sendMessageImg: string = null) {
		let baseVer = '2.0.3'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			this.showModelNotKeep();
			return;
	 ...
	 */
	compareSdkVersion(v1, v2): number {
		let v1Sum = v1.split('.')
		let v2Sum = v2.split('.')
	 ...
	 * @returns 
	 */
	connectSocket(url: string, success: Function = null, fail: Function = null, complete: Function = null, header: object = null, timeout: number = null, protocols: Array<string> = null, tcpNoDelay: boolean = false, perMessageDeflate: boolean = false) {
		let baseVer = '1.9.6'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			this.showModelNotKeep();
			return null;
	 ...
	 * @returns 
	 */
	closeSocket(code: number = 1000, reason: string = "", success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '1.9.6'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			this.showModelNotKeep();
			return null;
	 ...
	 * @param complete 接口调用结束的回调函数（调用成功、失败都会执行）
	 */
	requestMidasPayment(buyQuantity: number, offerId: string, env: number = 0, zoneId: string = "1", success: Function = null, fail: Function = null, complete: Function = null) {
		let obj = {
	 ...
	 * @param complete 接口调用结束的回调函数（调用成功、失败都会执行）
	 */
	getNetworkType(success: Function = null, fail: Function = null, complete: Function = null) {
	 ...
	 * @param complete 
	 */
	setUserCloudStorage(KVDataList: Array<__InterFace_WXSdk_KVData>, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '1.9.92'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			this.showModelNotKeep();
			return null;
	 ...
	 * @param complete 
	 */
	getUserCloudStorage(keyList: Array<string>, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '1.9.92'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
			this.showModelNotKeep();
			return null;
	 ...
	 * @returns 
	 */
	requestSubscribeMessage(tmplIds: Array<string>, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '2.4.4'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
	 ...
	 * @returns 
	 */
	vibrateShort(type = WXSdk_VibrateShortType.heavy, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '1.9.6'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
	 ...
	 * @returns 
	 */
	vibrateLong(success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '1.9.6'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
	 ...
	 * @returns 
	 */
	setEnableDebug(enableDebug: boolean, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '1.4.0'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
	 ...
	 * @returns 
	 */
	downloadFile(url: string, timeout: number = 5000, filePath: string = null, success: Function = null, fail: Function = null, complete: Function = null) {
	 ...
	 * @returns 
	 */
	createRewardedVideoAd(adUnitId: string, success: Function = null, fail: Function = null, clickCloseFunc: Function = null) {
		let baseVer = '2.0.4'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
		...
		this._adRewardedVideo = this.wxSdk.createRewardedVideoAd({ adUnitId: adUnitId });
		this.addRewardedVideoAdListener(success, fail, clickCloseFunc, true);
	}
	/** 添加激励视频监听 */
	addRewardedVideoAdListener(success: Function = null, fail: Function = null, clickCloseFunc: Function = null, isInit = false) {
		if (this._adRewardedVideo) {
			...
			WXSdk.instance.VideoCallFunc.isClick = false;
			//已经绑定了回调的不再绑定了
			if (isInit == false) {
				return;
			}
	 ...
	 * @returns 
	 */
	playRewardedVideoShow(success: Function = null, fail: Function = null, clickCloseCallback: Function = null) {
		if (!this._adRewardedVideo) {
	 ...
	 */
	getLaunchOptionsSync(): __InterFace_WXSdk_GetLaunchOptionsSync {
		let baseVer = '2.1.2'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
	 ...
	 * @returns __InterFace_WXSdk_GetLaunchOptionsSync
	 */
	getEnterOptionsSync(): __InterFace_WXSdk_GetLaunchOptionsSync {
		let baseVer = '2.13.2'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
	 ...
	 * @returns 
	 */
	setKeepScreenOn(isLight, success: Function = null, fail: Function = null, complete: Function = null) {
		let baseVer = '1.4.0'
		if (this.compareSdkVersion(baseVer, this._sdkVersion) > 0) {
